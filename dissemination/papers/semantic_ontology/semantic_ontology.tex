...
question, and it is open: the matter and field sectors of the discrete
model propagate by different mechanisms, no interacting common cone is
established, and the wave speed $1/\sqrt3$ is a selection rather than a
forced saturation. Interacting vertices and operational composite boosts
are likewise untested. And the deferral has a date: the moment a second
...
$1.6\times10^{-40}$ \\
Two-body register: common cone across sectors & \textbf{Open and failing
at order unity}; distinct sectors carry different leading speeds ---
untouched by the mass-dependence result \\
