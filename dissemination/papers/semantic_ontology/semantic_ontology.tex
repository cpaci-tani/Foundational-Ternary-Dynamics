...
lattices. (c) The identity itself: three face squares and six edge
squares stack exactly onto $-L_{18}$, with residual $1.8\times10^{-15}$
over $4000$ random momenta. (d) The price: $n$ squares require $n$
mutually anticommuting structures, and dimension $2^k$ carries $2k+1$, so
nine first becomes available at spinor dimension $16$ --- fourfold Dirac,
recognisably the staggered taste multiplication.}
