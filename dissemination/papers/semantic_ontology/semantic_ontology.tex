...
Nothing has been bought yet. The first purchase is the smallest one
available, and it is made in the next section: a single distinction,
without which there is not yet anything for a physics to be about.
...
Six line-items follow. The first three are computed and close;
the last three are where the obligation is still open, and each
names the object whose absence blocks it.
...
in Section~
ef{sec:clock} and the substrate did not supply. The next
