...
(not [\textsc{theorem}]) but lacking a derivation chain from axioms to
the physical identification; $x_+ = 1/\alpha$ has no numerical-uniqueness
support. The Moore-layer decomposition yielding
...
conjecture}]. Its structural support is the BCC complex-structure theorem
...
natural $\mathbb{Z}[i]$-module structure. $x_+ = 1/\alpha$ has no
numerical-uniqueness support. A
