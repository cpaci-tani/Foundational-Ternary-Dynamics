...
matches CODATA $\alpha^{-1}$ to 1.26 ppm and the smaller root
$x_- \approx 3.024$ matches $N_c = 3$ to $0.80\%$, with this
...
the physical identification. The Moore-layer decomposition yielding
