...
Whether the 5$\times$ gap closes in the continuum limit is the open
question --- Thread 1a ($L = 256$ MCRG scan) is still running at
time of writing and will be reported in the final manuscript revision.
