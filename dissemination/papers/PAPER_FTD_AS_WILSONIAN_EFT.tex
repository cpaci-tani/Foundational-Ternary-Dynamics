...
genuine engine physics rather than a methodology artefact. The final
Thread 1a ($L = 256$ Coulomb-tail measurement) pushes the deepest-r
probe down to $\alpha_r(r{=}84) / \alpha_{\text{ref}} = \mathbf{1.4}$
--- the lowest ratio measured in the entire programme. Fitting the
r-max series at L = 64, 128, 256 to a 1/L finite-size law (appropriate
for Coulomb in a periodic box) extrapolates to $\alpha_\infty =
\mathbf{1.23 \alpha_{\text{ref}}}$: \FTD\ matches continuum QED to
within \textbf{23\%} in the infinite-volume limit.
\end{abstract}
