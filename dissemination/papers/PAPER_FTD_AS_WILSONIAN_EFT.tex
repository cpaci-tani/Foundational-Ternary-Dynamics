...
\textbf{Critical comparison}: the static V(r) asymptotic method at the
...
\begin{tabular}{lccl}
\toprule
scaling law & $\alpha_\infty$ & $\alpha_\infty / \alpha_{\mathrm{ref}}$ & $R^2$ \\
\midrule
...
$\alpha_\infty \in [3.35, 3.74] \times \alpha_{\text{ref}}$ in the
engine's accumulator convention, or $\approx 1.8 \times \alpha_{\text{ref}}$
after the classical $\tfrac{1}{2}$ convention correction derived in
...
% ============================================================================
\section{Phase F: GPU unblock + 4-point continuum plateau}
\label{sec:phasef}

The Day-2 manuscript closed with a 3-point continuum extrapolation
($L = 64, 128, 256$) giving $\alpha_\infty = 1.23 \alpha_{\text{ref}}$
...
\begin{tabular}{lcc}
\toprule
fit form & $\alpha_\infty$ & $\alpha_\infty / \alpha_{\text{ref}}$ \\
\midrule
1/L & 0.02640 & 3.62 \\
1/L$^2$ & 0.02730 & 3.74 \\
...
All three extrapolations agree on $\alpha_\infty \in [3.35, 3.74]
\times \alpha_{\text{ref}}$ in the engine's native accumulator
convention. The 4-point series is flat enough that the extrapolation
is insensitive to scaling-law choice. \textbf{FTD does not match
continuum QED at the Coulomb tail.}
...
$\alpha_\infty^{\text{classical}} \approx 0.013 \approx 1.8
\times \alpha_{\text{ref}}$.
