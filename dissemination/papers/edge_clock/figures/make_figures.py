...
ax1.set_title("(a) calibration-free $G^{*}$ recovery (simulated)")
...
# independent check of tau at a generic point via direct quadrature
mu_t, A_t = 2.0, 0.017
...
# independent numerical check of B_exact at a generic modulus via simulated waveform
mu_x, A_x = 2.0, 0.017
def rhs_x(t, y):
    return [y[1], -(mu_x * y[0] + 4 * LAM * y[0] ** 3) / MASS]
Tex = T_t
