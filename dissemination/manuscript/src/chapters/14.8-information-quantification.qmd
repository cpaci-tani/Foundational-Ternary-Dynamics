...
1. **Environment** (configuration c) →
2. **Physical Signal** → (transduction)
3. **Receptor Activation** → (encoding)
4. **Neural Spike Train** → (integration)
5. **Cortical Pattern** → (binding)
6. **Conscious Percept** → (storage)
7. **Memory Trace**
...
|-------|-------|----------|------------|
| 0 | Physical World | ~10²² bits | receptor limits |
| 1 | Receptor Activation | ~10⁷ bits/sec | lateral inhibition |
| 2 | Primary Sensory Cortex | ~10⁶ bits/sec | feature extraction |
| 3 | Association Cortex | ~10⁵ bits/sec | attention filter |
| 4 | Working Memory | ~10² bits/sec | consolidation |
| 5 | Long-Term Memory | ~10¹ bits/sec stored | — |
...
| **Total** | ~10⁷ → ~50 bits/sec | 10⁻⁵ (1 in 100,000) |
