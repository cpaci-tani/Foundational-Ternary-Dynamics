...
- If the change affects a load-bearing claim's tag, update `docs/theory/07_assessment/core_ledgers/LEDGER.md` and (if the tag tier changes) `docs/theory/07_assessment/core_ledgers/TRACKER_ONTIC_TRUTH.md`.
