...
`N_c = 3` (and with it, in this framework's own bookkeeping, `N_gen = 3`) has structural support via the Moore Layer Theorem (`THEOREM_MOORE_LAYER_DECOMPOSITION.md`) and `DERIV_NC_FROM_TOPOLOGY.md`'s four independent routes.
