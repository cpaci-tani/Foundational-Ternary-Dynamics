...
**Theoretical prediction; simple simulation shows classical behavior.**

- The sLoop mechanism is a theoretical prediction based on Hilbert space tensor product structure
- Simple flux-loop simulation (verify_bell_inequality.py) correctly shows S ≤ 2 (classical limit)
- Full Hilbert space implementation required to demonstrate Bell violations
- No specific laboratory test designed yet
...
| Bell S | 2.83 | Theoretical (simple sim shows S ≤ 2) | TBD |
