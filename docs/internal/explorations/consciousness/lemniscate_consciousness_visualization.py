...
Discriminant: -32.68 (NEGATIVE)

ROOTS: y = 2.188 +/- 2.860i

  Re(y) = G*^2/4 = {Y_RE:.4f}
  Im(y) = {Y_IM:.4f}
  |y|   = {Y_MAG:.4f}
  Phase = {np.degrees(np.arctan2(Y_IM, Y_RE)):.2f} degrees

KEY RELATIONSHIPS:
  |y|^2 = G*^3/2 = {Y_MAG**2:.4f}
...
Real roots: 137.036, 3.024                    Complex roots: 2.19 +/- 2.86i
