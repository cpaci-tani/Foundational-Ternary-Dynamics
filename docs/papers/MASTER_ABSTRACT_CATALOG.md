...
**Path:** `docs/papers/src/DERIV_ALPHA_PRECISION.tex`
...
## FOUND_ONTIC_INCOMPLETENESS.tex
**Path:** `docs/papers/src/FOUND_ONTIC_INCOMPLETENESS.tex`
...
## FTD_Discrete_Continuous_Bridge.tex
**Path:** `docs/papers/src/FTD_Discrete_Continuous_Bridge.tex`
...
## FTD_Finitude_Theorem.tex
**Path:** `docs/papers/speculative/FTD_Finitude_Theorem.tex`
...
**Path:** `docs/papers/src/PAPER_0A_PERIOD_DESCENT.tex`
...
**Path:** `docs/papers/src/PAPER_0B_THREE_CONSTANTS.tex`
...
## PAPER_0E_ARITHMETIC_GEOMETRIC_EQUIVALENCE.tex
**Path:** `docs/papers/src/PAPER_0E_ARITHMETIC_GEOMETRIC_EQUIVALENCE.tex`
...
## PAPER_1A_WATSON_LATTICE_BRIDGE.tex
**Path:** `docs/papers/src/PAPER_1A_WATSON_LATTICE_BRIDGE.tex`
...
## PAPER_2A_MASTER_QUADRATIC.tex
**Path:** `docs/papers/src/PAPER_2A_MASTER_QUADRATIC.tex`
...
## PAPER_GAUGE_COUPLINGS_FROM_LATTICE_GEOMETRY.md
**Path:** `docs/papers/src/PAPER_GAUGE_COUPLINGS_FROM_LATTICE_GEOMETRY.md`
...
## PAPER_GAUGE_COUPLINGS_FROM_LATTICE_GEOMETRY.tex
**Path:** `docs/papers/src/PAPER_GAUGE_COUPLINGS_FROM_LATTICE_GEOMETRY.tex`
...
**Path:** `docs/papers/src/PAPER_GSTAR_BRIDGE_CONSTANT.tex`
...
**Path:** `docs/papers/src/PAPER_LIFECYCLE_SOFTPLUS.tex`
...
## PAPER_MASTER_QUADRATIC_FORMAL.tex
**Path:** `docs/papers/src/PAPER_MASTER_QUADRATIC_FORMAL.tex`
...
**Path:** `docs/papers/src/PAPER_MISSING_RATIO.tex`
...
**Path:** `docs/papers/src/PAPER_RATIO_AND_THE_ARROW.tex`
...
## PAPER_TWO_RACES.tex
**Path:** `docs/papers/src/PAPER_TWO_RACES.tex`
...
## ontic_derivation_chain.tex
**Path:** `docs/papers/src/ontic_derivation_chain.tex`
...
Other papers in this series trace the lifecycle of a hydrogen atom through these
constants, analyze the discrete--continuous bridge in pure
mathematics, and propose a unifying ontological
constructor.

---

## ratio_and_the_arrow.tex
**Path:** `docs/papers/src/ratio_and_the_arrow.tex`
