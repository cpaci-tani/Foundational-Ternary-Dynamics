...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textit{cpaci-tani}}
...
\begin{center}
    ...
    {\large William J.\ cpaci-tani~III}\\[8pt]
...
\bibitem{cpaci-tani2026} cpaci-tani, W.~J., III, ``A Precision Formula for the Fine-Structure Constant from Discrete Lattice Combinatorics,'' FTD Pre-print (2026).
