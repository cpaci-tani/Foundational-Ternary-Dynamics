...
The critical root---the boundary between the real-root regime (bosonic) and the complex-root regime (fermionic)---is not a free parameter. It is the harmonic mean of the two roots. In reciprocal space, $2G^*$ is equidistant from $x_+$ and $x_-$: it is the midpoint of the reciprocal interval $[w_+, w_-]$.
