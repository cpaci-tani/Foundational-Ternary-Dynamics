...
Full derivation: [DERIV_CHARGE_QUARTIC_FROM_GSTAR.md](../../theory/03_derivations/foundational_mechanics/DERIV_CHARGE_QUARTIC_FROM_GSTAR.md). Verified numerically: `scripts/verification/verify_charge_quartic.py` (6/6 tests, all residuals < $10^{-12}$).
