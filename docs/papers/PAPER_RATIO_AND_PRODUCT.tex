...
The anti-correlation theorem \cite{cpaci-tani2026a} establishes that at each integer
...
The blind derivation chain \cite{cpaci-tani2026b} begins from a single axiom:
