...
{\large William J.~Steinmetz~III}\\[1.6em]
...
\midrule
$k < k_c = 1/(4\Gstar)$ & $\Delta < 0$ & Complex conjugate & Type~III$_1$ \\
...
\begin{equation}\label{eq:kcrit}
  k_c \;=\; \frac{1}{4\,\Gstar} \;\approx\; 0.0845.
\end{equation}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item the constant that fixes, via $k_c = 1/(4\Gstar)$, the phase boundary at which life begins.
\end{itemize}
