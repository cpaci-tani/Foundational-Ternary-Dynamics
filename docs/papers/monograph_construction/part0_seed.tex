...
spine (\textbf{seven theorem-grade results}), and it \textbf{provably
does not force the electromagnetic coupling $\alpha$ without an additional
binding law}. Both halves are the deliverable. A program that only proved the
