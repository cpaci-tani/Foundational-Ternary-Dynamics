...
%
% The generator scripts/visualization/render_node_map_tikz.py is NOT used: it
% emits colour and a broken layout (all nodes stacked at x=0).  This figure is
% the data-of-record's hand-set presentation; the node/edge set matches the nine
% numbered spine results of SPEC_ALGEBRAIC_SPINE.md (seven theorem-grade, two tiered).
% =============================================================================
\begin{figure}[t!]
  \centering
  \resizebox{\textwidth}{!}{%
