...
(Clause~1), and a route-invariant boundary it provably does \emph{not} force
(Clause~2). This Part introduces the one ingredient withheld until now (the
...
is presently open, and that is exactly why $x_+=1/\alpha$ stands where it does.
The monograph claims no imminent closure; it claims to have located the gap
