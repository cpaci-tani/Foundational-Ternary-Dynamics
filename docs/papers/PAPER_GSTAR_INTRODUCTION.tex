...
for CM elliptic curves over $\Q$ by Rubin \cite{rubin1991} (building on
Coates--Wiles \cite{coates-wiles}), gives
\[
...
image is a polynomial $\Q$-algebra in two transcendentally independent
generators.
\end{proof}
