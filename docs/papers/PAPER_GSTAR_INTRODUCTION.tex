...
= (2, 3)$ is forced only by the structural requirement that the polynomial
have two roots of distinct $\Gs$-homogeneity (see Proposition~\ref{prop:exponent-regimes}).
A clean class-field-theoretic derivation of $(a, b) = (2, 3)$ from
$\chi_{-4}$-internal data, if it exists, would be of independent
arithmetic interest.
\end{observation}
