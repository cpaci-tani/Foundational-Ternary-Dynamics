...
is the inverse fine structure constant is a conjecture.  We have identified
three precise mathematical questions (the global coupling operator, the
Sum~$=$~Product condition, and the role of~$16$) whose resolution would settle
the matter.
