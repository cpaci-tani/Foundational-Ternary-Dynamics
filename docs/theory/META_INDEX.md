...
| 1.17 | **[SPEC_PHYSICS_BRIDGE.md](01_reference/SPEC_PHYSICS_BRIDGE.md)** | **Physics-bridge synthesis (FTD-0121, 2026-05-01):** crystallizes FTD's connection to (1/α, N_c) — mathematical spine + empirical match (1.26 ppm + 0.80%) + structural-uniqueness arguments (tower-scan rank-1, polynomial-scan unique dual-matcher). **2026-05-02 update**: Bayes factor strengthened from ~20,000:1 to **~4×10⁵:1** via extended polynomial-scan (2.87M polynomials/multipliers, pre-registered). 0 Eisenstein dual-matchers confirms (1+i, k=4) Gaussian selection is structurally distinguished. The IDENTIFICATION x_+ = 1/α stays [STRONGLY MOTIVATED CONJECTURE] |
| 1.18 | **[SPEC_OPEN_MATH_BY_SECTOR.md](01_reference/SPEC_OPEN_MATH_BY_SECTOR.md)** | **Open math by physics sector (2026-05-08, FTD-0146 [SYNTHESIS]; replaces archived `CHECKLIST_MATH_COMPLETE.md`)**: sector-aligned canonical research-questions queue across 10 SM-sectors (pure-math / EM-α / EW-Higgs / QCD / flavor / gravity / QM-foundations / cosmology / engine-bridge / cross-cutting). Preserves effort codes (D/W/M/RP/FO) + dependency graph + foundational-obstruction framing. Tier I + II closed (8/8); Tier III 1/5 closed + 3 investigations + 1 blocked; MC-T4.3 (non-action α-injection mechanism) is the central foundational obstruction. Cite for "what's left" math-completion questions |
