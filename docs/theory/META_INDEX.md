...
| 7.14 | [OPEN_A_PHYS_DERIVATION.md](10_eft_program/OPEN_A_PHYS_DERIVATION.md) | ✅ **[CLOSED] (2026-04-19)** — load-bearing problem created by the reframe. Resolved by Mechanism γ derivation in `DERIV_A_PHYS_MECHANISM_GAMMA_SUCCESS.md`. |
| 7.15 | [DERIV_A_PHYS_MECHANISM_GAMMA_ATTEMPT.md](10_eft_program/DERIV_A_PHYS_MECHANISM_GAMMA_ATTEMPT.md) | ❌ **Mechanism γ failed attempt (2026-04-19)** — explicit dimensional chain using physical electron mass fails. Superseded by `DERIV_A_PHYS_MECHANISM_GAMMA_SUCCESS.md`. |
| 7.15b | [DERIV_A_PHYS_MECHANISM_GAMMA_SUCCESS.md](10_eft_program/DERIV_A_PHYS_MECHANISM_GAMMA_SUCCESS.md) | ✅ **Mechanism γ SUCCESS (2026-04-19)** — [THEOREM]. Derives a_phys ≈ 4.39 ℓ_P purely from Axiom-Zero combinatorial constants (c_lat=1/√3, ℏ_lat=1, G_N(lat)=0.01) without any empirical physical mass input. Closes the OPEN dimensional conversion problem. |
