...
- [07_assessment/TRACKER_ONTIC_TRUTH.md](07_assessment/TRACKER_ONTIC_TRUTH.md) — canonical bedrock tracker (5-tier truth ranking with verification artifacts)
...
| 1.2b | **[BRIDGE_QUADRATIC_PHYSICS.md](01_reference/BRIDGE_QUADRATIC_PHYSICS.md)** | **Layer 2:** Selection principles SP1-SP6 bridging math to physics |
...
| 1.16 | **[SPEC_ALGEBRAIC_SPINE.md](01_reference/SPEC_ALGEBRAIC_SPINE.md)** | **Canonical 9-theorem reference** (created 2026-04-27, extended to 9 theorems 2026-04-29/30): G\* algebraic identity, master quadratic + roots, CM-curve uniqueness, coefficient 16 = \|Aut(E)\|², Watson identity, Phase G geometric Coulomb, Phase J ultralocality, (1+i)-tower harmonic invariant (FTD-0111), field-theoretic Q(G\*) characterization (FTD-0112). Citation target for paper drafts; states the firm algebraic content independent of any physics interpretation |
...
| 1.19 | **[REF_REFLEXIVITY_VOCABULARY.md](01_reference/REF_REFLEXIVITY_VOCABULARY.md)** | **Reflexivity vocabulary (2026-05-01)**: canonical replacement for "consciousness" terminology. Two-term core (reflexivity = structural; agency = dynamical). 25-row replacement table + 5 distinctions. Drops qualia/Hard-Problem baggage; preserves all conceptual content. P1-P4 sweep applied across theory + manuscript + whitepaper 2026-05-01/02. Cite before applying vocabulary in new docs |
...
| 1.27 | **[PAPER_GSTAR_FTD_BRIDGE.tex](../papers/PAPER_GSTAR_FTD_BRIDGE.tex)** | 🆕 **(2026-05-19) Paper B: math-physics bridge (5pp).** *The master quadratic P_{G*} as a math-physics bridge.* Companion note recording the FTD identification (x_+, x_-)≈(α⁻¹, N_c), Z[i]-substrate realism ontology (Pythagorean structural realism), Born-rule schema parallel to χ_{-4} (carefully scoped per philosophical red-team). All claims [SYNTHESIS] or [STRONGLY MOTIVATED CONJECTURE]. Target venue: Foundations of Physics. |
...
| 2.7 | [FOUND_RELATIVITY_GRAVITY_DISTINCTION.md](02_foundations/FOUND_RELATIVITY_GRAVITY_DISTINCTION.md) | **SR / Gravity / GR trichotomy (v2.0):** Three distinct concepts, 7-level hierarchy, emergent equivalence principle; **§10 epistemic time dimension:** kinematic/thermodynamic/geometric time relations, ontological vs epistemic time distinction, connection to discriminant trichotomy |
...
| Order | Document | Description |
|-------|----------|-------------|
| 3.1 | [DERIV_BOTTOM_UP_PHYSICS.md](03_derivations/DERIV_BOTTOM_UP_PHYSICS.md) | **Entry point:** 0 = (-1) + (+1) → Standard Model |
...
| 3.23 | [DERIV_SPIN_STATISTICS_BRIDGE.md](03_derivations/DERIV_SPIN_STATISTICS_BRIDGE.md) | **Two-lemniscate spin-statistics bridge:** Bernoulli (self-crossing ℤ₂) + Lemniscate-Alpha (winding w=−2 ℤ₂) both extract G*; discriminant trichotomy ↔ boson/fermion statistics; Z/6Z = particle×color from Fourcier lobes; coefficient 16 dual role (gauge DoF = spinor bilinears) |
| 3.24 | [DERIV_KCOMP_VOLUMETRIC_SHELL.md](03_derivations/DERIV_KCOMP_VOLUMETRIC_SHELL.md) | **K_comp volumetric shell (closes §6.3.2 gap):** Coupling g_c·s·∇·J builds self-field envelope r_eff=11.6 with E~K_B² [THEOREM]. Two shells overlap → shared flux → non-factorizable joint probability [SELECTION]. N_meas=K_B/J_peak≈18 = macroscopic measurement threshold [EMERGENT]. GPU-verified 10/10 checks (128³, GPU). Depends on DERIV_OBSERVER_BELL_MECHANISM |
| 3.25 | [DERIV_CHARGE_QUARTIC_FROM_GSTAR.md](03_derivations/DERIV_CHARGE_QUARTIC_FROM_GSTAR.md) | Charge quartic extension of master quadratic from G* |
...
| 3.36 | [DERIV_OBSERVER_BELL_MECHANISM.md](03_derivations/DERIV_OBSERVER_BELL_MECHANISM.md) | **Observer Bell mechanism [SELECTION]:** Three-level hierarchy — substrate (S≤2, local hidden variable) → aggregate (ensemble statistics, non-factorizable) → observer (measurement, Born rule); explains how S=2√2 emerges from local dynamics; N_meas≈18; connects to Type III₁→Type I transition |
...
| 3.40 | [DERIV_CONTINUUM_LIMIT_QED_EQUIVALENCE.md](03_derivations/DERIV_CONTINUUM_LIMIT_QED_EQUIVALENCE.md) | **Historical x₊ = 1/α upgrade attempt:** FTD compact U(1) → QED via Wilson two-phase theorem + UV scale rigidity lemma. Status revised 2026-04-19: the L → ∞ continuum-limit promotion path is not load-bearing under undefined-boundary ontology; `x_+ = 1/α` remains [STRONGLY MOTIVATED CONJECTURE]. |
...
| 3.43 | [DERIV_THREE_GENERATIONS.md](03_derivations/DERIV_THREE_GENERATIONS.md) | **Three generations from cuboctahedron:** O_h symmetry group (order 48) has 3 axis types — 3 C4 + 4 C3 + 6 C2 = 13 total axes = N_eff; N_axis_types=3=N_gen [SELECTION]; axis counts match {N_c, N_base, N_f, N_eff}; 18/18 tests pass |
| 3.44 | [DERIV_EINSTEIN_NONLINEAR_FROM_LATTICE.md](03_derivations/DERIV_EINSTEIN_NONLINEAR_FROM_LATTICE.md) | **Nonlinear Einstein equations:** Deser iterative bootstrap from linearized EFE; converges in 6 iterations to machine precision; 8πG coefficient from G_N=1/(b₃+N_c)²; post-Newtonian expansion verified; 12/12 tests pass |
| 3.45 | [DERIV_BELL_COSINE_FROM_GAUSS.md](03_derivations/DERIV_BELL_COSINE_FROM_GAUSS.md) | **Bell cosine from Gauss constraint:** ∇·J=ρ eliminates 1 DOF → 2D transverse flux → E(θ)=-cos(θ) → S=2√2 (Tsirelson); without constraint S≤2 (Bell); Monte Carlo verified; 13/13 tests pass |
...
| 3.48 | [DERIV_RETARDED_GREEN_LATTICE.md](03_derivations/DERIV_RETARDED_GREEN_LATTICE.md) | **Retarded Phase G** (FTD-0113, May 2026): radiation-zone extension of Phase G. `α_r(r,t,L) := 2r·G^ret_L(r,t)` time-integrates to static Phase G; continuum amplitude 1/(2π) on light cone. Three-line Fourier proof; verified at machine precision (subsidiary of FTD-0004) [DERIVED]. |
| 3.49 | [DERIV_LATTICE_HODGE_DUALITY.md](03_derivations/DERIV_LATTICE_HODGE_DUALITY.md) | **Lattice Hodge duality** (FTD-0114, May 2026): Bianchi identities `∇·(∇×A) = 0`, `∇×(∇φ) = 0` hold exactly on FTD's vertex-centered stencil with centered differences, **independent of Laplacian stencil choice** (G6/G18/G26). No hidden duality-breaking parameter; lattice has the algebraic backbone for Maxwell's homogeneous half [DERIVED]. |
| 3.50 | [DERIV_LATTICE_LIENARD_WIECHERT.md](03_derivations/DERIV_LATTICE_LIENARD_WIECHERT.md) | **Lattice LW + Cherenkov pole** (FTD-0115, May 2026): closed-form lattice boosted Coulomb at uniform velocity via single substitution `(c|k̂|)² → (c|k̂|)² − (k·v)²`. Lattice Cherenkov pole at `|k·v| = c|k̂|` exists at any v > 0 for high-k modes (BZ-edge dispersion); first-pole threshold v_th ≈ 6.62% c_lat at L=16 [DERIVED]. |
| 3.51 | [DERIV_LATTICE_LW_EXTENSIONS.md](03_derivations/DERIV_LATTICE_LW_EXTENSIONS.md) | **Maxwell-exploit thread closure Q5/Q6/Q7/Q8** (FTD-0120, May 2026): Q7 extended-source LW (form-factor substitution) [DERIVED]; Q6 Cherenkov power via Sokhotski-Plemelj on FTD-0115 pole [DERIVED]; Q5 Larmor sinusoidal closed form via Bessel-function expansion, recovers continuum Larmor [PARTIAL DERIVED]; Q8 source-half audit (Gauss to 1e-8, Ampère-Maxwell at O(a²), continuity at machine precision) [VERIFIED]. |
| 3.52 | [EXPLR_FTD_0110_NONLINEAR_BRIDGE_ANALYSIS.md](03_derivations/EXPLR_FTD_0110_NONLINEAR_BRIDGE_ANALYSIS.md) | **FTD-0110 nonlinear-bridge analysis** (FTD-0119, May 2026): empirical k(A) drift fits `¼·(1 − 0.030·ln(A/2))` — logarithmic correction signaling multi-scale physics. Three candidate mechanisms identified (multi-block irrep leakage, genesis-kink mixing, Langevin amplitude-crossover); engine experiments D3a-D3d proposed for discrimination. Bridge gap **sharper but not closed** [BRIDGE-ANALYZED]. |
| 3.53 | **[DERIV_G_STAR_PARITY_TWIST.md](03_derivations/DERIV_G_STAR_PARITY_TWIST.md)** | **G\* as parity-twist between ζ and L(s, χ_{−4}) + complete boundary structure** (FTD-0127, 2026-05-03): operational reading of Theorem 9 (FTD-0112) in L-function language. Result D: `G* = Γ_ζ(1/2)/Γ_{χ_{-4}}(1/2) = Γ(1/4)/Γ(3/4)` — G\* IS the parity-twist between the simplest even and odd Dirichlet L-functions at the critical-line center. Three derived boundary identities: A `L'(0, χ_{-4}) = log(G*/2)` (Lerch, verified to 81 digits); B `L'(1, χ_{-4}) = (π/4)·[γ + log(2π/G*²)]` (functional equation + A); C `L'(1/2, χ_{-4}) = (L(1/2)/2)·[γ + log(2π) − π/2]` (functional equation + Gauss digamma, verified to 62 digits). PSLQ-falsified scoping (Bayes ~10^15): L(1/2, χ_{-4}), Catalan G, ζ(1/2) all NOT in Q(G\*) ∪ standard extensions. Net: BOUNDARY of L(s, χ_{-4})'s critical strip fully closed-form in Q(G\*, γ, π, log π, log 2); CENTER value introduces one new transcendental beyond Q(G\*); ζ itself NOT directly tied to G\*. Subsidiary of Theorem 9; spine count remains 9 [DERIVED]. |
| 3.54 | **[EXPLR_G_STAR_AS_THETA_NULLWERT.md](03_derivations/EXPLR_G_STAR_AS_THETA_NULLWERT.md)** | **G\* as squared theta nullwert of ℤ[i] at CM point** (FTD-0132, 2026-05-03; renumbered from FTD-0129 to resolve ID collision): two-line algebraic identity `G* = √(2π) · θ_3(0|i)²` from Gauss–Jacobi `θ_3(0|i) = π^(1/4)/Γ(3/4)` (~1800) + Euler reflection `Γ(1/4)·Γ(3/4) = π√2` (~1750). **Mathematical content classical, not new** — pedagogical bridge to standard analytic number theory. The π ↔ G\* parallel: `π : ℤ-theta = G\* : ℤ[i]-theta` at the CM point. Operationally answers "why does G\* keep showing up in FTD instead of π?" — answer: FTD's natural lattice is Z[i], not ℤ. Filed [SYNTHESIS] with explicit attribution to classical sources (Gauss, Jacobi, Euler, Hecke, Chowla–Selberg). |
| 3.55 | **[DERIV_NEWTON_FROM_SUBSTRATE.md](03_derivations/DERIV_NEWTON_FROM_SUBSTRATE.md)** | **Newton's law derived from FTD substrate + falsification of "G\_N = 1/100"** (FTD-0131, 2026-05-03 late night): substrate-to-Newton chain via Phase G [THEOREM] (1/r tail of discrete Poisson) + FTD-0110 [DERIVED at linear level] (cluster mass M = N·m_e) + 2 flagged postulates (gravitational coupling form, linearized tick response 2/c²). Recovers Schwarzschild g_00 to leading order. Substrate prediction: α_G(e,e) = (m_e/m_P)² = (√(2π)·(16/3)·α¹¹)² ≈ 1.745×10⁻⁴⁵, matching measured 1.752×10⁻⁴⁵ to **0.38%** via FTD-0015's α¹¹ cascade. Tested and **falsified** the "G\_N = 1/(b\_3+N\_c)² = 1/100" framework-integer claim under all natural readings (factor 8×10¹⁹ off vs K_B = m_e; factor 300 off vs K_B = m_P; factor 6×10⁴² off vs α_G(e,e)). The "1/100" coincidence has no substrate justification. Closes FTD-0130 resolution-path-(a); path-(b) Planck-primary restructuring remains [OPEN]. Tag [DERIVED] with explicit POSTULATE flags; load-bearing epistemic floor inherits FTD-0015's [STRONGLY MOTIVATED CONJECTURE]. |
| 3.56 | **[DERIV_YUKAWA_FROM_27BLOCK_CHARACTER.md](03_derivations/DERIV_YUKAWA_FROM_27BLOCK_CHARACTER.md)** | **Electron Yukawa prefactor `16√2/3` decomposed via O_h character theory + Z[i]-norm** (FTD-0134, 2026-05-04 early morning, partial closure of FTD-0133): `y_e = (16√2/3)·α³` factorizes as `(mult(A_{1g})²/mult(T_{1u}))·\|1+i\|·α^{N_c}`. Each factor independently identified: 16 = mult(A_{1g})² in 27-block (squared scalar-irrep multiplicity, [THEOREM]); 3 = mult(T_{1u}) (vector-irrep multiplicity = N_c, [THEOREM]); √2 = \|1+i\| (norm of prime above 2 in Z[i] = Theorem 8 (1+i)-tower generator, [THEOREM]); α³ = α^{N_c} cumulative ladder step ([DERIVED] post-MC-T3.2). Independent O_h character verification reproduces full 27-block decomposition matching FTD-0110. **Net tag**: [STRUCTURALLY MOTIVATED PARAMETRIC] — each factor [THEOREM]/[DERIVED]; combination as Yukawa coupling [SELECTION] justified by 0.14% empirical match. The √(2π) factor in FTD-0015 m_e formula now reads as `√π·\|1+i\|`, isolating the [SELECTION] floor to `√π` only (from HIGGS-4). Replaces the discredited "√(2π) from Gaussian J-integral" reading (FTD-0032 retracted). Promotion to [DERIVED] requires substrate-level Yukawa-vertex computation (MC-T4.3-class). |
| 3.57 | **[DERIV_GSTAR_QUARTER_CONJUGACY.md](03_derivations/DERIV_GSTAR_QUARTER_CONJUGACY.md)** | **G\* as quarter-conjugacy determinant bridge** (FTD-0141, 2026-05-06, FQCR Model I): operator-theoretic provenance of $G^* = \Gamma(1/4)/\Gamma(3/4)$ via $\det_\zeta$ of the quarter-twisted spectra $\{n+1/4\}$ and $\{n+3/4\}$ from a primitive conjugacy operator $J$ with $J^2 = -I$. Lerch's formula gives $\det_\zeta\{n+a\} = \sqrt{2\pi}/\Gamma(a)$; the $\sqrt{2\pi}$ factors cancel in the ratio. **Complementary** to FTD-0127 parity-twist (number-theoretic / L-function lens); both bottom out at the same identity via different primary structures. Subsidiary to Theorem 1 of the algebraic spine [THEOREM]. |
| 3.58 | **[DERIV_GSTAR_FINITE_APPROX.md](03_derivations/DERIV_GSTAR_FINITE_APPROX.md)** | **G\* as finite-N attractor** (FTD-0142, 2026-05-06, FQCR Model II): $G_N^* := (N+1)^{-1/2}\prod_{n=0}^{N}(n+3/4)/(n+1/4)$ converges to $G^*$ at $O(1/N^2)$ rate with empirical $C \approx 0.046$. **Discharges** the `AUDIT_INFINITY_REFRAME.md` ε-L obligation for $G^*$: the bridge constant is now a finite-N attractor compatible with FTD's undefined-boundary lattice ontology. Verified by `scripts/proofs/proof_fqcr_convergence.py` (all assertions PASS). Subsidiary to Theorem 1 [THEOREM]. |
...
| 4.4 | [DERIV_VACUUM_ENERGY_FORMULA.md](archive/ARCH_DERIV_VACUUM_ENERGY_FORMULA.md) | Cosmological constant |
...
| 7.2 | [AUDIT_SELF_CONSISTENCY.md](07_assessment/AUDIT_SELF_CONSISTENCY.md) | Integer self-consistency proof (6 constraints satisfied); uniqueness open |
| 7.2b | [DERIV_INTEGER_UNIQUENESS.md](07_assessment/DERIV_INTEGER_UNIQUENESS.md) | **Integer uniqueness proven:** Exhaustive search confirms {3,4,7,13} is UNIQUE under combined physics + sequence constraints; 10 solutions exist with physics alone but master quadratic selects N_c=3; 6/6 tests pass |
...
| 7.5 | [AUDIT_NOVEL_PREDICTIONS.md](archive/ARCH_AUDIT_NOVEL_PREDICTIONS.md) | Pre-registered testable predictions |
...
| 7.10 | [TRACKER_ONTIC_TRUTH.md](07_assessment/TRACKER_ONTIC_TRUTH.md) | 🆕 **Canonical bedrock tracker (2026-05-02)** — 5-tier truth ranking (T1 rock-solid → T5 conjecture). Each entry has unique `OT-N.M` ID and points at a verification artifact. Read this FIRST before defending any FTD math claim. |
...
| 7.20 | [LEDGER.md](07_assessment/LEDGER.md) | 🆕 **Master claim ledger v1.0 (2026-04-19)** — single source of truth for claim status. 40 load-bearing claims with tag history, dependencies, dependents, reframe status. Maintenance rule: never delete (retracted claims stay with `tag: RETRACTED`); every tag change requires a `tag_history` entry. Format conforms to `reframe_deployment/templates/LEDGER_ENTRY_TEMPLATE.md`. |
...
| 7.30 | [SESSION_WRAPUP_2026_04_19_evening.md](07_assessment/SESSION_WRAPUP_2026_04_19_evening.md) | 🆕 **Session 2 wrapup (2026-04-19, evening)** — owner-approved decisions executed: α_inf rename (4 files, 23 edits), 5 EFT FLAGs replaced, devil's-advocate PASS-WITH-NOTES queue cleared, `a_phys ≡ ℓ_P` calibration declared in SPEC_FTD.md, top-5 papers Phase 4 restatement, PDF-only triage, YM/NS RE-DERIVE assessment, manuscript propagation rule. Read in sequence with Session 1 wrapup. |
...
| 7.35 | [SESSION_WRAPUP_2026_04_19.md](07_assessment/SESSION_WRAPUP_2026_04_19.md) | 🆕 **Session 1 wrapup (2026-04-19, original)** — what ran in your absence (4 parallel agents: engine audit, devil's advocate, inventory, classifier sweep). 280 artifacts inventoried; 34 papers classified; 3 BLOCKING + 2 HIGH same-day fixes. Read in sequence: Session 1 → Session 2 → Session 3. |
| 7.36 | [SESSION_WRAPUP_2026_04_19_session3.md](07_assessment/SESSION_WRAPUP_2026_04_19_session3.md) | 🆕 **Session 3 wrapup (2026-04-19, owner-approved retractions + repo cleanup)** — RETRACT YM + NS, recover all published docs (+ extensive cleanup of 13 PDF-only papers), remove Codex/Claude from commits via `git filter-repo` (222 → 0 across main + 155+155 across two feature branches), force-push canonical. |
| 7.37 | [ENGINE_AUDIT_FINAL_2026_04_19.md](07_assessment/ENGINE_AUDIT_FINAL_2026_04_19.md) | 🆕 **Final engine audit (2026-04-19, Session 4)** — residual sweep across CUDA/JS/test docstrings beyond Session 2's audit. **Headlines:** CUDA layer clean (0 hits); JS has 3 minor residual items (USER_GUIDE, beyond.js background art, FAQ); C++ tests have informal shorthand (no semantic issues). Engine docs do NOT yet acknowledge the `a_phys ≡ ℓ_P` calibration declaration — recommended banner text included. HIGH=0, MEDIUM=4, LOW=3. |
| 7.38 | [TRACKER_OPEN_ITEMS.md](07_assessment/TRACKER_OPEN_ITEMS.md) | **[OPEN]-items tracker** — every `[OPEN]` claim across code + theory in one place. Pre-existed Session 1; not yet reframe-updated for the resolved items (FTD-0030 a_phys, FTD-0034 EFT FLAGs, etc.). Owner update queued. |
...
| 7.40 | [AUDIT_CONSTANTS_FINAL_2026_04_19.md](07_assessment/AUDIT_CONSTANTS_FINAL_2026_04_19.md) | 🆕 **Final constants audit (Session 4)** — drift sweep after α_inf rename + a_phys calibration. Engine + scripts + dissemination CLEAN of α_inf residue. 1 HIGH (README, fixed), 6 MEDIUM (5 EFT docs prose + WHERE_WE_LEFT_OFF + LEDGER CODATA value — all fixed Session 4). 8 calibration-consistency checks PASS. |
| 7.41 | [AUDIT_MANUSCRIPT_REFRAME.md](07_assessment/AUDIT_MANUSCRIPT_REFRAME.md) | 🆕 **Manuscript v1+v2 audit (Session 4)** — 175 chapters audited against LEDGER. Zero retracted-paper citations. 5 CRITICAL LEDGER mismatches in v2 (sin²θ_W as "D"erived, α/N_c as [T] with 0.21 ppt, Type III₁ as transition, sub-ppt 7-term precision). 5 CRITICAL mismatches in v1. 9 chapters with reframe-language issues. Top priority: ch 13 single-table re-tag. |
| 7.42 | [AUDIT_SPECULATIVE_BOOK_2026_04_19.md](07_assessment/AUDIT_SPECULATIVE_BOOK_2026_04_19.md) | 🆕 **Speculative + Riemann + book audit (Session 4)** — Riemann paper does NOT claim to prove RH; recommendation DEMOTE-IN-PLACE with Canonical-Status preamble. 6 other speculative papers: 2 SURVIVE; 4 NEEDS-OWNER-JUDGMENT (substitution-identity hazard, untagged conjectures — not reframe issues). Book ch 36-45: 1 mechanical edit. |
...
| 7.49 | [AUDIT_DUAL_SUBSTRATE_PROVENANCE.md](07_assessment/AUDIT_DUAL_SUBSTRATE_PROVENANCE.md) | 🆕 **(2026-05-08)** Provenance audit of the dual-substrate decomposition $(J_L, J_R, S, P, \delta)$. Verdict: G\* itself derives from the J chain (FTD-0141, [THEOREM]); the integer 16 has two independent provenance chains (CM auto count, BCC×ternary). But $(S, P) = (16G^{*2}, 16G^{*3})$ are Vieta on the master quadratic, and $\delta^2 = (4G^*-1)/(4G^*) = 1 - 4P/S^2$ is algebraic dressing. The dual-substrate identity is the master quadratic in $(S, P, \delta)$ coordinates, not an independent path. **Recommendations:** (a) trim "five independent lines of evidence" framing in EXPLR_GSTAR_FLUX_TIME §1 to "five readings of the same algebraic structure"; (b) sync `master_quadratic.h` lines 36-40 (carries retracted temporal-gauge DoF count). **No tag changes; no spine demotion.** OPEN: can the J chain extend to derive $(S, P)$ via higher-order determinant invariants? [F1 HYGIENE / AUDIT FINDING] |
| 7.50 | [AUDIT_COMPLETE_FTD_CHAIN_V1.md](07_assessment/AUDIT_COMPLETE_FTD_CHAIN_V1.md) | 🆕 **(2026-05-18)** Intake audit of external draft `C:/Users/cpaci/Downloads/complete_ftd_chain_v1.md`. Verdict: useful synthesis draft, not a canonical replacement. Preserves finite-closure/FQCR/reconstruction framing while requiring tag normalization to canonical `[STRONGLY MOTIVATED CONJECTURE]`, `[SELECTION]`, `[PARAMETRIC]`, and `[OPEN]` statuses before any integration. **Updated after v1.3 doctrine consolidation:** doctrine/audit/roadmap sections were mined into `SPEC_DOCTRINE_LEDGER.md`; downloaded file remains external provenance. |
...
| Order | Document | Description |
|-------|----------|-------------|
| 9.1 | [EXPLR_NUMBER_THEORY.md](09_mathematical/EXPLR_NUMBER_THEORY.md) | Framework integers {3,4,7,13}, 42 nexus, uniqueness analysis (merged) |
| 9.2 | [EXPLR_RIEMANN_ZETA_CONNECTION.md](09_mathematical/EXPLR_RIEMANN_ZETA_CONNECTION.md) | Riemann-zeta connections with rigorous justification audit (merged) |
| 9.3 | [EXPLR_FEIGENBAUM_CONNECTION.md](archive/ARCH_EXPLR_FEIGENBAUM_CONNECTION.md) | Chaos theory links |
| 9.4 | [EXPLR_CURVE_FAMILY_MATHEMATICAL_ANALYSIS.md](09_mathematical/EXPLR_CURVE_FAMILY_MATHEMATICAL_ANALYSIS.md) | Rigorous curve family analysis (12 proven theorems) |
| 9.5 | [EXPLR_RELU_TYPE_TRANSITION.md](09_mathematical/EXPLR_RELU_TYPE_TRANSITION.md) | ReLU as Type III → Type I algebraic transition via β parameter |
| 9.6 | [EXPLR_COLLAPSE_GRAVITY_BRIDGE.md](09_mathematical/EXPLR_COLLAPSE_GRAVITY_BRIDGE.md) | Collapse and gravity as same algebraic type transition via Hawking-KMS bridge |
| 9.7 | [EXPLR_CAYLEY_DICKSON_FOURCIER_ISOMORPHISM.md](09_mathematical/EXPLR_CAYLEY_DICKSON_FOURCIER_ISOMORPHISM.md) | The Fourcier curve IS the division algebra cascade; computationally verified (10/10 predictions) |
...
| 9.28 | [EXPLR_FOURIER_CURVE_LEVEL_4.md](09_mathematical/EXPLR_FOURIER_CURVE_LEVEL_4.md) | **(2026-04-30)** Fourier curve at level 4: triple-cusp structure at cube roots of unity for `a_16 = 1/16`; area = `3π/4 = 3·L(1, χ_{−4})`; Class-3 universal divisibility. Falsified Damerell-basis prior conjecture recorded for the record. Filed as exploratory; not promoted [EXPLORATORY]. |
| 9.29 | [EXPLR_TWO_PI_GSTAR_CONNECTION.md](09_mathematical/EXPLR_TWO_PI_GSTAR_CONNECTION.md) | **(2026-04-30 / 2026-05-01)** Q4 examination of `1/(2π) ↔ G\*` connection. Records the full epistemic trajectory: initial closure (over-aggressive) → reopening as Z-factor [HYPOTHESIS] (FTD-0116) → Q4a numerical FALSIFICATION (Z_FTD = 1.99 on G18, not G\*² = 8.75). The structural connection is exactly the Watson identity already in the spine. Q4 line CLOSED-NEGATIVE with documented failure trajectory. Discipline preserved; FTD-0117 typo bug caught as side effect [CLOSED NEGATIVE]. |
| 9.30 | [EXPLR_PATHS_TO_ALPHA.md](09_mathematical/EXPLR_PATHS_TO_ALPHA.md) | **(2026-05-01)** Exhaustive survey of α-derivation routes. All algebraic combinations of {α, G*, x_+, x_-, 1/(2π), |λ_slow|} reduce to Vieta identities; RG-running with simple β = -c·α requires c ≈ 0.034 (no clean FTD structural origin); EFT routes R1/R2/R3 and Z-factor reading already closed-negative. Honest negative result for the record [NEGATIVE SURVEY]. |
| 9.31 | [EXPLR_TOWER_MULTIPLIER_UNIQUENESS.md](09_mathematical/EXPLR_TOWER_MULTIPLIER_UNIQUENESS.md) | **(2026-05-01)** Substantive positive result: scanned 58 (m, k) pairs in the natural Gaussian-integer-tower family `M_{m,k}(x) = x² − m^k·G*^(k−2)·x + m^k·G*^(k−1)`. (m=2, k=4) is RANK 1 with 5-orders-of-magnitude gap to rank 2. Both selections (m=2 from Z[i] CM ring; k=4 from N_base) are independently structural [STRUCTURAL OBSERVATION]. |
| 9.32 | [EXPLR_POLYNOMIAL_LOOK_ELSEWHERE.md](09_mathematical/EXPLR_POLYNOMIAL_LOOK_ELSEWHERE.md) | **(2026-05-01)** Substantive positive result extending FTD-0097: scanned 147,456 polynomials of form `x² − n·G*^p·x + m·G*^q` (n, m ∈ [1,64]; p, q ∈ [0,5]) at MQ precision tolerances. **Master quadratic is the UNIQUE dual-matcher**. Polynomial-level catalog NOT over-rich — opposite of monomial-level finding [STRUCTURAL OBSERVATION]. |
| 9.33 | [EXPLR_MASTER_QUADRATIC_AS_MIXING_MATRIX.md](09_mathematical/EXPLR_MASTER_QUADRATIC_AS_MIXING_MATRIX.md) | **(2026-05-01)** The master quadratic as the characteristic equation of a 2×2 symmetric mixing matrix with diagonal `8G*²` and off-diagonal `√(64G*⁴ − 16G*³)`, giving eigenvalues (1/α, N_c) = (137.04, 3.02) as symmetric/antisymmetric eigenmode pair with near-maximal (95.7%) coupling. Bonding/antibonding analogy [STRUCTURAL OBSERVATION]. |
| 9.34 | [EXPLR_3X3_MIXING_NEGATIVE.md](09_mathematical/EXPLR_3X3_MIXING_NEGATIVE.md) | **(2026-05-01)** Honest negative: the 2×2 mixing matrix reading does NOT extend cleanly to 3×3 within natural FTD structures. Sub-blocks of A_{1g}, fully-symmetric 3×3, SM-triple targets all fail. The 2-mode reading is structurally specific to (1/α, N_c) [STRUCTURAL OBSERVATION — NEGATIVE]. |
| 9.35 | [EXPLR_VOLUMETRIC_READING_OF_MASTER_QUADRATIC.md](09_mathematical/EXPLR_VOLUMETRIC_READING_OF_MASTER_QUADRATIC.md) | **(2026-05-01)** Corrects the 2×2 mixing matrix reading: it's algebraic re-presentation, not volumetric. The master quadratic IS volumetric via its coefficients' origin in the 3D BCC Watson integral (G*) and O_h trivial-irrep multiplicity (N_base² = 16). Voxel-scale O(1) eigenvalues distinct from cluster-scale O(100) eigenvalues [STRUCTURAL OBSERVATION]. |
| 9.36 | [EXPLR_CONJUGATE_LATTICE_INTERPRETATIONS.md](09_mathematical/EXPLR_CONJUGATE_LATTICE_INTERPRETATIONS.md) | **(2026-05-01)** Three readings of 16 = N_base² in the master quadratic. Reading 1 (SC+BCC interpenetrating) reduces. Reading 2 (real ↔ reciprocal duality) suggestive. Reading 3 (|Aut(E × E)| = 16 from product variety of CM curve) is structurally cleanest, connecting Theorems 3, 4, 8 [STRUCTURAL OBSERVATION]. |
| 9.37 | [EXPLR_CHOWLA_SELBERG_HIGHER_H.md](09_mathematical/EXPLR_CHOWLA_SELBERG_HIGHER_H.md) | **(2026-05-02 / MC-T2.3)** Theory note recording the analytic-machinery list for upgrading Theorem 3 from `[NUMERICAL FACT, h=1 only]` to a structural theorem covering all CM curves. Classical Chowla-Selberg (h=1) → Damerell-Anderson (h≥2) → per-ideal-class master-quadratic-coefficient construction. **§4 item 3 closed via FTD-0123** (`scripts/proofs/proof_chowla_selberg_higher_h_scan.py`): 63 fundamental discriminants in classes 1-4, ZERO h ≥ 2 dual-matchers. Item 4 (structural theorem) remains [OPEN]. |
| 9.38 | [DERIV_BCC_COMPLEX_STRUCTURE.md](09_mathematical/DERIV_BCC_COMPLEX_STRUCTURE.md) | 🆕 **(2026-05-02 / FTD-0122)** BCC complex-structure theorem [DERIVED]. Z[BCC] ⊗ Q decomposes as `V_triv² ⊕ V_sign² ⊕ V_complex²` with V_complex carrying natural Z[i]-module structure ≅ Z[i]². Unifies Roles 1 + 3 of the dual-4 framework via Z[i]; honest no-go for Roles 2 (O_h^ab Klein) + 4 (orbit-count). Verification: `scripts/proofs/proof_bcc_complex_structure.py` (5/5 PASS). Paper B Thm 3.1. |
| 9.39 | [REF_QCR_TRILOGY_BRIDGE.md](09_mathematical/REF_QCR_TRILOGY_BRIDGE.md) | 🆕 **(2026-05-07 / FTD-0144)** QCR-Trilogy bridge [STRUCTURAL CORRESPONDENCE / REFERENCE]. Three authorless mathematical notes (Fourcier dyadic Fourier curves; QC-Recurrences quarter-conjugacy recurrences; Compatibility branch ↔ curve sector pairing) cross-confirm FQCR Models II–V at the formula level: compatibility paper Definition 2.1 $G_N^*$ identical to FTD-0142; Proposition 2.4 relational invariant identical to FQCR Model III Casimir; Proposition 2.6 $z_+ z_- = 1$ identical to master quadratic projective form. Depth-4 five-harmonic example (frequencies $1, 2, 4, 8, 16$) is concrete numerical incarnation of FTD's $(1+i)$-tower at $k=4$ (Theorem 8 / FTD-0111). Verification: `scripts/proofs/proof_fqcr_branch_value.py` (Area = $177\pi/400$; rational + 50-dps numerical). The $6 = 2 \times 3$ sector structure documented interpretation-free per trilogy's own §10 self-restraint. **No spine inflation; no tier promotion; no FTD claim depends on a trilogy conjecture.** |
| 9.40 | [EXPLR_QUARTER_ROTATION_SPHERE_VISUALIZATION.md](09_mathematical/EXPLR_QUARTER_ROTATION_SPHERE_VISUALIZATION.md) | 🆕 **(2026-05-08)** Visualization companion to SPEC_FQCR. 3D quarter-rotation $p(\theta,\phi) = (\cos\theta, \cos\phi\sin\theta, \sin\phi\sin\theta)$ preserves sphere closure $x^2+y^2+z^2=1$ for all $\phi$, while the split-metric scalar $M = x^2+y^2-z^2$ collapses to $\cos(2\theta)$ at $\phi=\pi/2$ (lemniscatic kernel). **Three-trace disambiguation table** for $z^2 - sz + 1 = 0$: $s = G^* \approx 2.96$ (external note's selection; $\chi=0.944$, no canonical FTD reading), $s = 4\sqrt{G^*} \approx 6.88$ (FQCR Model V at $R=1$ ≡ master quadratic; $\chi=1.907$), $s = 3$ (golden trace; $\chi=0.962$, $q=\varphi^{-2}$). No new theorem; no LEDGER row; not on the spine. Imported in response to external note `quarter_rotation_split_geometry_Gstar.md` whose $s=G^*$ selection conflicted silently with the canonical $4\sqrt{G^*}$. [REFERENCE / VISUALIZATION] |
| 9.41 | [EXPLR_FQCR_RESPONSE_LAW_TEST.md](09_mathematical/EXPLR_FQCR_RESPONSE_LAW_TEST.md) | 🆕 **(2026-05-08)** Structural-stability test of the additive response law $R_N(t) = 1 + \lambda_N(4it) + A_N(t)$ ([SPEC_FQCR §3.3](01_reference/SPEC_FQCR.md), [SELECTION]) against multiplicative and exponential alternatives, across $t \in [0.3, 3.0]$, $N \in \{32, 128, 512, 1024\}$. **Key finding:** at $t = 1$, all three laws agree to $\sim 10^{-10}$ — the base point is structurally law-degenerate, so the "9-digit α⁻¹ match at $t=1$" cannot by itself pick the additive law. Real-domain validity, monotonicity, and finite-N convergence all PASS for all three laws; additive has a small edge in real-domain extension to small $t$, multiplicative wins on smoothness by a small margin. **Verdict:** [SELECTION] tag stands; structural-stability does not promote to [DERIVED]. Engages the four open questions (R-law, $16=4^2$, $(4,6;3,2)$, $t=1$) and points at FTD-0143 as the load-bearing follow-up. Script: `scripts/exploration/explore_fqcr_response_laws.py`. [EXPLORATORY] |
| 9.42 | [EXPLR_FQCR_T_SCALE_MAP.md](09_mathematical/EXPLR_FQCR_T_SCALE_MAP.md) | 🆕 **(2026-05-08)** Candidate $t \leftrightarrow$ scale maps for the FQCR Model V branch. Three proposals: heat-kernel ($\mu = m_e/t$), RG-log ($\mu = m_e e^{(1-t)/c}$), lattice-cutoff ($\mu = m_P/\sqrt{t}$). **Key findings:** (1) Map A heat-kernel matches CODATA $\alpha^{-1}(m_e)$ at $t = 1$ by construction; (2) FQCR slope at $\mu \approx 1$ MeV is $\sim 2.5\times$ QED electron-only slope — too fast; (3) FQCR Landau-like point ($x_+ = x_-$) at $t_* \approx 0.062$ corresponds to $\mu \sim 8$ MeV under Map A, $\mu \sim 5 \times 10^{22}$ MeV under Map C — **none match QED's Landau pole at $\sim 10^{280}$ MeV** (off by 270+ orders); (4) Map A's range is bounded and cannot reach muon/tau thresholds. **Verdict:** the FQCR-EM branch readout $x_+(t)$ is not a faithful representation of QED running under any candidate map; SPEC_FQCR §6 Test 3 (running behaviour) remains [OPEN] under the current operator stack. Three closability paths discussed: (C1) extend operator stack with explicit fermion loops, (C2) reinterpret $t$ as non-RG parameter, (C3) accept that $t = 1$ identification is structural-only. Script: `scripts/exploration/explore_fqcr_t_scale_map.py`. [EXPLORATORY] |
| 9.43 | [PROPOSAL_OBSERVER_OPERATOR_EXTENSION.md](09_mathematical/PROPOSAL_OBSERVER_OPERATOR_EXTENSION.md) | 🆕 **(2026-05-08)** Sketch of the C1 path from EXPLR_FQCR_T_SCALE_MAP — extending the FQCR operator stack with observer (vacuum-polarization) content. Identifies the right "observer" reading in REF_REFLEXIVITY_VOCABULARY ("observation layer" = subalgebra restriction = trace-out over fermion sector). **Structural [THEOREM] derived:** $\partial x_+/\partial R\|_{R=1} = -G^*/\delta \approx -3.092$, so QED-faithful running requires fermion-loop coefficient in $R(t)$ to be $\approx 1/3$ of naive QED $b_0$ (specifically $+2\delta/(3\pi G^*) \cdot N_\text{active}$, giving $c_e^{\text{structural}} = +0.0343$). Sketches operator stack extension $\mathcal{T}_N^{\text{ext}}(t) = \mathcal{T}_N(t) \cup \{D^{(e)}_N, D^{(\mu)}_N, D^{(\tau)}_N\}$ with truncated Dirac-style operators per lepton. Identifies chicken-and-egg: muon/tau thresholds under Map A sit *below* the FQCR Landau-like point at $t_* = 0.062$, so a different t-scale map (or analytic continuation past $t_*$) is required. **No tag promotions; no operator stack changes.** [PROPOSAL / SKETCH] |
| 9.44 | [EXPLR_FQCR_OBSERVER_TERM_TEST.md](09_mathematical/EXPLR_FQCR_OBSERVER_TERM_TEST.md) | 🆕 **(2026-05-08)** Empirical test of the structural prediction $c_e = \delta/(3\pi G^*) \approx 0.0343$ from doc 9.43. Two configurations tested: (I) additive supplement $R = 1 + \lambda + A + B^{(e)}$ at structural $c_e$ — **fails** (best-fit $c_e \approx -0.395$, wrong sign and magnitude); (II) clean separation $R = 1 + B^{(e)}$ with $\lambda + A$ removed at structural $c_e$ — **succeeds at slope level**: 0.4-0.6% match to QED's electron-only one-loop running at $\mu \in [5, 10]$ MeV (verified by both finite-difference and analytic chain rule). Constant +0.05-0.07 absolute residual across $t$-range, attributed to higher-order QED + smooth-threshold-form mismatch + pinning offset. **Key structural finding:** $\lambda + A$ in the existing FQCR machinery are NOT vacuum polarization / QED running content; they're geometric/topological structural pieces. The observer for QED-running is a SEPARATE operator-stack contribution. Partial validation of the C1 path — moves from "speculative" to "structurally suggestive." Open: multi-lepton extension; structural derivation of $B^{(l)}$'s functional form; separation principle. Script: `scripts/exploration/explore_fqcr_observer_term.py`. [EXPLORATORY / POSITIVE STRUCTURAL OBSERVATION] |
| 9.45 | [EXPLR_FQCR_MULTILEPTON_TEST.md](09_mathematical/EXPLR_FQCR_MULTILEPTON_TEST.md) | 🆕 **(2026-05-08)** Stage 2 of C1: extends the single-electron observer-term test to all three charged leptons under the structural prediction $c_l = \delta/(3\pi G^*) \approx 0.0343$ (same coefficient for $e, \mu, \tau$). Configuration II (clean separation, no $\lambda + A$). **Three independent slope matches at the structural $c$:** (a) electron-only at $\mu = 10$ MeV — **1.5% match** to QED $-2/(3\pi)$; (b) $e + \mu$ at $\mu = 511$ MeV — **4.5% match** to $-4/(3\pi)$; (c) all-three at $\mu = 5$ GeV — **0.92% match** to $-6/(3\pi)$. Threshold smearing (smooth $\log(1 + x^2)$ form) gives 20-30% errors near regime boundaries; chain-rule factor $\partial x_+/\partial R$ grows ~7% from $R=1$ to deep UV, leading to slope drift. FQCR Landau-like point under multi-lepton at $\mu_* \sim 3.7 \times 10^{21}$ GeV (well above Planck). **Validates C1 structural pathway at three thresholds.** Open: sharper threshold form (replace $\log(1+x^2)$ with $\log\det(L^{(l)} + m_l^2)$); chain-rule-non-constancy treatment (D1/D2/D3 paths discussed); separation principle for $\lambda + A$. Script: `scripts/exploration/explore_fqcr_multilepton.py`. [EXPLORATORY / POSITIVE STRUCTURAL OBSERVATION] |
| 9.46 | [EXPLR_HIGHER_DIM_WATSON.md](09_mathematical/EXPLR_HIGHER_DIM_WATSON.md) | 🆕 **(2026-05-19)** Generalised Watson identity [THEOREM]: $W^{(D)} = {}_DF_{D-1}(\tfrac12,\ldots;1,\ldots;1) = \sum[(\tfrac12)_n/n!]^D$ for integer $D \ge 3$. Q3 closure of the PAPER_GSTAR_INTRODUCTION open-question list. Verified mpmath 50-digit + independent GPU Monte Carlo cross-check (2M BCC random walks, RTX 5090 + CuPy/WSL2). Scripts: `gstar_open_questions.py`, `gstar_W_montecarlo_gpu.py`. |
| 9.47 | [PREREG_SYM_K_C_INVARIANT_PARITY_V1.md](09_mathematical/PREREG_SYM_K_C_INVARIANT_PARITY_V1.md) | 🆕 **(2026-05-19)** Pre-registration of the eigenline-parity hypothesis (H1–H4) for the G* opus follow-up Phase 0, hashed BEFORE any computational evidence per epistemic-rigor discipline. Git tag `preregister-sym-k-c-invariant-parity-v1`. H4 (the load-bearing joint-root assembly hypothesis) was subsequently CONFIRMED in Phase 1 L4 (FTD-0180). [PRE-REGISTRATION] |
| 9.48 | [EXPLR_SYM_PERIOD_ALGEBRA_CONVENTIONS.md](09_mathematical/EXPLR_SYM_PERIOD_ALGEBRA_CONVENTIONS.md) | 🆕 **(2026-05-19)** Working conventions C1–C6 for the symmetric period algebra of $E_\text{lemn}$: Z[i]-action, period values at $\tau=i$, Legendre normalisation, Galois conjugation $c$, and the Hodge complex structure $J$ (C6: $J(\omega)=-i\,\eta/G^*$, $J^2=(-1)^k\,\mathrm{id}$, closed-form $\sigma_{a,b}$). Infrastructure for the G* opus follow-up Phase 0/1. [EXPLR] |
| 9.49 | [DERIV_INTEGER_4_UNIFICATION.md](09_mathematical/DERIV_INTEGER_4_UNIFICATION.md) | 🆕 **(2026-05-19 / FTD-0181)** Integer-4 unification, corrected target T-A2 [THEOREM]. The lemniscatic catalogue 4's classify into 3 classes: (a) unit-derived $|\mu_4|$, (b) discriminant-derived $|\mathrm{disc}\,\mathbb{Q}(i)|$, (c) module-rank $\dim_\mathbb{Z}(\mathbb{Z}[i]^2)$. Load-bearing theorem: $\mathbb{Q}(i)$ is the **unique** imaginary quadratic field with $|\mu_K| = |\mathrm{disc}(K)|$ — this is why the catalogue shows a uniform 4. Corrects the spec-draft error $\mathrm{rank}_\mathbb{Z}(H^1)=4$ (true value 2). Verified `gstar_sym_k_eigenlines.py`. |
| 9.50 | [DERIV_CONJECTURE_16_5_2_CLOSURE.md](09_mathematical/DERIV_CONJECTURE_16_5_2_CLOSURE.md) | 🆕 **(2026-05-19 / FTD-0182)** Closure of Conjecture 16.5.2 (Paper A Conjecture 17.6), G* opus follow-up target T-A3 [DERIVED]. The **reality-collapse lemma** — $\Phi(b')\in\mathbb{R}$ forces $b'$ Q-rational, because $\mathrm{Im}\,\Phi(b')$ is a Q-linear relation among Q-linearly-independent monomial $\Phi$-images ($G^*$ transcendental, Chudnovsky 1976) — collapses the "arbitrary $\mathrm{Sym}^a$ coefficient" residual to the leading-period case, where Theorem 17.5 (H4 confirmed, FTD-0180) gives the $(2,3)$ uniqueness. Per the opus overview, closing this conjecture was the stated requirement for the Paper A Duke/JAMS-grade upgrade. |
| 9.51 | [DERIV_TIER_B_CLOSED_NEGATIVE.md](09_mathematical/DERIV_TIER_B_CLOSED_NEGATIVE.md) | 🆕 **(2026-05-19 / FTD-0183)** G* opus follow-up Tier B (T-B1, T-B2) [CLOSED NEGATIVE]. $\mathrm{mult}(A_{1g})=4$ in the 27-block is the $O_h$-orbit count of the cubic Moore neighbourhood — a crystallographic invariant, not a Z[i] bridge. FTD-0122's own source (`DERIV_BCC_COMPLEX_STRUCTURE.md` §3.2–3.3) already disclaims the connection ("Role 4 = count coincidence"; "dual-4 unifies as 2+2"). Adds class (d) crystallographic orbit-count to the integer-4 taxonomy, disjoint from the Q(i)-arithmetic classes (a)(b)(c). Second over-claim caught in Tier work. |
...
**Scope:** Number-theoretic and algebraic content of FTD's 9-theorem spine; G* identity, master quadratic, FQCR Models I–V, (1+i)-tower, Watson identity, BCC algebra, CM curves, modular structure, polynomial-uniqueness scans.

**Open gaps:** [`SPEC_OPEN_MATH_BY_SECTOR.md` §1](01_reference/SPEC_OPEN_MATH_BY_SECTOR.md#1--pure-mathematics--algebraic-spine).

**Anchor refs (canonical):** `SPEC_ALGEBRAIC_SPINE` (01_), `SPEC_FQCR` (01_), `MONOGRAPH_GSTAR_BRIDGE_CONSTANT` (01_), `MATH_MASTER_QUADRATIC` (01_), `BRIDGE_QUADRATIC_PHYSICS` (01_), `SPEC_DIMENSIONAL_MAP` (01_), `THEOREM_HARMONIC_INVARIANT_TOWER` (03_), `THEOREM_BCC_WATSON_REFLECTION_BRIDGE` (09_), `THEOREM_MOORE_LAYER_DECOMPOSITION` (08_).

**Foundations (02_):** `FOUND_GSTAR_SCALE`, `FOUND_LADDER_GENERATING_RULE`, `FOUND_LADDER_WALK_FROM_OH_STRUCTURE`, `FOUND_MASTER_QUADRATIC_BARE_STRUCTURE`, `FOUND_MASTER_QUADRATIC_UNIFIED_MOTIVATION`, `FOUND_MASTER_QUADRATIC_UNIQUENESS_PROOF`, `FOUND_MINIMUM_DIMENSIONS`, `FOUND_THE_RATIO_AND_THE_PRODUCT`, `FOUND_TERNARY_STATE_FROM_I`, `FOUND_THE_COMPLETE_ALGEBRA_OF_i`, `FOUND_EULER_IDENTITY_TERNARY`, `FOUND_COGITO_AXIOM_AND_FULL_TRACE`, `FOUND_FOURCIER_ONTIC_TOOL`, `DERIV_D3_FROM_AUTOMORPHISM`, `DERIV_D3_UNIQUENESS`.

**Derivations (03_):** `DERIV_GSTAR_FINITE_APPROX` (FQCR II), `DERIV_GSTAR_QUARTER_CONJUGACY` (FQCR I), `DERIV_G_STAR_PARITY_TWIST`, `DERIV_MASTER_QUADRATIC_FROM_Z`, `DERIV_MASTER_QUADRATIC_GAP_EQUATION`, `DERIV_QUADRATIC_NECESSITY`, `DERIV_CHARGE_QUARTIC_FROM_GSTAR`, `DERIV_GAP_EQUATION_FORM`, `EXPLR_G_STAR_AS_THETA_NULLWERT`, `MEASUREMENT_TOWER_LEVEL_SCAN`, `PROTOCOL_TOWER_LEVEL_FALSIFIER`.
...
**Mathematical (09_):** `CONJ_SEVEN_TERM_PRECISION_SERIES`, `DERIV_BCC_COMPLEX_STRUCTURE`, `DERIV_LFUNCTION_GSTAR_CONNECTION`, `DERIV_MASTER_QUADRATIC_CM_LVALUES`, `EXPLR_CHOWLA_SELBERG_HIGHER_H`, `EXPLR_CM_RATIO_TOWER`, `EXPLR_CONJUGATE_LATTICE_INTERPRETATIONS`, `EXPLR_CURVE_FAMILY_MATHEMATICAL_ANALYSIS`, `EXPLR_EULER_RATIO_RICCI_FLOW`, `EXPLR_FOURCIER_KINEMATIC_TOPOLOGY`, `EXPLR_FOURIER_CURVE_LEVEL_4`, `EXPLR_GSTAR_FLUX_TIME`, `EXPLR_HALF_MOBIUS_LEMNISCATE`, `EXPLR_LVALUE_SPAN_CORRECTION_SEARCH`, `EXPLR_MASTER_QUADRATIC_AS_MIXING_MATRIX`, `EXPLR_MODULAR_QUADRATIC`, `EXPLR_NUMBER_THEORY`, `EXPLR_ONTIC_CONSTANT_ATLAS`, `EXPLR_POLYNOMIAL_LOOK_ELSEWHERE`, `EXPLR_QUARTER_ROTATION_SPHERE_VISUALIZATION`, `EXPLR_RIEMANN_ZETA_CONNECTION`, `EXPLR_SPECTRAL_ARTIFACT_DISCOVERY`, `EXPLR_SPECTRAL_CIRCLE_TO_LEMNISCATE`, `EXPLR_TOWER_MULTIPLIER_UNIQUENESS`, `EXPLR_TWO_PI_GSTAR_CONNECTION`, `EXPLR_VOLUMETRIC_READING_OF_MASTER_QUADRATIC`, `EXPLR_WALSH_HADAMARD_B2_ALGEBRA`, `EXPLR_CAYLEY_DICKSON_FOURCIER_ISOMORPHISM`, `EXPLR_FQCR_OBSERVER_TERM_TEST`, `EXPLR_FQCR_RESPONSE_LAW_TEST`, `EXPLR_FQCR_T_SCALE_MAP`, `MATH_ANTI_CORRELATION_THEOREM`, `MATH_FAMILY_OF_RACES`, `MATH_LOG_GSTAR_IDENTITY`, `REF_QCR_TRILOGY_BRIDGE`, `PROPOSAL_OBSERVER_OPERATOR_EXTENSION`.

**Assessment (07_):** `AUDIT_MASTER_QUADRATIC`.
...
**Foundations (02_):** `FOUND_EMERGENT_TIME_GRAVITY`, `FOUND_RELATIVITY_GRAVITY_DISTINCTION`, `FOUND_SPACETIME_EMERGENCE`.
...
**Scope:** Emergence of QM from FTD substrate; Bell violation; Lorentz invariance recovery; observer mechanisms; consciousness/measurement (formal layer).

**Open gaps:** [`SPEC_OPEN_MATH_BY_SECTOR.md` §7](01_reference/SPEC_OPEN_MATH_BY_SECTOR.md#7--quantum-foundations--bell--lorentz).

**Anchor refs:** `REF_REFLEXIVITY_VOCABULARY` (01_; canonical vocabulary).
...
**Foundations (02_):** `FOUND_BRIDGE_FUNCTIONAL` (FTD-0095 mass-functional).
...
**Assessment (07_):** `AUDIT_ENGINE_CALLSTACK`, `DESIGN_RNG_PORTABILITY`, `ENGINE_AUDIT_FINAL_2026_04_19`.
...
**Cross-cutting audits (07_):** `AUDIT_CONSTANTS_FINAL_2026_04_19`, `AUDIT_EPISTEMIC_AUDIT`, `AUDIT_HIDDEN_SELECTIONS`, `AUDIT_LOOK_ELSEWHERE_RESULTS`, `AUDIT_MANUSCRIPT_REFRAME`, `AUDIT_PAPER_SYMPATHETIC_2026-04-28`, `AUDIT_RATIONAL_FIT_CLAIMS`, `AUDIT_SELF_CONSISTENCY`, `AUDIT_SESSION_2026_04_24`, `AUDIT_SPECULATIVE_BOOK_2026_04_19`, `AUDIT_WHAT_IS_GENUINELY_NEW`, `PHYSICIST_REVIEW_2026_04_19`, `PROTOCOL_LOOK_ELSEWHERE_SCAN`.

**Project meta (07_; not strictly math but listed for completeness):** `CHANGELOG_REFRAME`, `DOCS_BUILD_REPORT_SESSION4`, `PARKING_LOT`, `REFACTORING_RECOMMENDATIONS_2026_04_19`, `SESSION_WRAPUP_2026_04_19`, `SESSION_WRAPUP_2026_04_19_evening`, `SESSION_WRAPUP_2026_04_19_session3`, `SESSION_WRAPUP_2026_04_19_session4`, `STATUS_2026-05-04_post_bughunt`, `TEST_REPORT_SESSION4`.
...
| Sector | Anchor refs | Foundations | Derivations | Couplings | Particles | Consciousness | Structural | Mathematical | EFT program | Assessment | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|
