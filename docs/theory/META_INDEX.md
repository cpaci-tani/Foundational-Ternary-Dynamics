...
| 1.17 | **[SPEC_PHYSICS_BRIDGE.md](01_reference/SPEC_PHYSICS_BRIDGE.md)** | **Physics-bridge synthesis (FTD-0121, 2026-05-01):** crystallizes FTD's connection to (1/α, N_c) at its current standing — mathematical spine + empirical match (1.26 ppm + 0.80%) + structural-uniqueness arguments (tower-scan rank-1, polynomial-scan unique dual-matcher) + ~20,000:1 Bayesian evidence for structural-vs-coincidence reading within natural FTD polynomial family. The bridge is "finished as much as current methods allow"; the IDENTIFICATION x_+ = 1/α stays [STRONGLY MOTIVATED CONJECTURE] |
