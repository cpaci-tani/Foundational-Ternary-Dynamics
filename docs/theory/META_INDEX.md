...
| 7.34 | Tag `pre-coauthor-cleanup-2026-04-19` | 🔧 **Backup of pre-rewrite git history (2026-04-19, Session 3)** — points to `bc841fa…` (the HEAD before `git filter-repo` stripped 222 `Co-Authored-By: Claude` trailers from main's commit messages). Delete once force-push to remote is approved and rewritten history is canonical. |
