...
| 10.12 | [OPEN_GC_FROM_FIRST_PRINCIPLES.md](10_eft_program/OPEN_GC_FROM_FIRST_PRINCIPLES.md) | ⚠️ **[OPEN] scoping (2026-04-19)** — Phase I Item 3. Structural statement of the remaining physics required to elevate the master quadratic from [STRONGLY MOTIVATED CONJECTURE] to [THEOREM]: derive g_c = √(2π α_ref) ≈ 0.2141 from the lattice action without inserting α by hand. Three candidate mechanisms identified (Dirac quantisation, lattice matching, fixed-point self-consistency); none closed. Phase H verified the engine scales exactly as `g_c²` once g_c is inserted; producing g_c from first principles is the open question. |
