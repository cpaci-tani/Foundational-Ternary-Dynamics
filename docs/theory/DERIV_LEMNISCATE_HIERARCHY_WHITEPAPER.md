...
3. **Mutual necessity:** Via the Triangle of Necessity (see [MANDELBROT_TRD_DUALITY.md](MANDELBROT_TRD_DUALITY.md) §XI), if one is necessary for physics, both are
...
See [MITOSIS_OF_THE_VOID.md](MITOSIS_OF_THE_VOID.md) for complete derivation and the "void mitosis" interpretation.
