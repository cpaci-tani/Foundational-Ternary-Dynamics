...
- [FOUND_THE_COMPLETE_ALGEBRA_OF_i.md](FOUND_THE_COMPLETE_ALGEBRA_OF_i.md) - Imaginary unit foundations
- [DERIV_LEMNISCATE_HIERARCHY_WHITEPAPER.md](archive/DERIV_LEMNISCATE_HIERARCHY_WHITEPAPER.md) - Full hierarchy
- [EXPLR_FEIGENBAUM_CONNECTION.md](EXPLR_FEIGENBAUM_CONNECTION.md) - Chaos theory connection
- [archive/ARCH_LEMNISCATE_ALPHA_PAPER.md](archive/archive/ARCH_LEMNISCATE_ALPHA_PAPER.md) - Original derivation
