...
- [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) — $f(r) = 1 - r_s/r$, computational budget
- [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) — Same flux $J$ for QFT and GRT
- [DERIV_GSTAR_PF_BRIDGE.md](DERIV_GSTAR_PF_BRIDGE.md) — $G^* = \varpi/\sqrt{\text{PF}}$, PF cancellation
- [FOUND_THE_EXISTENCE_FILTER.md](FOUND_THE_EXISTENCE_FILTER.md) — Projection hierarchy $E(x) \to |x|^2 \to \Phi$
...
From [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md), the Schwarzschild metric arises from computational budget saturation:
...
The proper time formula ([DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) Theorem 5.1):
...
From [DERIV_GSTAR_PF_BRIDGE.md](DERIV_GSTAR_PF_BRIDGE.md) §3.2, express $8\pi$ through FTD integers:
...
**Interpretation** [SELECTION]: The Connes parameter $\lambda_H = e^{-\beta_H}$ depends on PF (geometric packing), so the algebraic type classification contains geometric information. But the thermodynamic observables ($S \times T$) are PF-free — the physics is topological even though the algebraic classification is geometric. This is consistent with the PF cancellation pattern established in [DERIV_GSTAR_PF_BRIDGE.md](DERIV_GSTAR_PF_BRIDGE.md): PF enters intermediate expressions but cancels in physical observables.
...
From [FOUND_THE_EXISTENCE_FILTER.md](FOUND_THE_EXISTENCE_FILTER.md), the projection hierarchy:
...
| [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) | $f(r) = 1 - r_s/r$, computational budget, velocity amplification |
| [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) | Same flux $J$ for QFT and GRT, $T_{\mu\nu}$ via Noether |
| [DERIV_GSTAR_PF_BRIDGE.md](DERIV_GSTAR_PF_BRIDGE.md) | $G^* = \varpi/\sqrt{\text{PF}}$, BH thermodynamics, PF cancellation |
| [FOUND_THE_EXISTENCE_FILTER.md](FOUND_THE_EXISTENCE_FILTER.md) | Projection hierarchy $E \to |\cdot|^2 \to \Phi$ |
