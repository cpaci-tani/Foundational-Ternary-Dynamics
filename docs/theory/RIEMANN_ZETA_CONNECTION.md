...
- **Master quadratic derivation:** `lemniscate_alpha_paper.md`
- **TRD integers:** `FTD_REFERENCE.md` §7
- **Ontological hierarchy:** `ONTOLOGICAL_GENESIS.md`
- **Claims tracking:** `CLAIMS_MATRIX.md`
