...
[5] [SPEC_FTD_LAGRANGIAN.md](SPEC_FTD_LAGRANGIAN.md) — The Born-Infeld action and Euclidean continuation.

[6] [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) — Exact Schwarzschild from latency field.
