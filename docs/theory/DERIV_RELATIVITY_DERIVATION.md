...
| Full Schwarzschild | §11 | [THEOREM] + [SELECTION] | High — See [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) |
...
|-----|-------------|----------|-------------------|
| **GAP-1** | Full Schwarzschild metric ($g_{rr}$) | **RESOLVED** | See [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) — $g_{rr} = -1/f$ from velocity cost amplification |
...
| **GAP-4** | Strong field geodesics | MEDIUM | Now possible — GAP-1 resolved. See [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) |
...
**Not derived:**
- Full Schwarzschild metric — **RESOLVED**: See [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md)
