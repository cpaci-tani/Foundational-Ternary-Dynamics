...
| RT-O5 | Does the $\beta$-$\lambda$ dictionary extend to the FTD reference frame context parameter $\lambda(k) \approx 0.400$? If $\lambda = 0.400 = e^{-\beta}$, then $\beta \approx 0.916$. Does this temperature have physical significance? | Low |
