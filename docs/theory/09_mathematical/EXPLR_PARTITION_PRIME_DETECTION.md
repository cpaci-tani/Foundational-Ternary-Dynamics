...
- [FOUND_LADDER_GENERATING_RULE.md](../02_foundations/FOUND_LADDER_GENERATING_RULE.md) --- k_phys = 16, n_gravity = 20
- [FOUND_FORCE_STRUCTURE.md](../02_foundations/FOUND_FORCE_STRUCTURE.md) --- Force genealogy from G*
