...
**Generated from:** `scripts/verification/results/math_node_map.json` (commit `1632e92`).
...
**Nodes:** 13 spine theorems (T1–T9, S1–S4) + 189 LEDGER claims + 80 mathematical objects + 901 identities.
**Edges:** 1242 total across 5 types (theorem→ledger anchor, ledger→ledger deps, identity→theorem witness, identity→ledger witness, object→identity participation).

**Sectors (with row count):**

- `engine-bridge` — 9 LEDGER rows
- `physics/EM-alpha` — 16 LEDGER rows
- `physics/EW-Higgs` — 2 LEDGER rows
- `physics/QCD` — 9 LEDGER rows
- `physics/QM-foundations` — 12 LEDGER rows
- `physics/flavor` — 5 LEDGER rows
- `physics/gravity` — 2 LEDGER rows
- `pure-math/CM-curves` — 5 LEDGER rows
- `pure-math/G*-family` — 20 LEDGER rows
- `pure-math/Watson-Catalan` — 3 LEDGER rows
- `pure-math/master-quadratic` — 41 LEDGER rows
- `pure-math/modular-FQCR` — 8 LEDGER rows
- `pure-math/structure` — 24 LEDGER rows
- `pure-math/unclassified` — 33 LEDGER rows

**Epistemic tags appearing:**

- `THEOREM` (40, color #2e7d32)
- `CLOSED_NEGATIVE` (19, color #c62828)
- `DERIVED` (15, color #388e3c)
- `MEASURED` (14, color #66bb6a)
- `UNKNOWN` (13, color #bdbdbd)
- `SYNTHESIS` (11, color #00897b)
- `PARTIAL` (11, color #ffb74d)
- `SELECTION` (10, color #fbc02d)
- `POSITIVE` (7, color #43a047)
- `PRE_REGISTRATION` (6, color #1976d2)
- `RETRACTED` (6, color #424242)
- `OPEN` (5, color #757575)
- `CONJECTURE` (4, color #fb8c00)
- `PARAMETRIC` (4, color #9e9e9e)
- `INFRASTRUCTURE` (3, color #00897b)
...
graph LR
    ...
    style FTD_0095 fill:#fbc02d,color:white,stroke:#222,stroke-width:1px
    ...
    FTD_0197["FTD-0197: Ternary-matrix BCC-snap test of a 2026-05-23 us..."]
    style FTD_0197 fill:#c62828,color:white,stroke:#222,stroke-width:1px
    T2 ==> FTD_0001
    T5 ==> FTD_0001
    T8 ==> FTD_0111
    T9 ==> FTD_0112
