...
- [`REF_GUILLERA_CORPUS_MAP.md`](REF_GUILLERA_CORPUS_MAP.md) — Guillera fence (§0); explanation of why this test does not constitute a Guillera↔physics bridge regardless of outcome.
...
- [`DERIV_COLLAPSE_MECHANISM.md`](../06_consciousness/DERIV_COLLAPSE_MECHANISM.md) — canonical collapse proposal; the present run does not engage it.
- [`LEDGER.md`](../07_assessment/LEDGER.md) — see new row FTD-0197.
- [`EXPLR_3X3_MIXING_NEGATIVE.md`](EXPLR_3X3_MIXING_NEGATIVE.md) — sibling 3×3 closed-negative document; same epistemic pattern (a 3×3 promotion that does not extend a 2×2 structure cleanly).
