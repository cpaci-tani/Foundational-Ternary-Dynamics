...
| [EXPLR_GAUSSIAN_EISENSTEIN_DICHOTOMY.md](number_theory/EXPLR_GAUSSIAN_EISENSTEIN_DICHOTOMY.md) | [STRUCTURAL OBSERVATION] + [CLARIFICATION] | Why the master quadratic is uniquely Gaussian (2⁴=4², no Eisenstein twin); G\*³'s odd exponent = D=3 over three Z[i] planes (organized by C₃/⟨111⟩), not Z[ω]; reframes the MC-T4.3 trace/determinant odd-term gap. FTD-0237. |
