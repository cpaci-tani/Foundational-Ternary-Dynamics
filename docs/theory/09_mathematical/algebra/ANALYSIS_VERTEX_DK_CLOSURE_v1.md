...
**Pre-registration:** [`PREREG_VERTEX_DK_CLOSURE_v1.md`](../../10_eft_program/preregistrations/engine_emergence_campaigns/PREREG_VERTEX_DK_CLOSURE_v1.md), lock commit `b46fdfe0`, tag `preregister-vertex-dk-closure-v1` — expectations, criteria, and priors committed before either measurement ran
