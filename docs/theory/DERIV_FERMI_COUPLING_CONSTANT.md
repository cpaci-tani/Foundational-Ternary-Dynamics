...
- $G^*$: Complex Multiplication theory, j = 1728 ([SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) §6)
- $\alpha$: Master quadratic ([SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) §6)
...
|----------|-----------------|
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | Master quadratic, α, framework integers |
...
|----------|----------------|
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | Remove $G_F$ from "External inputs required" list |
| [AUDIT_EPISTEMIC_AUDIT.md](AUDIT_EPISTEMIC_AUDIT.md) | Reclassify $G_F$ from external to derived; update counts |
| [README.md](../../README.md) | Update epistemic notice: $G_F$ no longer external |
| [REF_CLAIMS_MATRIX.md](REF_CLAIMS_MATRIX.md) | Add GF-1 through GF-7 |
