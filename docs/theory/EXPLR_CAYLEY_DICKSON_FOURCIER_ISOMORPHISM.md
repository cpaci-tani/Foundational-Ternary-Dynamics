...
- [EXPLR_FEIGENBAUM_CONNECTION.md](EXPLR_FEIGENBAUM_CONNECTION.md) — Feigenbaum-lemniscate integer encoding
- [DERIV_OCTONIONIC_STRUCTURE.md](DERIV_OCTONIONIC_STRUCTURE.md) — Division algebra origins of FTD
- [SPEC_THE_MASTER_CUBIC.md](SPEC_THE_MASTER_CUBIC.md) — Master cubic and force sectors
- [DERIV_LEMNISCATE_HIERARCHY_WHITEPAPER.md](DERIV_LEMNISCATE_HIERARCHY_WHITEPAPER.md) — Lemniscate curve hierarchy
