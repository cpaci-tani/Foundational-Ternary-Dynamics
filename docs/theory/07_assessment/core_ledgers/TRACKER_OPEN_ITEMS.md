...
- 🔶 **[OPEN — remaining half] SM cluster↔mass re-assessment under the new law + sub-knee onset mechanism (FTD-0110/FTD-0261 successor).** With the current-stack law measured, the open work: (i) does any SM cluster↔mass mapping survive under `N ∝ A^1.86, k_eff ≈ 0.05` (the historical A = 2√R mapping rode on ¼·A²)? The [SMC] identification currently has historical-only evidence. (ii) What sets the knee at A ≈ 16 and the steep p ≈ 3.7 onset (thermal floor falsified; candidates: genesis-kink/β, front-energetics, 27-block escape)? (iii) Does any protocol/config realize the linear theorem's ¼ on the current stack?
...
**Last audit refresh:** 2026-06-10 (FTD-0261: current-stack N(A) law MEASURED — broken power, knee A≈16, k_eff≈0.05; thermostat Outcome A = pure friction; FTD-0259 thermal-knee reading closed negative; remaining [OPEN] = SM re-assessment + sub-knee mechanism. Earlier same day: FTD-0260 resolved by owner decision, fixes shipped; FTD-0259 Mechanism α closed negative).
