...
- 🔶 **[OPEN — narrowed remainder] Sub-knee onset mechanism + the ¼ question (FTD-0261/0262 successor).** (i) What sets the knee at A ≈ 16 and the steep p ≈ 3.7 onset (thermal floor falsified by FTD-0261; candidates: genesis-kink/β, front-energetics, 27-block escape)? (ii) Does any protocol/config realize the linear theorem's ¼ on the current stack? (iii) (deferred, low priority under IDENT-NULL) K/p/τ extension via an L-scan, A ∈ [141, 278].
...
**Last audit refresh:** 2026-06-10 (FTD-0262: SM identification re-assessment IDENT-NULL — anchor holds, no specialness at R_μ; FTD-0110 support inventory documented. FTD-0261: current-stack law MEASURED — broken power, knee A≈16; thermostat = pure friction; FTD-0259 thermal-knee closed. FTD-0260 resolved by owner decision. Remaining [OPEN]: sub-knee mechanism + the ¼ question).
