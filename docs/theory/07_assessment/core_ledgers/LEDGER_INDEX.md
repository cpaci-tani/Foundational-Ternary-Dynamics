...
**Generated** by `scripts/theory/build_ledger_index.py` from `LEDGER.md` (924 claim rows). **Do not edit by hand** — regenerate instead.
...
| [Lorentz recovery & causal structure](#lorentz-recovery-causal-structure) | 33 | The discrete flux pole, anisotropy exponents, the common cone, CFL and causal normalisation, preferred-frame operators, anisotropic-QED RG. |
...
| [Native time & the carrier programme](#native-time-the-carrier-programme) | 182 | The quartic action-angle clock, G* as a temporal invariant, the C1/C2/C3 carrier conditions and every carrier candidate opened against them. |
