...
**Generated** by `scripts/theory/build_ledger_index.py` from `LEDGER.md` (928 claim rows). **Do not edit by hand** — regenerate instead.
...
| [Lorentz recovery & causal structure](#lorentz-recovery-causal-structure) | 34 | The discrete flux pole, anisotropy exponents, the common cone, CFL and causal normalisation, preferred-frame operators, anisotropic-QED RG. |
