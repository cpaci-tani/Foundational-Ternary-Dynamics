...
**Pre-registration:**
[`PREREG_QUADRATIC_COAT_DISCRETE_GRADIENT_TRANSACTION_v1.md`](../../10_eft_program/preregistrations/common_action_mechanics_reciprocity/PREREG_QUADRATIC_COAT_DISCRETE_GRADIENT_TRANSACTION_v1.md)  
**Derivation:**
[`DERIV_QUADRATIC_COAT_DISCRETE_GRADIENT_TRANSACTION.md`](../../10_eft_program/derivations/common_action_mechanics_reciprocity/DERIV_QUADRATIC_COAT_DISCRETE_GRADIENT_TRANSACTION.md)  
