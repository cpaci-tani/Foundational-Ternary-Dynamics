...
**Pre-registration:** [`PREREG_MINIMUM_NORM_TRANSACTION_SELECTOR_v1.md`](../../10_eft_program/preregistrations/common_action_mechanics_reciprocity/PREREG_MINIMUM_NORM_TRANSACTION_SELECTOR_v1.md)  
