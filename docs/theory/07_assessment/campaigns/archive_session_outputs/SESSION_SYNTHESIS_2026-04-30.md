...
The level-4 instance, conjecturally, is the FTD master quadratic, with the master quadratic content playing the role of energy invariant and the reference frame context/physics distinction playing the role of phase-content vs. phase-averaged representation. Not yet proven in this rigorous form; well-defined as research target.
