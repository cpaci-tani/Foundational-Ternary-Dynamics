...
- Anyone who has cloned the repo will need to re-clone or rebase (impact: limited to owner's own clones since `github.com/williamsteinmetz/Foundational-Ternary-Dynamics` is sole-owner).
