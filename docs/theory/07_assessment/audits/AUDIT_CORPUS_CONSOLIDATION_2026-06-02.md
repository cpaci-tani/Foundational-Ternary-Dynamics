...
- `docs/theory/10_eft_program/derivations/alpha_readout_programme/THEOREM_COMMUTATIVITY_INDEPENDENCE.md` (header "Supersedes status of:" line) — update path to archive
- `docs/theory/10_eft_program/preregistrations/quantum_foundations/PREREG_COMMUTATIVITY_INDEPENDENCE_v1.md` — update two references
