...
| 1.M4 | `docs/theory/10_eft_program/archive/resolved/OPEN_A_PHYS_DERIVATION.md` | 81 | MEDIUM | One occurrence in active prose: "The EFT recovery program reports α_∞ ≈ 3.6 × α_ref across L ∈ {64, 128, 256, 384}." | Rename to `α_largeL` (matches the surrounding calibration discourse, which is the new framing). |
