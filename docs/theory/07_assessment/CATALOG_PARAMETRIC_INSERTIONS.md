...
|---|---|---|---|---|
| sin²θ₁₂ | N_c / (N_c + b_3) = 3/10 | 0.300 (exp 0.307) | **[PARAMETRIC]** (FTD-0320 rigidity audit 2026-06-24 dropped the [STRUCTURALLY MOTIVATED] qualifier: **CHANCE_LEVEL**, null p=0.48 — hitting this target at its complexity is routine; downgraded 2026-04-19 → demoted 2026-06-24) | 2.28% error; 4 rational competitors within same tolerance (4/13, 7/23, etc.). `proof_complete_sm.py:229`; `AUDIT_RIGIDITY_CATALOG_v1.md` |
| sin²θ₂₃ | (N_eff + N_c)/(2N_eff + N_c) = 16/29 | 0.552 (exp 0.546) | **[PARAMETRIC]** (FTD-0320 rigidity audit 2026-06-24: **MDL_DOMINATED** — 6/11 is simpler (denom 11<29) AND ~10× more accurate (0.100% vs 1.05%), null p=0.96; the N_eff/N_c story does no work; demoted from [STRUCTURALLY MOTIVATED PARAMETRIC]) | 1.05% error; 6/11 dominates. `proof_complete_sm.py:230`; `AUDIT_RIGIDITY_CATALOG_v1.md` |
| sin²θ₁₃ | 1/(N_base·N_eff) = 1/52 | 0.0192 (exp 0.0220) | **[PARAMETRIC]** (downgraded 2026-04-19; FTD-0320 control: MDL_DOMINATED by 1/41, confirms the rigidity method flags this known mis-prediction) | **12.6% error, 37× experimental precision**; experimental 0.0220 is closer to 1/45 or 1/46 (neither structurally motivated). Essentially a mis-prediction. `proof_complete_sm.py:231` |
| Δm²₃₁/Δm²₂₁ | (b_3+N_c)²/N_c = 100/3 | 33.3 (exp 32.8) | **[PARAMETRIC]** (FTD-0320 rigidity audit 2026-06-24: **MDL_DOMINATED** — 33/1 is simpler AND more accurate (0.610% vs 1.63%), null p=1.00; demoted from [STRUCTURALLY MOTIVATED PARAMETRIC]) | 1.63% error; simpler 33/1 also fits within 1%. `proof_complete_sm.py:232`; `AUDIT_RIGIDITY_CATALOG_v1.md` |
...
|---|---|---|---|---|
| α_s(M_Z) | 7/59 | {b_3 = 7} | **[PARAMETRIC]** (FTD-0310 rigidity audit 2026-06-22 dropped the [STRUCTURALLY MOTIVATED] qualifier: **MDL-DOMINATED** — 2/17 = 0.1176 is *simpler* (denom 17<59) AND *more accurate* (0.215% vs 0.631%), null p=0.90; the 59 denominator does no structural work. CORRECTION 2026-06-19: [THEOREM] of `24b31016` RETRACTED.) | 0.63% error vs 0.1179; the chance-level fit 2/17 dominates. `proof_complete_sm.py:262`; `AUDIT_RIGIDITY_LOADBEARING_v1.md` |
