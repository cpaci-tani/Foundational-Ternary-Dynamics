...
| Continuum α extrapolation (Phase F, 2026-04-19) | 4-point r_max series at consistent r/L≈0.31 and ticks=150, 3 scaling laws all agree | GPU runs at L ∈ {64, 128, 256, 384} | **[MEASURED]** | α_∞ ∈ [3.35×, 3.74×] α_ref; plateau at ~3.6× α_ref. **FTD's Coulomb-tail coupling is 3.6× stronger than CODATA QED** — a falsifiable deviation, not approximate agreement. `DERIV_DAY2_CAMPAIGN.md` §6b + `PAPER §9`. |
