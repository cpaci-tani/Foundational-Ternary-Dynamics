...
| Continuum α extrapolation via 1/L fit (Day 2 Thread 1a) | α(L→∞) = 0.0090 → **1.23× α_ref** (R² = 0.66) | 3 r_max points {L=64,128,256} fit to α = α_∞ + c/L | **[MEASURED]** | `scripts/benchmarks/continuum_extrapolate.py`; 1/L discriminating prediction at L=512: α=0.0119. FTD matches continuum QED to 23% in infinite-volume limit. |
