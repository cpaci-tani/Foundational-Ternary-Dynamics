# ARCHIVED/RETRACTED — Lattice Liénard-Wiechert Potential and Lattice Cherenkov Pole

> **Retraction (FTD-0558, 2026-07-26):** This document used a continuous-time
> seven-point propagator instead of the production discrete-time 18-point map,
> treated array labels as unwrapped crystal momentum, and therefore produced a
> false any-nonzero-speed Cherenkov claim.  The reported `L=16, n=15` threshold
> is the `n=-1` mode with its denominator enlarged by an aliasing error.  This
> file is retained only as provenance.  The corrected active statement is
> `docs/theory/03_derivations/electromagnetism/DERIV_LATTICE_LIENARD_WIECHERT.md`.
