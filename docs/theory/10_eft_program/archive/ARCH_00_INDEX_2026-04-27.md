...
this directory. Status tags reflect the LEDGER (`../07_assessment/core_ledgers/LEDGER.md`)
...
FTD-0013 (physical identification x_+ <-> 1/alpha) remains [STRONGLY
MOTIVATED CONJECTURE]; it never depended on an RG-step reading of the
polynomial. The Link 8 closure (FTD-0050) rules out the
