...
4. **[Priority D]** Update [SPEC_EFT_RECOVERY_PROGRAM.md](../../scopes_and_specs/SPEC_EFT_RECOVERY_PROGRAM.md) to note that the 3.6× plateau is conditional on the current `a_phys` choice, and re-quote the result accordingly.
