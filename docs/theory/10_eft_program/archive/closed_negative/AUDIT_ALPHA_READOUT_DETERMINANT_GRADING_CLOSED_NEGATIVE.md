...
> structure* (`AUDIT_ALPHA_READOUT_DET_IDENTITY_UNDERDETERMINED.md`, FTD-0235:
...
- ARC-C1 / ARC-B2 "FOUND-at-ARC-2" (FTD-0230/0231): **honest status UNDERDETERMINED** (per the independent review + this sharpening). *Recommended downgrade pending owner sign-off; not executed here.*
