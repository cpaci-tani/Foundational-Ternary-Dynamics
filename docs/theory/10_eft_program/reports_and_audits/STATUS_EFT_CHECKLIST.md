...
- [x] FTD-0406 records the explicit owner authorization and installs the default-off CPU v1 selected contract: `U(1)=0`, collision-free energy/momentum projection, local midpoint-CIC string T00/central stress, and latency gravity through `T00/C_SPEED²`. Exact 21/21, native 35/35 twice, neighbors 10/10 and golden 7/7 pass.
- [ ] Extend the selected contract beyond the isolated flat collision-free CPU domain: GPU parity, topology-changing events, moving latency and mixed-force exchange remain open. NCEMC-5/mass readout remains inadmissible until that domain work receives a separate lock.
