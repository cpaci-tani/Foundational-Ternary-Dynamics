...
**Owner adoption ruling (2026-07-17):** ADOPTED ("Let's go with the new derivation. I trust pure math."). Booked as **LEDGER FTD-0388** — the identification [SELECTION — ADOPTED]; the value it selects forced by geometry ([THEOREM] limit + [MEASURED] engine realization). K_MANIFEST → 0.5054620197173260, K_GENESIS → 1.516386059. Engine cutover gated behind the evaporation-parity chip under merge-gate discipline; registry reconciliation booked as explicit debt on the FTD-0388 row.
