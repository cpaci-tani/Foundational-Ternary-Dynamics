...
**Companion docs:**
- [`SCOPE_SPIN2_BOUNDARY_THEOREM.md`](SCOPE_SPIN2_BOUNDARY_THEOREM.md) — Arc C2 P0 scoping (parent; this is its P1 closure)
...
- [`REPORT_GRAVITON_SUBSTRATE_MODE.md`](REPORT_GRAVITON_SUBSTRATE_MODE.md) — FTD-0193 `[CLOSED NEGATIVE]` 2026-05-22 empirical validation
...
- [`PREREG_ALPHA_READOUT_OBSERVABLE_SELECTION_v1.md`](PREREG_ALPHA_READOUT_OBSERVABLE_SELECTION_v1.md) §4 — frozen non-site-local observable catalog Arc C2 inherits
