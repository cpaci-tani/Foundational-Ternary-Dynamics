...
| [`FOUND_MCT43_NATIVE_Z2_PERMANENCE.md`](derivations/FOUND_MCT43_NATIVE_Z2_PERMANENCE.md) | [DERIVED]+[SYNTHESIS] | FTD-0318: no FTD-native ℤ/2 (i-conjugation, ±ω, matter/antimatter, parity, time-reversal) can supply $\delta$ — all are $\mathbb{Q}$-entry, Galois-blind; the $\delta$-selection is a Galois orbit no operator performs. Verdict PERMANENT-EXTENDED; strengthens FTD-0242. Pre-reg: [`PREREG_MCT43_NATIVE_Z2_PERMANENCE_TEST_v1.md`](derivations/PREREG_MCT43_NATIVE_Z2_PERMANENCE_TEST_v1.md). |
