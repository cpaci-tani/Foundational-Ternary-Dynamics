...
| [`DERIV_DISCRETE_TICK_ENERGY_INVARIANT.md`](derivations/DERIV_DISCRETE_TICK_ENERGY_INVARIANT.md) | [THEOREM -- SOURCE-FREE LINEAR TICK] / [OPEN -- LOCAL CURRENT] | Exact modified-energy invariant for the source-free `phase_read`/`phase_write` tick: `0.5 W^2 + E_grad + 0.5 W dot c^2LJ`. FTD-0293 confirms the engine realization; local current remains open. |
