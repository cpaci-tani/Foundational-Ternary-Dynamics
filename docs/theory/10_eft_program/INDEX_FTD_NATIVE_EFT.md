...
| [`PREREG_ALPHA_ESTIMATOR_VALIDATION_v1.md`](preregistrations/PREREG_ALPHA_ESTIMATOR_VALIDATION_v1.md) | [PRE-REGISTRATION -- LOCKED] | FTD-0286 instrument validation after FTD-0285: production live-tick Gauss estimator versus existing matched-stencil EFT projector; no alpha claim can be promoted. |
...
| [`PREREG_ALPHA_ESTIMATOR_VALIDATION_v1.md`](preregistrations/PREREG_ALPHA_ESTIMATOR_VALIDATION_v1.md) | [PRE-REGISTRATION -- LOCKED] | FTD-0286: estimator-validation campaign comparing production live-tick Gauss against the matched-stencil static projector before any renewed no-alpha-vs-Postulate-W question. |
