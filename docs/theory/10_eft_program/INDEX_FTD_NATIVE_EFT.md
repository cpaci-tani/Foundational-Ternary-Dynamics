...
| [`PREREG_THOMSON_UNLOCKED_RECOIL_v1.md`](preregistrations/PREREG_THOMSON_UNLOCKED_RECOIL_v1.md) | [PRE-REGISTRATION -- LOCKED] | FTD-0288: unlocked-charge recoil discriminator after FTD-0287. Separates native legacy force, native emergent flux-gradient force, and explicitly imposed diagnostic qE response; no alpha or cross-section claim. |
