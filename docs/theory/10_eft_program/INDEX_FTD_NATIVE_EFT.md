...
| [`DERIV_DISCRETE_TICK_ENERGY_INVARIANT.md`](derivations/DERIV_DISCRETE_TICK_ENERGY_INVARIANT.md) | [THEOREM -- SOURCE-FREE LINEAR TICK ENERGY AND LOCAL CURRENT] / [OPEN -- COUPLED SOURCE WORK] | Exact modified-energy invariant and finite-volume current for the source-free `phase_read`/`phase_write` tick. FTD-0293 confirms global energy; FTD-0295 confirms local continuity. Coupled source/work remains open. |
