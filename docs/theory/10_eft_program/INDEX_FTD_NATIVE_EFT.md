...
| [`PREREG_THOMSON_FLUX_EXCESS_v1.md`](preregistrations/PREREG_THOMSON_FLUX_EXCESS_v1.md) | [PRE-REGISTRATION -- LOCKED] | FTD-0289: baseline-subtracted flux-excess discriminator after FTD-0288; freezes `charge_plus_beam - beam_only - charge_only` residual gates before run. |
