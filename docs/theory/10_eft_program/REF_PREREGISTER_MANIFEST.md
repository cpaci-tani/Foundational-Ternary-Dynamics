...
| **FTD-0397** `n=11` order-type no-go | `preregister-n11-order-type-no-go-v1` | (tag commit) | `scripts/proofs/proof_n11_order_type_no_go.py` SHA256 `49b8e5b0939547e3cb73635e79e190cf34ba9aea3ecb312f3a52ffcd1cfdb707` | exact integer group action only; all 12 multiset orderings; full `S4` action; no empirical target; executor = current repository session; window = tag creation +72 hours | pending execution | [`PREREG_N11_ORDER_TYPE_NO_GO_v1.md`](preregistrations/PREREG_N11_ORDER_TYPE_NO_GO_v1.md) SHA256 `c2f33663b583f6012ab3e4a8029904493850b5c8f4e447600f1301e0ef713c1d`; result pending |
