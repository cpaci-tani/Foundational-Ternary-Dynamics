...
| FTD ID | Pre-reg tag | Commit | Script | Flags | Output dir | Analysis doc |
|---|---|---|---|---|---|---|
| **FTD-0402** causal normalization and mass-role reconciliation — **LOCKED; execution pending** | `preregister-causal-normalization-mass-roles-v1` | tag commit | prospective `engine/tests/test_causal_normalization.cpp` + `scripts/proofs/verify_causal_normalization_mass_roles.py` (SHA256 values due in result record) | raw nodes/tick; `C=C_SPEED`; `B=u^2/C^2+L^2<1`; `M_INERTIAL=K_B`; `E_REST=K_B*C_SPEED^2`; `M_GRAVITATIONAL=K_B`; CPU/GPU + WASM; outcomes CONSISTENT-RAW / PARTIAL / INVALID; executor = current Codex repository session; 72-hour window ends `2026-07-24T18:43:32Z` | due with frozen result | [`PREREG_CAUSAL_NORMALIZATION_MASS_ROLES_v1.md`](preregistrations/PREREG_CAUSAL_NORMALIZATION_MASS_ROLES_v1.md) (SHA256 `1ebbd3359b8766120feb8cd0bbf372786246a2d2adecc1dc9b240b2ffdbc2ee0`) |
