...
| **FTD-0398** terminal topological-charge transport | `preregister-topological-charge-transport-v1` | (tag commit) | `engine/tests/campaign_topological_charge_transport.cpp` SHA256 `44f8965d167231bad7019b2bbf79fc8f23356dc26a87f6f29d4db3bb11cae12c`; verifier SHA256 `a73e9036f1946039e9eb0496bb7f0719669d020cec264f552e9bb2e2550906b2` | WSL2 `engine/build_wsl`; CPU-forced; `FTD_FORCE_GPU` unset; A/C/E; `L=17`; `t=0..8`; scaled octahedra `R=1..6`; executor=current repository session; window=tag creation +72 hours | pending execution | [`PREREG_TOPOLOGICAL_CHARGE_TRANSPORT_v1.md`](preregistrations/PREREG_TOPOLOGICAL_CHARGE_TRANSPORT_v1.md) SHA256 `50bee4c449b6e66f3cbb4e04717b7c69f86093843991cab9c637476f4d9dce80`; result pending |
