...
| **FTD-0396** nonlinear delta-IND v2 | `preregister-nonlinear-delta-ind-v2` | (tag commit) | `scripts/proofs/proof_nonlinear_delta_ind_v2.py` SHA256 `f4624e066131fe43f775b8d334d06893d7af0d978e5e07b8b0673215c08c94f5` | spec-level exact arithmetic only; algebraic parameters; two rungs; delta valuation gated behind properness; executor = current repository session; window = tag creation +72 hours | pending execution | [`PREREG_NONLINEAR_DELTA_IND_v2.md`](preregistrations/PREREG_NONLINEAR_DELTA_IND_v2.md) SHA256 `5179b24c480cf89be6fb4b0e4fc6df2a72fdb995c2180e94f697244532394385`; result pending |
