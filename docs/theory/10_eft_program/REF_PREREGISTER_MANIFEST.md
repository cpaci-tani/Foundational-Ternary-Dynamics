...
| **FTD-0399** target-blind particlehood | `preregister-target-blind-particlehood-v1` | (tag commit) | `engine/tests/campaign_target_blind_particlehood.cpp` SHA256 `14833be2d81d31b682af73b51618126fa9a6c1991b2d965d0538a907c367b501`; verifier SHA256 `a35a7c1b2a4b50818678cc59fcf4343d6d818bde61171813fd5bfa370d1e75d0` | WSL2 `engine/build_wsl`; CPU-forced; `FTD_FORCE_GPU` unset; A/C/E; dissipative+undamped; `L=33,65`; `t_post=0..12/24`; radius-4 raw profiles; internal+external duplicates; executor=current repository session; window=tag creation +72 hours | pending execution | [`PREREG_TARGET_BLIND_PARTICLEHOOD_v1.md`](preregistrations/PREREG_TARGET_BLIND_PARTICLEHOOD_v1.md) SHA256 `dc9c78f1b34d8de13853a8ec2468a0f85d45ff7907b3ec01946dbad8c4c1eac6`; result pending |
