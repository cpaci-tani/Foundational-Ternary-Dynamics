...
- Complementary boundary route (same even-power wall, different mechanism): [`PREREG_ALPHA_READOUT_BOUNDARY_v2.md`](../preregistrations/PREREG_ALPHA_READOUT_BOUNDARY_v2.md) + [`DERIV_ALPHA_READOUT_BOUNDARY.md`](../archive/closed_negative/DERIV_ALPHA_READOUT_BOUNDARY.md) (ARC-A1 v2, FTD-0238/0239, UNDERDETERMINED); [`THEOREM_COMMUTATIVITY_INDEPENDENCE.md`](../derivations/THEOREM_COMMUTATIVITY_INDEPENDENCE.md) (supersedes `SYNTHESIS_COMMUTATIVITY_BOUNDARY_2026-05-30.md`, now archived).
