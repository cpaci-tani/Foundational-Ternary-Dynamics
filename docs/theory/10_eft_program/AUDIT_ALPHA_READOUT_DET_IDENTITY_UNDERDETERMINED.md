...
**Date:** 2026-05-28
**Result of:** `PREREG_ALPHA_READOUT_DET_IDENTITY_v1.md` (FTD-0219 provisional → consolidated under LEDGER FTD-0224), SHA256 `03b967c760fa38fffa8c7d08d5a75c34392dcd2c4c546f24a9c58b4d97a78122` (commit deferred by owner).
...
> honest verdict is **UNDERDETERMINED** (this also softens the FTD-0217 parity
...
**FTD-0217 parity "no-go" is therefore scoped, not fundamental**: it showed only
that the ingredients `{16, G*², winding}` — which *exclude* the det_ζ ratio — are
even-degree and cannot reach the odd `16G*³`. Admitting the det_ζ ratio (`= G*`,
a clean forward **odd** scalar; FTD-0218) supplies the missing odd degree
...
|---|---|---|
| Independent review of the "FOUND" | FTD-0224 | overclaim → **UNDERDETERMINED** |
| Determinant grading (parity) | FTD-0217 | **CLOSED-NEGATIVE — scoped** (frozen set *excluding* det_ζ; superseded as operative obstruction) |
| Odd period via J-twisted det_ζ | FTD-0218 | **UNDERDETERMINED** (clean odd scalar `G*` exists; `Det=Tr·G*` unforced) |
| det↔det_ζ identity (this) | FTD-0219 | **UNDERDETERMINED** (assemblable from forward scalars but unforced) |
