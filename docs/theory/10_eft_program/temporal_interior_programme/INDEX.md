...
disagree, the LEDGER wins. Booked rows: **`FTD-0804` … `FTD-0818`**
(2026-08-07 and 2026-08-08). Charter:
[`SCOPE_TEMPORAL_INTERIOR_PROGRAM_v1.md`](SCOPE_TEMPORAL_INTERIOR_PROGRAM_v1.md),
which remains `[DRAFT FOR OWNER RATIFICATION]` — booking the rows did not
ratify it.
...
## 1. Charter and criteria specs — `FTD-0806`

| document | role |
|---|---|
| [`SCOPE_TEMPORAL_INTERIOR_PROGRAM_v1.md`](SCOPE_TEMPORAL_INTERIOR_PROGRAM_v1.md) | two set types (succession P2, potentiality P3); three purchased structures; fronts T1–T5 |
...
24 files, all self-verifying (each prints a `[verify]` block and asserts
...
- The two-body Lorentz sector (`FTD-0815`), which is clock-gated on the
  carrier work above.
- Native C3 (`FTD-0805`): integer unit-strut tensegrities, the lens family
  having been killed mod 4.
