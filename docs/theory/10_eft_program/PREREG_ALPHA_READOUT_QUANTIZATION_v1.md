...
**LEDGER row reservation:** FTD-0216  
**Companion docs:** `../01_reference/SPEC_ALPHA_READOUT_CONTRACT.md`, `../10_eft_program/AUDIT_CHARGE_QUANTIZATION_NO_CHEAT.md` (FTD-0211, charge quantization audit).
