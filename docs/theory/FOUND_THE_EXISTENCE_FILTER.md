...
**Proposition EF-C1** [CONJECTURE] (Level Correspondence). Each projection in the hierarchy operates at a specific level of the FTD ontological hierarchy ([FOUND_ONTOLOGICAL_GENESIS.md](FOUND_ONTOLOGICAL_GENESIS.md)):
...
**Proposition EF-T6** [SELECTION] (E(x) and the First Distinction). The First Distinction $0 = (+1) + (-1)$ ([SPEC_THE_MASTER_QUADRATIC_UNIFIED.md](SPEC_THE_MASTER_QUADRATIC_UNIFIED.md), Part I; [FOUND_THE_FIRST_DISTINCTION.md](FOUND_THE_FIRST_DISTINCTION.md)) is proposed as structurally analogous to the Existence Filter evaluated at the primordial polarity pair.
...
**At Level $0.5+$:** After self-reference creates $i$ ([FOUND_THE_COMPLETE_ALGEBRA_OF_i.md](FOUND_THE_COMPLETE_ALGEBRA_OF_i.md)), states become genuinely complex: $x = a + bi$. Now the Existence Filter performs non-trivial work — it strips the imaginary part, retaining only what survives reflection:
...
Cross-reference: [DERIV_QUANTUM_MECHANICS_RESOLVED.md](DERIV_QUANTUM_MECHANICS_RESOLVED.md), §2.4; [FOUND_CONSCIOUSNESS_MATHEMATICS.md](FOUND_CONSCIOUSNESS_MATHEMATICS.md), Part VI.
...
Apply $E$ to the roots of the master quadratic $z^2 - kG^{*2}z + kG^{*3} = 0$ ([SPEC_THE_MASTER_QUADRATIC_UNIFIED.md](SPEC_THE_MASTER_QUADRATIC_UNIFIED.md)):
...
|-------------------|------------------|-----|
| [FOUND_THE_FIRST_DISTINCTION.md](FOUND_THE_FIRST_DISTINCTION.md) | $0 = (+1) + (-1)$ | Identified as EF-T6: the Existence Filter at Level $-1$ |
| [DERIV_QUANTUM_MECHANICS_RESOLVED.md](DERIV_QUANTUM_MECHANICS_RESOLVED.md) | Born rule $P = |\psi|^2$ | Placed in hierarchy (EF-D3) and reconstructed from $E$ (EF-T5) |
...
| [DERIV_BOTTOM_UP_PHYSICS.md](DERIV_BOTTOM_UP_PHYSICS.md) | Ghost invisibility | Algebraic formula: $E(bi) = 0$ (EF-C2) |
...
| Document | Relevance |
|----------|-----------|
| [FOUND_THE_FIRST_DISTINCTION.md](FOUND_THE_FIRST_DISTINCTION.md) | $0 = (+1) + (-1)$ as Existence Filter at Level $-1$ |
| [FOUND_THE_COMPLETE_ALGEBRA_OF_i.md](FOUND_THE_COMPLETE_ALGEBRA_OF_i.md) | $i$ from self-reference$^2$; Born rule as $\mathbb{C} \to \mathbb{R}$ projection |
...
| [DERIV_QUANTUM_MECHANICS_RESOLVED.md](DERIV_QUANTUM_MECHANICS_RESOLVED.md) | Born rule $P = |\psi|^2$, collapse = manifestation |
...
| [SPEC_THE_MASTER_QUADRATIC_UNIFIED.md](SPEC_THE_MASTER_QUADRATIC_UNIFIED.md) | Discriminant $\Delta(k)$, physics roots vs consciousness roots |
| [DERIV_BOTTOM_UP_PHYSICS.md](DERIV_BOTTOM_UP_PHYSICS.md) | Ghost/Body/Void ontology |
| [FOUND_ONTOLOGICAL_GENESIS.md](FOUND_ONTOLOGICAL_GENESIS.md) | Level hierarchy ($-3$ to $12$) |
