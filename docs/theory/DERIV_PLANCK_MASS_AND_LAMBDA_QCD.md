...
| [DERIV_HIGGS_FROM_MANIFESTATION.md](DERIV_HIGGS_FROM_MANIFESTATION.md) | v = M_P√(2π)α⁸ |
| [DERIV_FERMI_COUPLING_CONSTANT.md](DERIV_FERMI_COUPLING_CONSTANT.md) | G_F derivation |
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | m_e, α, sin²θ_W formulas |

## 5.2 Documents That Should Be Updated

| Document | Update Needed |
|----------|--------------|
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | Remove G_F, Λ_QCD from "External inputs"; clarify M_P as sole axiom |
| [AUDIT_EPISTEMIC_AUDIT.md](AUDIT_EPISTEMIC_AUDIT.md) | Reclassify G_F and Λ_QCD; update counts |
| [DERIV_COMPLETE_PARTICLE_PHYSICS.md](DERIV_COMPLETE_PARTICLE_PHYSICS.md) | Update epistemic notice |
