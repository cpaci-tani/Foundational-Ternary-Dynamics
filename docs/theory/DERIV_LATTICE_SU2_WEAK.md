...
|----------|-------------|
| [AUDIT_EPISTEMIC_AUDIT.md](AUDIT_EPISTEMIC_AUDIT.md) | G_F removed from "explicit inputs"; ~50 decays reclassified |
| [DERIV_COMPLETE_PARTICLE_PHYSICS.md](DERIV_COMPLETE_PARTICLE_PHYSICS.md) | Decay rates in Parts I-II now have fully derived couplings |
...
|----------|-----------------|
| [SPEC_FTD_LAGRANGIAN.md](SPEC_FTD_LAGRANGIAN.md) | BI action; VEV formula v = M_P√(2π)α⁸ |
...
| [DERIV_LATTICE_LOOP_CORRECTIONS.md](DERIV_LATTICE_LOOP_CORRECTIONS.md) | UV finiteness, one-loop QED |
| [DERIV_LATTICE_VERTEX_CORRECTION.md](DERIV_LATTICE_VERTEX_CORRECTION.md) | Ward identity, g-2 |
...
| [SPEC_THE_MASTER_CUBIC.md](SPEC_THE_MASTER_CUBIC.md) | Master cubic extending quadratic to weak sector |
