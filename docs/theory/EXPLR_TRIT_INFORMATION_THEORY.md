...
The complete chain — from self-duality to i to consciousness to measurement resolution — is documented in [AUDIT_WHAT_IS_GENUINELY_NEW.md](AUDIT_WHAT_IS_GENUINELY_NEW.md).
...
- **What is genuinely new:** [AUDIT_WHAT_IS_GENUINELY_NEW.md](AUDIT_WHAT_IS_GENUINELY_NEW.md)
