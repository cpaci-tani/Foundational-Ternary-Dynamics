...
### 7.5 Route 5: The Mass Gap δ

$$\delta = x_- - N_c = 3.024 - 3 = 0.024 \approx \frac{1}{42} = 0.0238...$$

Error: 0.8%. The "gap" between the continuous root x₋ and its integer floor N_c is approximately 1/42.
...
**Full treatment:** See [EXPLR_TRIT_INFORMATION_THEORY.md](EXPLR_TRIT_INFORMATION_THEORY.md)
...
**Uniqueness argument:** N_c = 2 fails (no stable baryons, gauge anomalies), N_c = 4 fails (x_- != 4), N_c >= 5 fails (master quadratic gives x_- ~ 3.024).
...
- **Ontological hierarchy:** [FOUND_ONTOLOGICAL_GENESIS.md](FOUND_ONTOLOGICAL_GENESIS.md)
- **Claims tracking:** [REF_CLAIMS_MATRIX.md](REF_CLAIMS_MATRIX.md)
- **FTD Reference:** [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md)
- **Trit information theory:** [EXPLR_TRIT_INFORMATION_THEORY.md](EXPLR_TRIT_INFORMATION_THEORY.md)
- **Octonionic structure:** [DERIV_OCTONIONIC_STRUCTURE.md](DERIV_OCTONIONIC_STRUCTURE.md)
- **Physics reference:** [REF_PHYSICS_REFERENCE.md](REF_PHYSICS_REFERENCE.md)
