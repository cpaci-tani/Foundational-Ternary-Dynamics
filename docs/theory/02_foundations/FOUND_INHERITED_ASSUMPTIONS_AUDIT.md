...
| 11 | **The field and locality** | inherited | discrete flux ⊥ state fields; Moore-local causality (P4); **classical electromagnetism is `[DERIVED]`** (retarded radiation, Bianchi identities, boosted Coulomb, Larmor) | **REBUILT** (classical EM) | P4; FTD-0113–0120; Phase-G |
