...
**Tag:** [STRONGLY MOTIVATED CONJECTURE] — comparable in epistemic standing to the master quadratic identification `x_+ ≈ 1/α` (1.26 ppm, FTD-0013). The strength here is:
