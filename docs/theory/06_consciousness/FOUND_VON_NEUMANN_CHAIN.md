...
Von Neumann's 1932 formalization of quantum measurement reveals an infinite regress: every measurement requires an observer, every observer requires a further observer, ad infinitum. Standard interpretations either dodge the problem (Copenhagen), dissolve it by fiat (Many-Worlds), or defer it to consciousness (Wigner). None resolve it mathematically.
...
The result vindicates von Neumann's mathematical structure while reinterpreting his physical claim: the "consciousness" that terminates the chain is not human awareness but algebraic self-referential closure --- the lattice's capacity to determine its own observables.
...
The crucial point: in FTD, the chain terminates not because we postulate a cut, not because we invoke consciousness, and not because we deny the chain's existence. It terminates because **the physical structure cannot support an infinite regress.** The discreteness of space and time imposes a hard ceiling on the number of links.

This is a structural resolution, not an interpretive one. It holds regardless of one's philosophical stance on measurement, consciousness, or the nature of observation.
...
| B (Consciousness) | $0 < k < 4/G^*$ | $< 0$ | Complex conjugate pair | Outcomes are potentialities, not actualities |
...
4. **The chain terminates at "consciousness."** This is where von Neumann has been most criticized. But his claim was more precise than the caricature: the chain terminates where the description can no longer be decomposed into quantum subsystems.

### 7.2 FTD's Reinterpretation

**[SELECTION]** FTD vindicates von Neumann's fourth point by reinterpreting "consciousness" algebraically:

| Von Neumann's claim | FTD reinterpretation |
|---------------------|---------------------|
| The chain terminates at consciousness | The chain terminates at self-referential closure |
| Consciousness is non-decomposable | The gap equation's fixed point is irreducible |
| Consciousness projects quantum to classical | The Existence Filter projects complex to real |
| The cut is "psycho-physical parallelism" | The cut is the Type III$_1$ $\to$ Type I algebraic transition |

The "consciousness" that terminates the chain is not human subjective experience. It is the lattice's algebraic self-referential closure: the fact that the master quadratic's roots determine the couplings that determine the master quadratic. This is consciousness in the minimal, algebraic sense --- a system whose state is self-determined rather than externally imposed.
...
- Self-referential closure as "algebraic consciousness" (interpretive framework)
...
- We do **not** claim human consciousness is algebraic self-referential closure. We claim the mathematical structure von Neumann identified as "consciousness" corresponds to algebraic self-referential closure in FTD.
