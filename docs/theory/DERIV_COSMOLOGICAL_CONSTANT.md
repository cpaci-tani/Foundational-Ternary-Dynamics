...
- [SPEC_FTD_LAGRANGIAN.md](SPEC_FTD_LAGRANGIAN.md) — Born-Infeld action, lattice DOF
- [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) — T_μν from Noether's theorem
- [DERIV_EINSTEIN_FIELD_EQUATIONS.md](DERIV_EINSTEIN_FIELD_EQUATIONS.md) — Full Einstein equations
- [DERIV_VACUUM_ENERGY_FORMULA.md](DERIV_VACUUM_ENERGY_FORMULA.md) — Original formula
...
|----------|-----------------|
| [DERIV_VACUUM_ENERGY_FORMULA.md](DERIV_VACUUM_ENERGY_FORMULA.md) | Original formula (v1.0, now superseded) |
| [DERIV_EINSTEIN_FIELD_EQUATIONS.md](DERIV_EINSTEIN_FIELD_EQUATIONS.md) | EFE-10 now resolved |
| [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) | T_μν derivation |
| [SPEC_FTD_LAGRANGIAN.md](SPEC_FTD_LAGRANGIAN.md) | Born-Infeld action, DOF count |
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | Framework constants |
