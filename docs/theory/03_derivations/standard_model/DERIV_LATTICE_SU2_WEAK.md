...
## 3.1 The Weinberg Angle [THEOREM] (FTD-0018)

**Theorem 3.1 (Weinberg Angle from Geometric Projection).** *The weak mixing angle is the projection of the orthogonal Cartesian sublattice onto the full Moore neighborhood:*
...
| SU2-5 | sin²θ_W = 3/13 = 0.23077 | **[THEOREM]** (FTD-0018) | 0.19% agreement with PDG (§3.1) | DERIV_WEINBERG_STRONG_GEOMETRY.md |
