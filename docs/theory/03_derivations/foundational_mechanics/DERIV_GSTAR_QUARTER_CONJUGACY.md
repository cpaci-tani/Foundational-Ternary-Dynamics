...
- **Does not derive the master quadratic.** The polynomial $x^2 - 16G^{*2}x + 16G^{*3} = 0$ retains its existing provenance (coefficient 16 from $|\text{Aut}(E)|^2$, etc.). The transfer-matrix interpretation (FQCR Model V) is a notational reframing of the same polynomial, not a new derivation.
