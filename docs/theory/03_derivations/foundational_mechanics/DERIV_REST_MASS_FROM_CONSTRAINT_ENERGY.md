...
**Status:** [CLOSED — §5 identification REFUTED, and the route it opened is CLOSED as currently posed: genesis's locked energy is circumstance-dependent (9.2× spread across birth energies, monotonic, not noise — fourth amendment below), so no single "mass excess" exists for this proposal to even be conditionally rescued by. Preserved for provenance per the project's documentation-cleanup discipline; not archived, since the four amendments are the record of a same-day, fully-measured line of inquiry, not dead weight]. Provisional AI-derived content, not externally reviewed. Registered 2026-07-19; closed 2026-07-19.
...
| Genesis's own operating point on this response curve | **[REFUTED — no single operating point exists]**, PREREG_MANIFESTATION_SEED_DIVERSITY_v1: three cleanly-valid, independently-constructed births give `e_half` = 0.782 / 1.709 / 7.221 (cold/baseline/hot), CV=0.878, 9.2× spread, **monotonic in birth energy** — not noise around a stable value |
