...
| Sharper hypothesis: any single-site asymmetric field perturbation (independent of the drain's scaling) is sufficient to inject curl | [OPEN — named, not yet tested] |
