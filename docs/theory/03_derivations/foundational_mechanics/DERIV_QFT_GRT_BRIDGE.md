...
- [DERIV_STATE_FLUX_COUPLING_DERIVATION.md](../electromagnetism/DERIV_STATE_FLUX_COUPLING_DERIVATION.md) — Vertex factor g_c = √α
- [DERIV_RELATIVITY_DERIVATION.md](../gravity_and_cosmology/DERIV_RELATIVITY_DERIVATION.md) — Linearized Einstein (Theorem 14.1)
...
- [DERIV_STATE_FLUX_COUPLING_DERIVATION.md](../electromagnetism/DERIV_STATE_FLUX_COUPLING_DERIVATION.md) — g_c = √α derivation
