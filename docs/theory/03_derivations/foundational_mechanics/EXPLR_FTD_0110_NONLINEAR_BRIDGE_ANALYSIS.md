...
- **NOT a new theorem.** The spine count is unchanged — nine numbered results (seven theorem-grade + two honestly-tiered — Theorem 3 at its arithmetic core only; see `SPEC_ALGEBRAIC_SPINE.md` §0 count convention); FTD-0110 main claim remains [STRONGLY MOTIVATED CONJECTURE] for the full nonlinear regime.
