...
- FTD-0110 status: **unchanged** — linear k = ¼ `[DERIVED]`; nonlinear bridge `[OPEN]` (per the FTD-0110 resolution audit; the stale TRACKER "CLOSED" line is corrected); clustermass identification `[STRONGLY MOTIVATED CONJECTURE]`. **Nothing promoted.**
