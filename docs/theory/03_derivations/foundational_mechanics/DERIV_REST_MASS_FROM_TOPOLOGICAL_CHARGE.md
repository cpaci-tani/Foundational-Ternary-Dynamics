...
See `docs/theory/10_eft_program/preregistrations/framework_boundary_imports_consumption/PREREG_HEDGEHOG_CHARGE_ROBUSTNESS_v1.md` for the locked falsifier, frozen reading bands, and full outcome.
