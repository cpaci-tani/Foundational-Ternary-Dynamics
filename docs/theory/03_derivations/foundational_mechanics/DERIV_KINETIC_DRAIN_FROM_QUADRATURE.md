...
**Pre-registration (Leg A):** [`PREREG_DRAIN_SCALING_v1.md`](../../10_eft_program/preregistrations/sm_constants_mass_flavour/PREREG_DRAIN_SCALING_v1.md), tag `preregister-drain-scaling-v1`, lock commit `1dc4db23`.
