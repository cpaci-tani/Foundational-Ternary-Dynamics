...
| [ANALYSIS_BETA_ENVELOPE_MODEL_v1.md](foundational_mechanics/ANALYSIS_BETA_ENVELOPE_MODEL_v1.md) | [MEASURED — BETA-PARTIAL] (FTD-0264, 2026-06-10) | Parameter-free envelope model of the sub-knee onset: dispersion check corrected (exact Symplectic Euler arcsin formula), elbow knee_N = 13.1 matches target range (PASS), shape RMS = 0.749 (FAIL); kinetics/back-reaction are load-bearing. |
