...
140 active docs in this cluster (+ 16 archived, verified 2026-08-06). This local index curates the load-bearing subset across the foundational_mechanics / electromagnetism / standard_model / quantum_mechanics / gravity_and_cosmology subdirectories; the master catalog is [`../META_INDEX.md`](../META_INDEX.md).
