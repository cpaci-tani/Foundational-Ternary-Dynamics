...
| [DERIV_MASTER_QUADRATIC_FROM_Z_RETRACTED.md](../archive/DERIV_MASTER_QUADRATIC_FROM_Z_RETRACTED.md) | **[RETRACTED 2026-04-19]** (FTD-0032) | Historical partition-function route to the master quadratic; polynomial algebra survives independently, but this is not an active physics derivation. |
| [DERIV_GAP_EQUATION_FORM_RETRACTED.md](../archive/DERIV_GAP_EQUATION_FORM_RETRACTED.md) | **[RETRACTED — physics closure]** (FTD-0032) | Historical one-loop argument for the screened gap-equation form; conditional algebra survives, but the operator assembly was not forced. |
| [DERIV_THREE_RESOLUTIONS.md](foundational_mechanics/DERIV_THREE_RESOLUTIONS.md) | [HISTORICAL SYNTHESIS] | Third (one-loop) closure withdrawn with FTD-0032; first two claims require separate adjudication. |
