...
| [ANALYSIS_THERMOSTAT_OFF_SWEEP_v1_INVALID.md](foundational_mechanics/ANALYSIS_THERMOSTAT_OFF_SWEEP_v1_INVALID.md) | [INVALID RUN — V-1 0/11, diagnosed] + [OBSERVATION — load-bearing] (FTD-0260, 2026-06-10) | The run of record: gates fired; constants + rig fidelity eliminated by git-verification; **the engine's ic1 phenomenology changed ~6× since April under identical config** — FTD-0110's empirical baseline provenance-pinned to `87158aef`; NEW [OPEN] ic1 regression bisect; v2 blocked on it. |
