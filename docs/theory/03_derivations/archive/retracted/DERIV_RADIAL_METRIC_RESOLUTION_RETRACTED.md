...
**Status:** **[RETRACTED 2026-07-02 — invalid proof; FTD-0361]** (was: [THEOREM])
...
> `MONOGRAPH_EFFECTIVE_EQUATIONS.md` §7.1).** This document's central proof is invalid:
> its conclusion contradicts its own premise, and its claim contradicts the corpus's
