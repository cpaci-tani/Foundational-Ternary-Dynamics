...
produces x₊ = 137.036 (≈ 1/α) and x₋ = 3.024. In PF notation (see [DERIV_DISCRETE_CONTINUOUS_BRIDGE.md](../../04_coupling/DERIV_DISCRETE_CONTINUOUS_BRIDGE.md), Theorem 1.1):
...
|--------|-----------|-----------|----------------|
| **Δ > 0** | kG* > 4 | Two real distinct roots | Physics (k = 16: α) |
| **Δ = 0** | kG* = 4 | One degenerate root | Measurement (k_crit = 4/G* ≈ 1.352) |
| **Δ < 0** | kG* < 4 | Complex conjugate pair | Reference frame context (k = 1/2: y ≈ 2.19 ± 2.86i) |
