...
- [DERIV_KCOMP_VOLUMETRIC_SHELL.md](DERIV_KCOMP_VOLUMETRIC_SHELL.md) -- Dynamical mechanism closing the joint-probability gap (Section 6.3)
...
## 7. Connection to the Existence Filter and Consciousness
...
| k = 1/2 (consciousness) | Delta < 0 | Complex conjugate pair | Observer (non-factorizable experience) |
