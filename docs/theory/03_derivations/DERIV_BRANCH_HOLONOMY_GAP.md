...
- **Sibling overlays** (same campaign): [`DERIV_Z3_CENTER_GRAPH_CLOSURE.md`](DERIV_Z3_CENTER_GRAPH_CLOSURE.md) (Z_3 color-center closure, FTD-0195), [`../05_particles/EXPLR_GENERATION_GRAPH_GAMMA_D.md`](../05_particles/EXPLR_GENERATION_GRAPH_GAMMA_D.md) (generation graph `Γ_F(d)`, `[CANDIDATE RECONSTRUCTION]`, FTD-0196).
