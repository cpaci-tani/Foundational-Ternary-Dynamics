...
| Document | Content |
|----------|---------|
| [DERIV_FORCE_EMERGENCE.md](DERIV_FORCE_EMERGENCE.md) | All 4 forces from lattice Green's functions |
| [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) | Propagator, vertex, stress-energy tensor, Moller scattering |
| [DERIV_STATE_FLUX_COUPLING_DERIVATION.md](DERIV_STATE_FLUX_COUPLING_DERIVATION.md) | $g_c = \sqrt{\alpha}$ derivation |
| [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) | Schwarzschild from computational budget |
| [DERIV_VARIATIONAL_PROOF.md](DERIV_VARIATIONAL_PROOF.md) | $\delta S = 0$ reproduces all update rules (59 checks) |

## Wave 2: One-Loop QED + Black Holes

| Document | Content |
|----------|---------|
| [DERIV_LATTICE_LOOP_CORRECTIONS.md](DERIV_LATTICE_LOOP_CORRECTIONS.md) | Vacuum polarization $\Pi(k)$, QED beta function |
| [DERIV_LATTICE_SELF_ENERGY.md](DERIV_LATTICE_SELF_ENERGY.md) | Self-energy $\Sigma(p)$, mass renormalization |
| [DERIV_LATTICE_VERTEX_CORRECTION.md](DERIV_LATTICE_VERTEX_CORRECTION.md) | Vertex $\Lambda_\mu$, $g - 2 = \alpha/(2\pi)$ |
| [DERIV_LATTICE_KERR.md](DERIV_LATTICE_KERR.md) | Kerr metric from vortical flux |
| [DERIV_LATTICE_REISSNER_NORDSTROM.md](DERIV_LATTICE_REISSNER_NORDSTROM.md) | Reissner-Nordstrom from EM anti-saturation |

## Wave 3: Non-Abelian Gauge Sectors + Higgs

| Document | Content |
|----------|---------|
| [DERIV_LATTICE_SU3_GAUGE.md](DERIV_LATTICE_SU3_GAUGE.md) | SU(3) gauge theory from flux geometry |
| [DERIV_LATTICE_SU2_WEAK.md](DERIV_LATTICE_SU2_WEAK.md) | SU(2) weak sector, $G_F$ derived, ~50 decay rate upgrades |
| [DERIV_HIGGS_FROM_MANIFESTATION.md](DERIV_HIGGS_FROM_MANIFESTATION.md) | Higgs mechanism from manifestation dynamics |

## Wave 4: Formal QFT Completion

| Document | Content |
|----------|---------|
| [DERIV_PATH_INTEGRAL_CONSTRUCTION.md](DERIV_PATH_INTEGRAL_CONSTRUCTION.md) | Path integral $Z[\mathbf{J}]$, generating functional, effective action |
| [DERIV_LATTICE_CHIRAL_ANOMALY.md](DERIV_LATTICE_CHIRAL_ANOMALY.md) | Chiral anomaly, $\pi^0 \to \gamma\gamma$, baryogenesis |
| [DERIV_TWO_LOOP_ALPHA.md](DERIV_TWO_LOOP_ALPHA.md) | Two-loop $\alpha$ correction, road to sub-ppm |
...
| [SPEC_THE_MASTER_QUADRATIC_UNIFIED.md](SPEC_THE_MASTER_QUADRATIC_UNIFIED.md) | Master quadratic (16 algebraic forms) |
| [DERIV_DISCRETE_CONTINUOUS_BRIDGE.md](DERIV_DISCRETE_CONTINUOUS_BRIDGE.md) | Master quadratic as domain connector |
| [DERIV_GSTAR_PF_BRIDGE.md](DERIV_GSTAR_PF_BRIDGE.md) | $G^* = \varpi/\sqrt{\text{PF}}$ decomposition |
| [FOUND_ONTIC_MATHEMATICAL_FOUNDATIONS.md](FOUND_ONTIC_MATHEMATICAL_FOUNDATIONS.md) | Constant chain $\gamma \to \varpi \to M \to \pi \to G^*$ |
| [DERIV_ALPHA_PRECISION_FORMULA.md](DERIV_ALPHA_PRECISION_FORMULA.md) | 4-term precision formula |
| [DERIV_LAMBDA_QCD_DERIVATION.md](DERIV_LAMBDA_QCD_DERIVATION.md) | $\Lambda_{\text{QCD}}$ from dimensional transmutation |
| [AUDIT_EPISTEMIC_AUDIT.md](AUDIT_EPISTEMIC_AUDIT.md) | Honest derivation accounting |
| [DERIV_COMPLETE_PARTICLE_PHYSICS.md](DERIV_COMPLETE_PARTICLE_PHYSICS.md) | Full PDG coverage |
