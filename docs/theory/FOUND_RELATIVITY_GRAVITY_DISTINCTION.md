...
**Depends on:**
- [DERIV_RELATIVITY_DERIVATION.md](DERIV_RELATIVITY_DERIVATION.md) — SR derivation (Part I) and g₀₀ from flux saturation (Part II, Theorem 11.1)
- [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) — Combined proper time formula, velocity cost amplification
- [DERIV_FORCE_EMERGENCE.md](DERIV_FORCE_EMERGENCE.md) — Newtonian gravity as weak-field limit
- [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) — Linearized GR (propagators, wave equations)
- [SPEC_QFT_GRT_BRIDGE_ROADMAP.md](SPEC_QFT_GRT_BRIDGE_ROADMAP.md) — Gap analysis (GAP-G2, GAP-G4, GAP-G5)
...
From this single axiom, the following are **complete theorems** (proven in [DERIV_RELATIVITY_DERIVATION.md](DERIV_RELATIVITY_DERIVATION.md) Part I):
...
From [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) §1-2: each lattice node receives one unit of computational budget per Universal Tick. This budget is distributed between:
...
**The availability factor** (from Theorem 11.1 in [DERIV_RELATIVITY_DERIVATION.md](DERIV_RELATIVITY_DERIVATION.md)):
...
The actual formula (Theorem 6.1 from [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md)) is:
...
|----------|-------------|
| [DERIV_RELATIVITY_DERIVATION.md](DERIV_RELATIVITY_DERIVATION.md) | SR derivation (Part I); gravity/g₀₀ (Part II §9-11) |
| [DERIV_LATTICE_SCHWARZSCHILD.md](DERIV_LATTICE_SCHWARZSCHILD.md) | Combined proper time formula; velocity cost amplification; budget conservation |
| [DERIV_FORCE_EMERGENCE.md](DERIV_FORCE_EMERGENCE.md) | Newtonian gravity as Green's function (weak-field limit) |
| [DERIV_QFT_GRT_BRIDGE.md](DERIV_QFT_GRT_BRIDGE.md) | Linearized GR; graviton propagator; gravitational wave equations |
| [SPEC_QFT_GRT_BRIDGE_ROADMAP.md](SPEC_QFT_GRT_BRIDGE_ROADMAP.md) | Full GRT gap analysis (GAP-G2, GAP-G4, GAP-G5) |
| [EXPLR_COLLAPSE_GRAVITY_BRIDGE.md](EXPLR_COLLAPSE_GRAVITY_BRIDGE.md) | Gravity as spatial crystallization; Hawking-KMS bridge |
