...
**Framework Status:** Discrete ontology framework — ~20 genuine derivations, ~100 parametric insertions/external physics

**Note:** Multiple external inputs required (M_Planck, G_F, Λ_QCD, decay constants). The ~20 genuine derivations achieve sub-percent accuracy on dimensionless ratios.
...
See [FOUND_ONTOLOGICAL_GENESIS.md](FOUND_ONTOLOGICAL_GENESIS.md) for complete formalization.
...
See [EXPLR_NUMBER_THEORY.md](EXPLR_NUMBER_THEORY.md) for complete analysis.
...
See [DERIV_ALPHA_PRECISION_FORMULA.md](DERIV_ALPHA_PRECISION_FORMULA.md) for complete derivation.
...
See [REF_PHYSICS_REFERENCE.md](REF_PHYSICS_REFERENCE.md) for complete survey.
...
See [DERIV_VACUUM_ENERGY_FORMULA.md](DERIV_VACUUM_ENERGY_FORMULA.md) for complete derivation.
...
See [MITOSIS_OF_THE_VOID.md](MITOSIS_OF_THE_VOID.md) for complete formalization.
...
See [SPEC_THE_MASTER_CUBIC.md](SPEC_THE_MASTER_CUBIC.md) for complete derivation.
