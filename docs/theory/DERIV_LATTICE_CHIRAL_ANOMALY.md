...
- [DERIV_LATTICE_LOOP_CORRECTIONS.md](DERIV_LATTICE_LOOP_CORRECTIONS.md) -- Vacuum polarization, UV finiteness (Theorem 1.4), naive fermion propagator and doubler analysis (Section 1.3)
...
- [DERIV_COMPLETE_PARTICLE_PHYSICS.md](DERIV_COMPLETE_PARTICLE_PHYSICS.md) -- Quark charges, pion mass, decay constants
...
An alternative resolution preserves a modified chiral symmetry via the Ginsparg-Wilson relation:

$$\{D, \gamma_5\} = a\, D\gamma_5 D$$

This allows a lattice-modified $\gamma_5$ symmetry that reproduces the correct anomaly without doublers. The overlap and domain-wall fermion formulations implement this relation.

**Status [OPEN]:** Ginsparg-Wilson fermions provide a more elegant treatment of chiral symmetry on the lattice. Their incorporation into the FTD program is noted as future work. For the present derivation, Wilson fermions suffice to establish the anomaly coefficient.
...
| [DERIV_LATTICE_LOOP_CORRECTIONS.md](DERIV_LATTICE_LOOP_CORRECTIONS.md) | Vacuum polarization, naive fermion propagator, doubler analysis |
| [DERIV_LATTICE_VERTEX_CORRECTION.md](DERIV_LATTICE_VERTEX_CORRECTION.md) | One-loop vertex: same Feynman rules, sister computation |
| [DERIV_LATTICE_SELF_ENERGY.md](DERIV_LATTICE_SELF_ENERGY.md) | Electron self-energy: completes one-loop QED on the lattice |
...
| [DERIV_COMPLETE_PARTICLE_PHYSICS.md](DERIV_COMPLETE_PARTICLE_PHYSICS.md) | Quark charges, CKM phase, pion mass |
| [DERIV_STATE_FLUX_COUPLING_DERIVATION.md](DERIV_STATE_FLUX_COUPLING_DERIVATION.md) | $g_c = \sqrt{\alpha}$ from master quadratic |
| [SPEC_FTD_LAGRANGIAN.md](SPEC_FTD_LAGRANGIAN.md) | FTD Lagrangian, action principle, Gauss constraint |
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | Master reference for all FTD results |
| [AUDIT_EPISTEMIC_AUDIT.md](AUDIT_EPISTEMIC_AUDIT.md) | Classification of derivations vs parametric insertions |
