...
| [SPEC_FTD_REFERENCE.md](SPEC_FTD_REFERENCE.md) | Technical reference manual |
| [DERIV_QUANTUM_MECHANICS_RESOLVED.md](DERIV_QUANTUM_MECHANICS_RESOLVED.md) | QM derivation (Hilbert space construction) |
