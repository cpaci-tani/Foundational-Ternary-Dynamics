...
This is the master quadratic coefficient. With `K = 16 G*^2`, the roots are `x_+ ≈ 137.036` and `x_- ≈ 3.024`; the physics reading `x_+ = 1/alpha` remains [STRONGLY MOTIVATED CONJECTURE] (FTD-0013).
