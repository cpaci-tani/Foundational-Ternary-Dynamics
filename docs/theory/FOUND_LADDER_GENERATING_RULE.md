...
**Depends on:**
- [FOUND_DEEP_HIERARCHY.md](FOUND_DEEP_HIERARCHY.md) --- Alpha-power ladder and three quadratics
- [EXPLR_ONTIC_CONSTANT_ATLAS.md](EXPLR_ONTIC_CONSTANT_ATLAS.md) --- Complete constant catalog
...
- **Constant atlas**: [EXPLR_ONTIC_CONSTANT_ATLAS.md](EXPLR_ONTIC_CONSTANT_ATLAS.md)
