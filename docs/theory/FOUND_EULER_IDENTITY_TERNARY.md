...
- **Related:** [SPEC_THE_MASTER_QUADRATIC_UNIFIED.md](SPEC_THE_MASTER_QUADRATIC_UNIFIED.md) — Master quadratic forms
- **Related:** [FOUND_CONSCIOUSNESS_MATHEMATICS.md](FOUND_CONSCIOUSNESS_MATHEMATICS.md) — Consciousness quadratic (k = 1/2 domain)
- **Related:** [FOUND_THE_EXISTENCE_FILTER.md](FOUND_THE_EXISTENCE_FILTER.md) — Born rule as C → R projection
