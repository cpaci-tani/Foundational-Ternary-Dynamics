...
| U-11 | the empirical bridge catalog (~131 [PARAMETRIC] + ~50 external) | IMP-E2/E3 | per-row tags in CATALOG_PARAMETRIC_INSERTIONS.md; **no identification in the catalog is scan-rigid — the count is zero (FTD-0791, 2026-08-03)**. This entry formerly read "exactly one identification is scan-rigid (U-4)"; the FTD-0319 scan behind that claim was audited and sits at its own null's expectation (1.42–1.67 matchers expected, 1 found), and is retagged [MEASURED] → [SELECTION] |
