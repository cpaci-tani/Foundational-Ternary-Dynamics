...
**Status:** `[AXIOM]`-class Framework Commitment (a declaration, **not** a derivation) — **FTD-0303** (registered 2026-06-15)
...
| **FC-3** | **scale-ratio-covariance: only internal ratios are physical; `a`, `L` are observation scales** | **FTD-0303** |
...
- FC-3 itself is an `[AXIOM]`-class Framework Commitment (a declared choice), **FTD-0303**.
...
- ~~Register FC-3 in `SPEC_FTD_FRAMEWORK_V1.md` (the constitution) and add the **FTD-0303** LEDGER row.~~ **DONE — 2026-06-15.**
