...
| FTD-0127: parity-twist (L-function lens) | **Complementary**, not competing. Both bottom out at $\Gamma(1/4)/\Gamma(3/4)$ but via distinct primary structures (parity decomposition of $\zeta$ vs $L(s,\chi_{-4})$ on FTD-0127's side; $J$-action on FQCR's side). A unification linking $\chi_{-4}(n) = i^{n-1}$ to $J$-eigenvalues is a future refactor. |
