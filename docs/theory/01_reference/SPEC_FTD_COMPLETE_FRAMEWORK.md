...
| **Native rest-mass gap / topological anchor** | **`[MEASURED — CLOSED NEGATIVE]`** for the probed native mass gap (FTD-0362); FTD-0392's local charge is zero at freeze and FTD-0398's terminal larger-shell test is **`[UNDERDETERMINED]`**, supplies no mass evidence, and licenses no geometry retry. | LEDGER FTD-0362/0392/0398 |
