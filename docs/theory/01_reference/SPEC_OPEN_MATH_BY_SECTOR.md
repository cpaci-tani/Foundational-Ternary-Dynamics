...
| NCEMC | Native Confinement Energy–Momentum Contract (FTD-0400): define one backend-common `H_strong` generating the force, exact work accounting, complete momentum, and field-only gravity sourced by the same object. FTD-0402 implements the normalization subcontracts; FTD-0403 closes their targeted dependency surface. No mass measurement before NCEMC itself closes | [OPEN — admissible; separate lock required] | M–RP | eng-SU3 |
...
| §12-mgcurv | Mass-gap to curvature source. FTD-0400 proves the implementation is split; FTD-0402 repairs the normalization layer and FTD-0403 closes its targeted dependency surface, but neither supplies common stress–energy. Closure requires NCEMC-1–4 before any curvature measurement | [OPEN — blocked on NCEMC] | RP | NCEMC |
