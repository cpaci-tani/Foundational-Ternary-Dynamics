...
```
G* = Γ(1/4) / Γ(3/4) = 2.9586751192...

Equivalently: G* = √2 × Γ(1/4)² / (2π)

Verification:
  Γ(1/4) = 3.62560990...
  Γ(3/4) = 1.22541670...
  G* = 3.62560990... / 1.22541670... = 2.9586751192...
```
...
Coefficients (verified):
  a = 1
  b = -16(G*)² = -16 × 8.75376... = -140.0601...
  c = 16(G*)³ = 16 × 25.89953... = 414.3924...

Discriminant:
  D = b² - 4ac = 19616.84... - 1657.57... = 17959.27...
  √D = 134.0122...
```
...
**PMNS CP Phase** [OPEN — conjecture, not derivation]:
```
δ_PMNS = π + arctan(N_base/N_c) = π + arctan(4/3) = 233.1°
```
Experimental: 222° ± 38° (0.29σ). Motivation: {N_c, N_base} = {3, 4} are legs of the 3-4-5 Pythagorean triple (N_c² + N_base² = 25 = 5²). CKM uses arctan(b_3/N_c) where b_3 = N_c + N_base; PMNS uses arctan(N_base/N_c). The π offset is conjectured from antifermion boundary conditions but **not derived**. The 38° experimental error bar means this is not yet a meaningful test.
...
KEY CONSTANT:  G* = Γ(1/4)/Γ(3/4) = 2.9586751192  [≡ √2·Γ(1/4)²/(2π)]
