...
| §II.4 — K-BIND `[OPEN]` | Irreducible obligation: substrate must natively realize √(G*(4G*−1)); ARC-D1 [CLOSED NEGATIVE]; no operator calculus | [`SPEC_ALPHA_READOUT_CONTRACT.md`](SPEC_ALPHA_READOUT_CONTRACT.md) §5D; [`../10_eft_program/derivations/DERIV_ALPHA_READOUT_EMPIRICAL.md`](../10_eft_program/derivations/DERIV_ALPHA_READOUT_EMPIRICAL.md) (ARC-D1 closure); [`../07_assessment/core_ledgers/TRACKER_ONTIC_TRUTH.md`](../07_assessment/core_ledgers/TRACKER_ONTIC_TRUTH.md) OT-5.1 |
...
| §III.4 — What would close the gap | Exit 1: 6th-postulate W forcing operator assembly (K-BIND `[OPEN]`); Exit 2: fresh ARC-D measurement (ARC-D1 `[CLOSED NEGATIVE]`) | [`SPEC_ALPHA_READOUT_CONTRACT.md`](SPEC_ALPHA_READOUT_CONTRACT.md) §5D; [`../07_assessment/audits/AUDIT_RSI_LEG3_CONDITIONAL_THEOREM.md`](../07_assessment/audits/AUDIT_RSI_LEG3_CONDITIONAL_THEOREM.md) §5; [`../10_eft_program/derivations/DERIV_ALPHA_READOUT_EMPIRICAL.md`](../10_eft_program/derivations/DERIV_ALPHA_READOUT_EMPIRICAL.md) |
