...
|---|---|---|
| §0.1 — The discrete ontology | Five postulates `[AXIOM]`; two-layer ontology (flux J, state s); undefined-boundary lattice commitment | [`../07_assessment/AUDIT_INFINITY_REFRAME.md`](../07_assessment/framework_postulates_constitution/AUDIT_INFINITY_REFRAME.md) — undefined-boundary triage and foundational commitment |
...
| §I.2 Route 3 — det_ζ quarter-conjugacy `[THEOREM — CONDITIONAL DOMAIN]` (OT-1.7, FTD-0141; scope corrected FTD-0839) | Registered anchored chiral J-twisted determinant ratio = G*; `J²=-I` alone does not force the domain; full-line control ratio = 1 | [`SPEC_FQCR.md`](SPEC_FQCR.md) Model I; [`../03_derivations/foundational_mechanics/DERIV_GSTAR_QUARTER_CONJUGACY.md`](../03_derivations/foundational_mechanics/DERIV_GSTAR_QUARTER_CONJUGACY.md) §5 (OT-1.7) |
...
| §I.4 — Tower-discriminant transcendence `[CONDITIONAL THEOREM given Chudnovsky 1976]` (OT-2.2) | A_k transcendental for k ≥ 4; conditional on Chudnovsky 1976 (Waldschmidt 2000 §1.4) | [`SPEC_ALGEBRAIC_SPINE.md`](SPEC_ALGEBRAIC_SPINE.md) §8 |
...
| §I.4 — χ_{-4} unification, η-tower, Sym²⊕Sym³ exponent constraints (OT-2.5, OT-2.6, OT-2.7) | The numeric identities are `[THEOREM]`s conditional on Deligne/Chowla–Selberg; the Sym²⊕Sym³ exponent story *(corrected 2026-07-02, FTD-0356, per FTD-0351)*: constraint set {a<b<2a} ∪ {b=2a+1} `[THEOREM]`; the "(2,3) uniquely minimal-a" claim **RETRACTED** (minimal-a survivor is (1,3)); the (2,3) choice `[SELECTION]` conditional on W-CRIT-2 (FTD-0235) | [`SPEC_ALGEBRAIC_SPINE.md`](SPEC_ALGEBRAIC_SPINE.md); [`../07_assessment/core_ledgers/LEDGER.md`](../07_assessment/core_ledgers/LEDGER.md) FTD-0163, FTD-0175 |
...
| §II.4 — K-BIND `[CLOSED THEOREM-NEGATIVE]` | Irreducible obligation: substrate must natively realize √(G*(4G*−1)); ARC-D1 [CLOSED NEGATIVE]; operator calculus axiomatization closed negative | [`SPEC_ALPHA_READOUT_CONTRACT.md`](SPEC_ALPHA_READOUT_CONTRACT.md) §5D; [`../10_eft_program/derivations/FOUND_OPERATOR_CALCULUS_AXIOMATIZATION.md`](../10_eft_program/derivations/alpha_readout_programme/FOUND_OPERATOR_CALCULUS_AXIOMATIZATION.md) (FTD-0244); [`../07_assessment/core_ledgers/TRACKER_ONTIC_TRUTH.md`](../07_assessment/core_ledgers/TRACKER_ONTIC_TRUTH.md) OT-5.1 |
...
| §II.6 — Scoped conclusion | Four attempted routes and the axiomatized operator calculus do not force α; MC-T4.3 remains `[OPEN — SCOPED NO-GO PACKAGES]`; FTD-0013 stays `[STRONGLY MOTIVATED CONJECTURE]`; N_c = 3 contrast | [`../07_assessment/core_ledgers/LEDGER.md`](../07_assessment/core_ledgers/LEDGER.md) FTD-0013/0412; [`SPEC_DOCTRINE_LEDGER.md`](SPEC_DOCTRINE_LEDGER.md) §14; [`../03_derivations/standard_model/DERIV_NC_FROM_TOPOLOGY.md`](../03_derivations/standard_model/DERIV_NC_FROM_TOPOLOGY.md); retracted facade: [`../04_coupling/archive/retracted/DERIV_ALPHA_READOUT_RESOLUTION.md`](../04_coupling/archive/retracted/DERIV_ALPHA_READOUT_RESOLUTION.md) (archived) |
...
| §III.2 — Structural-uniqueness evidence ⚠ **WITHDRAWN** | **FTD-0791 (2026-08-03): there is no structural-uniqueness evidence.** The FTD-0319 scan sits at the chance base rate — null expects 1.42–1.67 matchers, scan found 1, and the second leg eliminates nothing at the operative gate. Retagged [MEASURED] → [SELECTION]; **scan-rigid count zero**. *(Formerly: "0 non-G* dual-matchers / 2.65M polynomials; rank 1 by ~130×; Eisenstein-family null; h≥2 null", with the "Bayes ~4×10⁵:1" figure already retracted to [NUMERICAL FACT] — not runner-computed, ~19× scan-size.)* | [`SPEC_PHYSICS_BRIDGE.md`](SPEC_PHYSICS_BRIDGE.md) §3.1 (FTD-0121, OT-3.3); [`../07_assessment/core_ledgers/LEDGER.md`](../07_assessment/core_ledgers/LEDGER.md) FTD-0319 |
...
| §III.4 — What would close the gap | Exit 1: 6th-postulate W forcing operator assembly (K-BIND `[CLOSED THEOREM-NEGATIVE]`); Exit 2: fresh ARC-D measurement (ARC-D1 `[CLOSED NEGATIVE]`) | [`SPEC_ALPHA_READOUT_CONTRACT.md`](SPEC_ALPHA_READOUT_CONTRACT.md) §5D; [`../10_eft_program/derivations/FOUND_OPERATOR_CALCULUS_AXIOMATIZATION.md`](../10_eft_program/derivations/alpha_readout_programme/FOUND_OPERATOR_CALCULUS_AXIOMATIZATION.md) (FTD-0244); [`../10_eft_program/archive/closed_negative/DERIV_ALPHA_READOUT_EMPIRICAL.md`](../10_eft_program/archive/closed_negative/DERIV_ALPHA_READOUT_EMPIRICAL.md) |
