...
| §III.4 — What would close the gap | Exit 1: 6th-postulate W forcing operator assembly (K-BIND `[CLOSED THEOREM-NEGATIVE]`); Exit 2: fresh ARC-D measurement (ARC-D1 `[CLOSED NEGATIVE]`) | [`SPEC_ALPHA_READOUT_CONTRACT.md`](SPEC_ALPHA_READOUT_CONTRACT.md) §5D; [`../10_eft_program/derivations/FOUND_OPERATOR_CALCULUS_AXIOMATIZATION.md`](../10_eft_program/derivations/FOUND_OPERATOR_CALCULUS_AXIOMATIZATION.md) (FTD-0244); [`../10_eft_program/archive/closed_negative/DERIV_ALPHA_READOUT_EMPIRICAL.md`](../10_eft_program/archive/closed_negative/DERIV_ALPHA_READOUT_EMPIRICAL.md) |
