...
| §III.2 — Structural-uniqueness evidence | FTD-0319 (formerly cited as FTD-0189) adversarial look-elsewhere scan: 0 non-G* dual-matchers / 2.65M polynomials; rank 1 by ~130×; Eisenstein-family null; h≥2 null. The "Bayes ~4×10⁵:1" figure is retracted to [NUMERICAL FACT] — not runner-computed, ~19× scan-size | [`SPEC_PHYSICS_BRIDGE.md`](SPEC_PHYSICS_BRIDGE.md) §3.1 (FTD-0121, OT-3.3); [`../07_assessment/core_ledgers/LEDGER.md`](../07_assessment/core_ledgers/LEDGER.md) FTD-0319 |
