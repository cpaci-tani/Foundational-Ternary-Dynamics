...
| §I.4 — χ_{-4} unification, η-tower, Sym²⊕Sym³ uniqueness (OT-2.5, OT-2.6, OT-2.7) | The numeric identities are `[THEOREM]`s conditional on Deligne/Chowla–Selberg; the Sym²⊕Sym³ / (2,3) uniqueness/forcing step is `[SELECTION]` | [`SPEC_ALGEBRAIC_SPINE.md`](SPEC_ALGEBRAIC_SPINE.md); [`../07_assessment/core_ledgers/LEDGER.md`](../07_assessment/core_ledgers/LEDGER.md) FTD-0163, FTD-0175 |
