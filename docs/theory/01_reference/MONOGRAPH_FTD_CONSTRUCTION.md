...
- §III.2 — Closed-negative (preserved for provenance)
- §III.3 — What would close the gap
- §III.4 — The honest physics scope
...
A construction story is incomplete without its dead ends, because preserving them is what stops a closed route from re-emerging as a fresh "discovery."
