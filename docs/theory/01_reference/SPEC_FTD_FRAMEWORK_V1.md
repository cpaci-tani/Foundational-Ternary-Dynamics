...
| 3 | **Spatial isotropy recovery; Lorentz recovery open** | `[MEASURED]` + `[SCOPED NO-GO/OPEN]` | directional exponent `p = 4.0008 ± 0.0006` is valid for spatial rotations. The fully discrete pole has an earlier isotropic dimension-six boost term; current stable update cannot cancel it, and common-cone/radiative gates remain open ([`AUDIT_LORENTZ_RECOVERY_HARD.md`](../07_assessment/AUDIT_LORENTZ_RECOVERY_HARD.md), FTD-0407). |
