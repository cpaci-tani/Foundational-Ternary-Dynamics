...
**Joint-reading guard (FTD-0400–0405, 2026-07-21):** rows 4, 7, 9, and 12 still do not form one native stress–energy account. FTD-0400 finds `SPLIT-BOOKKEEPING`; FTD-0401 identifies the raw/c=1 mismatch; FTD-0402 corrects the selected live normalization but remains historically `PARTIAL`; FTD-0403 closes `§12-cnorm`; and FTD-0404 makes the volume measure explicit. FTD-0405 then returns `DOUBLE-OBSTRUCTION` for the current direct colour pair-force route: its tick does not exchange exact work with the force-derived potential, and no substrate rule fixes the additive gravitational energy zero/local stress distribution. No framework type, common stress–energy source, or mass derivation is added.
