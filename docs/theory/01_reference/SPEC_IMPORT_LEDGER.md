...
| SS-3 | `G* = Γ(1/4)/Γ(3/4)` | [THEOREM] | four independent constructions converge; forced given FC-0 |
...
| IMP-C3 | **E1** (SC/FCC Watson-class independence) | open — **a case of Rohrlich–Lang / GPC** (Waldschmidt Conj 5.23; Lang proven only n=3,4,6; trdeg floor 2 / conj 4; priced FTD-0376) | [OPEN — exported P1] | a proof either way re-adjudicates FTD-0369 |
| IMP-C4 | **E\*/E\*\*** (no admissible period has (4G*−1) in its square class; subsumes E2) | open — E2 leg **a case of the exponential period conjecture** (Fresán–Jossen 8.2.6; priced FTD-0376) | [OPEN] | FTD-0353 §8 shared falsifier (forced native output, odd (4t−1)-valuation → REFUTED) |
