# SPEC · FTD/FQCR Doctrine Ledger v1.7

**Tag:** [REFERENCE] — single-page status map. Per-element tags within (see §0 status key + §13 audit).
**Date:** 2026-07-22
**Version:** 1.7 (FTD-0412 scope correction: MC-T4.3 is `[OPEN — SCOPED NO-GO PACKAGES]`, not a universal foundational obstruction; FTD-0126 is retracted as a physical Wilson-Dirac result and cannot serve as a fourth structural-decoupling leg. FTD-0244 remains theorem-negative for its axiomatized operator calculus. Prior: v1.6 reconciled FTD-0244 and FTD-0208.).
