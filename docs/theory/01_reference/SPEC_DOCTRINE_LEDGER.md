...
| `α_FTD⁻¹ ≈ 137.035999177` at `t = 1`                                  | [STRONGLY MOTIVATED CONJECTURE]  | OT-5.1; FTD-0013. Structural evidence: the 2.87M-poly scan returns 0 Eisenstein dual-matchers (OT-3.3) — the "~4×10⁵:1 Bayes" figure is **retracted to [NUMERICAL FACT]** (not runner-computed, ~19× scan-size; 2026-06-24 spine audit); 63-discriminant Γ-product null at `h ≥ 2` (OT-3.2); Z[i] structural unification of CM Aut count and tower level k=4 (OT-1.5, FTD-0122). |
