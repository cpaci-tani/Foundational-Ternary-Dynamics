...
- [SPEC_SIX_ALGORITHMS.md](SPEC_SIX_ALGORITHMS.md) -- Force algorithms (currently imposed)
...
- [DERIV_LEMNISCATE_HIERARCHY_WHITEPAPER.md](DERIV_LEMNISCATE_HIERARCHY_WHITEPAPER.md) -- Force hierarchy via G*
...
- [EXPLR_LOOP_GRID_DUALITY.md](EXPLR_LOOP_GRID_DUALITY.md) -- Two-layer ontology
