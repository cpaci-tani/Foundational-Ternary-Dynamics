...
Per [AUDIT_EPISTEMIC_AUDIT.md](AUDIT_EPISTEMIC_AUDIT.md), the "~120 predictions" break down as:
...
- **~20 genuine derivations** from G* and framework integers (α, mass ratios, mixing angles)
...
*Framework: Foundational Ternary Dynamics v5.17*
*Status: ~20 genuine derivations + ~100 parametric insertions/external physics*
