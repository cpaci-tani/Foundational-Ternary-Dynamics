...
| **T4** | Electron Mass Formula | Prefactor 16 derived from $|Aut(E)|^2$ of the elliptic curve $y^2 = x^3 - x$. Expresses $m_e = m_P \sqrt{2\pi} \frac{16}{3} \alpha^{11}$ to 0.27% accuracy. | [`DERIV_ELECTRON_MASS_MOTIVATION.md`](docs/theory/05_particles/DERIV_ELECTRON_MASS_MOTIVATION.md) | `proof_complete_sm.py` |
