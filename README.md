...
Then open `http://localhost:8080`, or visit the published dashboard at [williamcpaci-tani.github.io/Foundational-Ternary-Dynamics](https://williamcpaci-tani.github.io/Foundational-Ternary-Dynamics/). GPU measurement campaigns run through WSL2 Ubuntu-22.04; the exact local convention is recorded in [`AGENTS.md`](AGENTS.md) and [`CLAUDE.md`](CLAUDE.md).
