...
Cleanup work should follow the [documentation cleanup discipline](CLAUDE.md#documentation-cleanup-discipline) and the [theory directory structure](docs/theory/META_STRUCTURE.md).
