...
3. [AUDIT_BELL_ANALYSIS.md](docs/theory/07_assessment/quantum_foundations/AUDIT_BELL_ANALYSIS.md) — Bell inequality theory and simulation
...
│   │   ├── archive/REF_SCOPE_LIMITATIONS.md # What FTD does NOT address (SUPERSEDED, archived 2026-08-06)
│   │   ├── archive/REF_DEPLOYMENT.md # Static web deployment guide (SUPERSEDED, archived 2026-08-06)
...
| Document | Purpose |
|----------|---------|
| [INDEX_FTD_NATIVE_EFT.md](docs/theory/10_eft_program/INDEX_FTD_NATIVE_EFT.md) | Canonical local catalog for active native-EFT specifications, conditional theorems, selected probes, audits, and preregistrations |
...
| [ANALYSIS_COUPLED_QUARTIC_CLOCK_FIELD_v1.md](docs/theory/10_eft_program/derivations/native_time_carrier_programme/ANALYSIS_COUPLED_QUARTIC_CLOCK_FIELD_v1.md) | FTD-0770 selected coupled-clock field: conditional phase-wave/compliance/integrability theorems, axial-vs-Moore normalization, and scoped negative result for a non-rescalable linear `G*` signature |
| [ANALYSIS_QUARTIC_CLOCK_ROD_SYNCHRONIZATION_v1.md](docs/theory/10_eft_program/derivations/constituent_complete_matter/ANALYSIS_QUARTIC_CLOCK_ROD_SYNCHRONIZATION_v1.md) | FTD-0771 conditional coordinate-edge/clock ratio, conservative-extension no-go for a unique P1--P5 synchronization, and exact `G*` cancellation in the FTD-0770 selected linear common-cone control |
| [ANALYSIS_NATIVE_TEMPORAL_OCCUPANCY_v1.md](docs/theory/10_eft_program/derivations/native_time_carrier_programme/ANALYSIS_NATIVE_TEMPORAL_OCCUPANCY_v1.md) | FTD-0772 exact fixed-coordinate occupancy characterization plus locked FTD-0659 reanalysis: valid execution, but every native cell is recurrence/stationarity unqualified; full matter--field recurrence remains open |
| [PREREG_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md](docs/theory/10_eft_program/preregistrations/native_time_carrier_programme/PREREG_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md) | FTD-0773 exact-only lock: continuous/discrete firewall, fixed-coordinate inverse hypotheses, selected quadratic-edge waveform functional, `m={2,4,6}` controls, and native no-run boundary |
| [ANALYSIS_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md](docs/theory/10_eft_program/derivations/native_time_carrier_programme/ANALYSIS_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md) | FTD-0773 conditional quartic inverse/selected-edge theorems: exact `B_4=48pi/G*^4` and `H_0''K_4=epsilon/3`, with independence and native-derivation promotions rejected; certificate `95/95`; coupled matter--field recurrence remains the next target |
| [PREREG_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md](docs/theory/10_eft_program/preregistrations/native_time_carrier_programme/PREREG_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md) | FTD-0776 locked production-engine `q_active` recurrence-first pilot: four `L=32`/seed-1 CPU-SOR arms, fixed controls, exact validity gates, and observable/configuration scope firewall |
| [ANALYSIS_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md](docs/theory/10_eft_program/derivations/native_time_carrier_programme/ANALYSIS_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md) | FTD-0776 measured exact-profile `q_active` recurrence failure: four raw-valid arms, zero complete cycles, downstream quartic gates N/A, scale/body work stopped |
| [PREREG_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md](docs/theory/10_eft_program/preregistrations/native_time_carrier_programme/PREREG_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md) | FTD-0777 locked exact/synthetic boundary for forward powers, compatible root lifts, append-only recurrence, single-tower payload obstruction, and the selected two-tower relational repair |
| [ANALYSIS_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md](docs/theory/10_eft_program/derivations/native_time_carrier_programme/ANALYSIS_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md) | FTD-0777 certificate `16/16`: finite root lifts form a recurrence/epoch hierarchy; one tower is not stable arbitrary event memory; native carrier/reference/energy bridge remains open |
...
| [REF_SCOPE_LIMITATIONS.md](docs/reference/archive/REF_SCOPE_LIMITATIONS.md) | What FTD does NOT address — required acknowledgments |
