...
**Framework version:** v5.27-neutrino
...
|-------------------|------------|
| Understand FTD from scratch | [docs/internal/SPEC_CLAUDE.md](docs/internal/SPEC_CLAUDE.md) — the simulation manual |
...
| Assess what's genuinely derived | [docs/theory/AUDIT_EPISTEMIC_AUDIT.md](docs/theory/AUDIT_EPISTEMIC_AUDIT.md) (~30 genuine) |
...
### For Physicists
1. [SPEC_FTD_REFERENCE.md](docs/theory/SPEC_FTD_REFERENCE.md) — Technical reference
2. [DERIV_ALPHA_PRECISION_FORMULA.md](docs/theory/DERIV_ALPHA_PRECISION_FORMULA.md) — The 1.26 ppm result
3. [AUDIT_EPISTEMIC_AUDIT.md](docs/theory/AUDIT_EPISTEMIC_AUDIT.md) — What's proven vs parametric
4. [AUDIT_HIDDEN_SELECTIONS.md](docs/theory/AUDIT_HIDDEN_SELECTIONS.md) — Explicit selection principles

### For Philosophers
1. [FOUND_THE_FIRST_DISTINCTION.md](docs/theory/FOUND_THE_FIRST_DISTINCTION.md) — From void to existence
2. [FOUND_ONTOLOGICAL_GENESIS.md](docs/theory/FOUND_ONTOLOGICAL_GENESIS.md) — 13-level emergence hierarchy
3. [FOUND_CONSCIOUSNESS_MATHEMATICS.md](docs/theory/FOUND_CONSCIOUSNESS_MATHEMATICS.md) — Consciousness from G*
4. [FOUND_THE_EXISTENCE_FILTER.md](docs/theory/FOUND_THE_EXISTENCE_FILTER.md) — E(x) = Re(x) and the Born rule
...
3. `engine/` — C++ simulation engine with Qt6 GUI
4. `engine/tests/` — 62 CTests (variational proof, forces, SM sectors)

### For Experimentalists
1. [EMPIRICAL_CERN_CAVITATION.md](docs/theory/EMPIRICAL_CERN_CAVITATION.md) — CMS Open Data test of topological cavitation
2. [SPEC_NOVEL_PREDICTIONS.md](docs/theory/SPEC_NOVEL_PREDICTIONS.md) — Falsifiable predictions catalog
...
### For Skeptics
1. [AUDIT_EPISTEMIC_AUDIT.md](docs/theory/AUDIT_EPISTEMIC_AUDIT.md) — Honest accounting (~30 genuine, ~50 parametric)
2. [AUDIT_HIDDEN_SELECTIONS.md](docs/theory/AUDIT_HIDDEN_SELECTIONS.md) — Every implicit assumption made explicit
3. [AUDIT_BELL_ANALYSIS.md](docs/theory/AUDIT_BELL_ANALYSIS.md) — Bell inequality theory and simulation: why S ≤ 2 is expected, not a failure
