...
| [ANALYSIS_COUPLED_QUARTIC_CLOCK_FIELD_v1.md](docs/theory/10_eft_program/derivations/ANALYSIS_COUPLED_QUARTIC_CLOCK_FIELD_v1.md) | FTD-0770 selected coupled-clock field: conditional phase-wave/compliance/integrability theorems, axial-vs-Moore normalization, and scoped negative result for a non-rescalable linear `G*` signature |
...
| [ANALYSIS_NATIVE_TEMPORAL_OCCUPANCY_v1.md](docs/theory/10_eft_program/derivations/ANALYSIS_NATIVE_TEMPORAL_OCCUPANCY_v1.md) | FTD-0772 exact fixed-coordinate occupancy characterization plus locked FTD-0659 reanalysis: valid execution, but every native cell is recurrence/stationarity unqualified; full matter--field recurrence remains open |
...
| [ANALYSIS_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md](docs/theory/10_eft_program/derivations/ANALYSIS_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md) | FTD-0773 conditional quartic inverse/selected-edge theorems: exact `B_4=48pi/G*^4` and `H_0''K_4=epsilon/3`, with independence and native-derivation promotions rejected; certificate `95/95`; coupled matter--field recurrence remains the next target |
...
| [ANALYSIS_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md](docs/theory/10_eft_program/derivations/ANALYSIS_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md) | FTD-0776 measured exact-profile `q_active` recurrence failure: four raw-valid arms, zero complete cycles, downstream quartic gates N/A, scale/body work stopped |
...
| [ANALYSIS_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md](docs/theory/10_eft_program/derivations/ANALYSIS_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md) | FTD-0777 certificate `16/16`: finite root lifts form a recurrence/epoch hierarchy; one tower is not stable arbitrary event memory; native carrier/reference/energy bridge remains open |
