...
| [ANALYSIS_QUARTIC_CLOCK_ROD_SYNCHRONIZATION_v1.md](docs/theory/10_eft_program/derivations/ANALYSIS_QUARTIC_CLOCK_ROD_SYNCHRONIZATION_v1.md) | FTD-0771 conditional coordinate-edge/clock ratio, conservative-extension no-go for a unique P1--P5 synchronization, and exact `G*` cancellation in the FTD-0770 selected linear common-cone control |
