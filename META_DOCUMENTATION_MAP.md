...
| [PREREG_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md](docs/theory/10_eft_program/preregistrations/PREREG_QUARTIC_WAVEFORM_NONLINEAR_EDGE_SIGNATURE_v1.md) | FTD-0773 exact-only lock: continuous/discrete firewall, fixed-coordinate inverse hypotheses, selected quadratic-edge waveform functional, `m={2,4,6}` controls, and native no-run boundary |
...
| [PREREG_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md](docs/theory/10_eft_program/preregistrations/PREREG_NATIVE_QACTIVE_TEMPORAL_PILOT_v1.md) | FTD-0776 locked production-engine `q_active` recurrence-first pilot: four `L=32`/seed-1 CPU-SOR arms, fixed controls, exact validity gates, and observable/configuration scope firewall |
...
| [PREREG_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md](docs/theory/10_eft_program/preregistrations/PREREG_DYADIC_MONODROMY_CLOCK_MEMORY_v1.md) | FTD-0777 locked exact/synthetic boundary for forward powers, compatible root lifts, append-only recurrence, single-tower payload obstruction, and the selected two-tower relational repair |
