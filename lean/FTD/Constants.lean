...
theorem N_c_plus_N_base : N_c + N_base = b_3 := by decide
theorem N_base_sq : N_base * N_base = 16 := by decide
theorem twelve_cubed : 12 * 12 * 12 = 1728 := by decide
theorem twelve_is_Nc_times_Nbase : N_c * N_base = 12 := by decide
theorem D_constraint_def : N_c * N_base * N_base - 1 = D_constraint := by decide
...
theorem torsion_sq_16 : torsion_order * torsion_order = 16 := by decide
theorem Aut_eq_torsion : Aut_E_order = torsion_order := by decide
theorem coefficient_is_16 : Aut_E_order * Aut_E_order = N_base * N_base := by decide
