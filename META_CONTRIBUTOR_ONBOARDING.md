...
- Use [docs/theory/07_assessment/TRACKER_DOCUMENT_STATUS.md](docs/theory/07_assessment/TRACKER_DOCUMENT_STATUS.md) to see which theory docs are mature vs. rough.
...
3. [evaluation/ISSUE_TRACKER.md](evaluation/ISSUE_TRACKER.md)
...
4. Before editing, check [docs/theory/07_assessment/TRACKER_DOCUMENT_STATUS.md](docs/theory/07_assessment/TRACKER_DOCUMENT_STATUS.md).
