...
- **Master claim ledger**: `docs/theory/07_assessment/core_ledgers/LEDGER.md` — **544 claim rows** (re-counted 2026-07-26; highest id FTD-0597) with tag history, dependencies, reframe status. The retired "52 load-bearing claims" invited readers to treat the single-source-of-truth ledger as a short table. **Single source of truth for claim status** — papers cite tags from here; if they disagree, the ledger wins. Rows FTD-0050/0051/0052 (Link 8 closure + Langevin infrastructure + deferred s-Metropolis).
