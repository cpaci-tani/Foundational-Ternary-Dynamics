...
**Version:** 5.36 (post-2026-05-03 publication-trio + tracker consolidation — 19 commits across 5-02 + 5-03; Tier I 5/5, Tier II 3/3 + T2.3 §4 item 3 closed via FTD-0123, Tier III 1/5 closed + 3/5 investigated, Tier IV T4.5 Roles 1+3 [DERIVED] + Roles 2+4 [NO-GO]; FTD-0122 [DERIVED] + FTD-0123 [NUMERICAL FACT] + FTD-0124 [METHODOLOGICAL] added to LEDGER; Papers A v2 + B v1 + C revision shipped; canonical bedrock tracker + 87-paper inventory database; 4 stale trackers deleted)
