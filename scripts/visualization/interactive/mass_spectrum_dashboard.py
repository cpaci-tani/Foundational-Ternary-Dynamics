...
def save_figures():
    ...
    # Determine output directory (project_root/media/interactive)
    script_dir = os.path.dirname(os.path.abspath(__file__))
    # script is in scripts/visualization/interactive
    # we want media/interactive which is ../../../media/interactive
    project_root = os.path.abspath(os.path.join(script_dir, '..', '..', '..'))
    output_dir = os.path.join(project_root, 'media', 'interactive')
