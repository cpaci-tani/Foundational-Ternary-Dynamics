...
def main():
    ...
    fig, axes = plt.subplots(2, 2, figsize=(7.3, 6.3),
    ...
    fig.savefig(FIGDIR / "fig14_carrierarc.pdf")
    fig.savefig(OUT / "fig14_carrierarc.png", dpi=200)
    print(f"  wrote {FIGDIR / 'fig14_carrierarc.pdf'}")
