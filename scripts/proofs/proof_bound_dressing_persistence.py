"""Independent run-record certificate for FTD-0727."""
...
PREREG_SHA256 = "49941B346EFF02394C381E6661D47E1A519FD333A087A88A25825D817457312F"
TEST_SHA256 = "5640D53F956D8E3B9610A9B2269F16A4DAAFF79CDE436252734BA5EE3F085B68"
JSON_SHA256 = "52C9537C4E40AD33683070081EA1D4160BFF3C1101AF9237FC36B4EBA95E3F95"
CSV_SHA256 = "007E3FC1E0E3E7FA3E034E0308B028E14BF76E6503BFAC0B547D430542B76668"
...
def main() -> None:
    ...
    check(summary["identifier"] == "FTD-0727", "identifier", checks)
    ...
    check(spread > 1e-9, "locked scalar covariance gate fails", checks)
    check(close(spread, 1.1065308669344631e-9), "scalar spread value locked", checks)
    ...
    print(f"FTD-0727 certificate: {len(checks)}/{len(checks)} checks PASS")
