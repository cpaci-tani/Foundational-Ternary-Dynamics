...
# Connecting to the reference frame context quadratic
...
print()
print(f'  For reference frame context (k=1/2):')
k_cons = 0.5
...
print(f'  For reference frame context, the substrate split becomes IMAGINARY.')
...
print(f'     The substrate asymmetry = normalized root difference')
print(f'')
...
print(f'     k < 4/G*: delta imaginary (reference frame context: inseparable substrates)')
print(f'')
...
print(f'     - The three domains (physics/measurement/reference frame context)')
