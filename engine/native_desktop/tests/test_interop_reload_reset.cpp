...
int main() {
    ...
    try {
        ...
        for (int reload_i = 0; reload_i < 2; ++reload_i) {
            ...
            const auto outcome = ftd::native_desktop::reimport_interop_after_reload(
        ...
        ftd::test::check(
            ...
            !session.interop_enabled());
        const auto null_handle_outcome = ftd::native_desktop::reimport_interop_after_reload(
        ...
        ftd::test::check(
            ...
            !session.interop_enabled());
        const auto rising_edge_outcome = ftd::native_desktop::reimport_interop_after_reload(
