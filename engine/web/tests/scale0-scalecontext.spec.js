 ...
 * scripts/exploration/energy_scales_2026.py (K_GENESIS = 1.533 MeV, 2 m_e = 1.022 MeV).
 */
...
test.describe('Scale-0 Scale Context', () => {
    test('mounts, renders the ruler + readouts, shows live L and the honest tags', async ({ page }) => {
        ...
        expect(r.txt.includes('1.533'), 'K_GENESIS = 1.533 MeV').toBe(true);
        expect(r.txt.includes('1.022'), 'QED pair threshold 2 m_e = 1.022 MeV').toBe(true);
    });
});
