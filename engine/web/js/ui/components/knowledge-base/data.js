...
const SCALE0_SPECIFIC_GUIDES = Object.freeze({
    ...
    's0-field-spacetime-forcing-boundary': {
        ...
        body: [
            'This dashboard scenario shows the actual wave-equation half of the spacetime-forcing boundary demo. It disables non-wave phases so the pulse is a clean field-ruler seed, not a particle or gravity scenario.',
            'Its dashboard profile forces the needed visual controls on after scenario load: flux volume, center slice, low threshold, larger points, and higher opacity. Those settings make the pulse visible but do not change the seeded physics.',
            'The first-order diffusion comparison is not an engine phase. It is kept in the linked local artifact at /demos/spacetime-forcing-boundary.html as an explicitly labelled counterfactual replay of the C++ test.',
        ],
