...
export function getQuantumLabPanelTemplate() {
    return `
        <div class="panel" id="panel-quantum-lab">
            <div class="panel-scale-header"><span class="scale0-only">Quantum Lab</span></div>
            <div class="scale0-only panel-resource-shell panel-resource-shell-padded qlab-shell">
                <div class="qlab-row">
                    <label class="tb-label qlab-label" for="qlab-experiment">Experiment</label>
                    <select id="qlab-experiment" class="tb-select qlab-select">
                        <option value="quantum-born-rule">Born Rule Convergence</option>
                        <option value="quantum-double-slit">Double-Slit Interference</option>
                        <option value="quantum-tunnel">Quantum Tunneling</option>
                        <option value="quantum-well">Energy Quantization (FFT)</option>
                        <option value="quantum-entangle">Entanglement Correlation</option>
                        <option value="quantum-aharonov-bohm">Aharonov-Bohm Effect</option>
                        <option value="quantum-casimir">Casimir Effect</option>
                        <option value="quantum-zeno">Quantum Zeno Effect</option>
                    </select>
                </div>
                <div class="qlab-row">
                    <label class="qlab-meta-label">Trials</label>
                    <select id="qlab-trials" class="tb-select qlab-trials-select">
                    ...
                    <label class="qlab-meta-label">Ticks/Trial</label>
                    <input type="number" id="qlab-ticks" value="200" min="10" max="5000" step="10" class="qlab-ticks-input">
                    <button id="qlab-run" class="qlab-btn-primary">Run Experiment</button>
                    <button id="qlab-abort" class="qlab-btn-secondary panel-resource-hidden">Abort</button>
                </div>
                <div id="qlab-progress-wrap" class="qlab-progress panel-resource-hidden">
                    <div class="qlab-progress-meta">
                        <span id="qlab-progress-label">Trial 0 / 100</span>
                        <span id="qlab-progress-pct">0%</span>
                    </div>
                    <div class="qlab-progress-track">
                        <div id="qlab-progress-bar" class="qlab-progress-bar"></div>
                    </div>
                </div>
                <div class="qlab-chart-grid">
                    <div class="qlab-chart-panel">
                        <div class="qlab-panel-label" id="qlab-chart-title">Distribution</div>
                        <canvas id="qlab-histogram" width="400" height="200" class="qlab-histogram"></canvas>
                    </div>
                    <div class="qlab-stats-panel">
                        <div class="qlab-panel-label">Statistics</div>
                        <dl class="inspector-grid qlab-stats-grid" id="qlab-stats">
                            <dt>Trials</dt><dd id="qlab-stat-n">--</dd>
                            <dt>Mean</dt><dd id="qlab-stat-mean">--</dd>
                            <dt>Std Dev</dt><dd id="qlab-stat-std">--</dd>
                            <dt>Min</dt><dd id="qlab-stat-min">--</dd>
                            <dt>Max</dt><dd id="qlab-stat-max">--</dd>
                        </dl>
                        <div class="qlab-panel-label qlab-panel-label-spaced">Theory</div>
                        <p id="qlab-description" class="qlab-description">
                            Select an experiment and click Run.
                        </p>
                        <div class="qlab-export-row">
                            <button id="qlab-export-csv" class="qlab-btn-secondary qlab-export-btn" disabled>CSV</button>
                            <button id="qlab-export-json" class="qlab-btn-secondary qlab-export-btn" disabled>JSON</button>
                            <button id="qlab-copy" class="qlab-btn-secondary qlab-export-btn" disabled>Copy</button>
                        </div>
                    </div>
                </div>
            </div>
