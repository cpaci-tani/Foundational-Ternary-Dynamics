...
export const SCALE0_SCENARIOS = [
    ...
    makeScenario('Field Configurations', 's0-field-thomson-scattering', 'Thomson scattering observatory', ['field', 'light', 'charge'], '[INSTRUMENT]'),
    makeScenario('Field Configurations', 's0-field-thomson-unlocked-recoil', 'Thomson unlocked recoil', ['field', 'light', 'charge'], '[MEASUREMENT]'),
