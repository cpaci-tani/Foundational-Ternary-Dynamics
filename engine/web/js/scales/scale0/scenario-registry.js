...
export const SCALE0_SCENARIO_CATALOG = [
     ...
     * Scientific purpose: Serves as an imposed null control with no initial particles or fields.
     * Parameters: None.
     * Expected behavior: Qualified dynamical lattice fields remain at their initialized null/sentinel values.
     * Limitation: This finite control does not establish a physical vacuum or zero-point-energy claim.
     */
    makeScenario('1. Validated Native Dynamics', 'empty', 'Empty Lattice — Null Control', ['baseline'], '[IMPOSED] all-zero initial record; native null-control invariance is qualified separately'),
    /*
     ...
     * Qualification: Dispersal retires manifested face records, keeps the shell exact void, and evaluates a normalized target-local one-way closure without opposite-face reinjection or interior grading. The fixed L=33 packet remains bounded with negligible residual through tick 4096. This computational finite-box law is not an exact all-angle radiation theorem or a physical boundary of the ontology.
     */
