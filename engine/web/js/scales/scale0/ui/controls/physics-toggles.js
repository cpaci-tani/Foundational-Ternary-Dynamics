...
export function createPhysicsTogglesCard() {
  ...
  card.innerHTML = `
    ...
    <div class="toggle-row"><input type="checkbox" id="t-confinement"><label for="t-confinement" title="[SELECTION] Replace the long-range color-force shell with linear string tension F = SIGMA_STRING * cf at r >= 8. Requires Color Forces; native CUDA + CPU.">Confinement</label></div>
