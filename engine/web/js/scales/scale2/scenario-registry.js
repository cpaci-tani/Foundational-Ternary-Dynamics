...
const AE_SCENARIO_PRESENTATION = [
    {
        id: 'ae-hydrogen-atom',
        category: 'Atomic Structure · Element References',
    ...
    },
    {
        ...
        category: 'Electromagnetism · Scattering',
    ...
    {
        id: 'ae-he-cluster',
        category: 'Interatomic Forces · Dispersion & Repulsion',
    ...
    {
        id: 'ae-nacl-form',
        category: 'Bonding · Ionic Assembly',
        title: 'Na + Cl \u2192 NaCl',
    ...
    {
        id: 'ae-h2-form',
        category: 'Bonding · Covalent Formation & Rupture',
        title: 'H + H \u2192 H\u2082',
    ...
    {
        id: 'ae-water-dimer',
        category: 'Intermolecular Forces · Hydrogen Bonding',
    ...
    {
        id: 'ae-vsepr-linear',
        category: 'Molecular Structure · Bond Geometry',
        title: 'CO\u2082 \u2192 Linear (180\u00b0)',
    ...
    {
        id: 'ae-thermal-gas',
        category: 'Thermodynamics · Heating & Cooling',
    ...
    {
        id: 'ae-collision',
        category: 'Interatomic Forces · Collisions',
    ...
    },
    {
        ...
        category: 'Dissipation · Damped Relaxation',
    ...
    {
        id: 'ae-polar-dimer',
        category: 'Intermolecular Forces · Electric Dipoles',
    ...
    {
        id: 'ae-dt-fusion',
        category: 'Nuclear Physics · Fusion',
        title: '²H + ³H Fusion',
    ...
    {
        id: 'ae-u235-fission',
        category: 'Nuclear Physics · Fission & Criticality',
    ...
    {
        id: 'ae-fe-bcc',
        category: 'Condensed Matter · Crystal Structure',
    ...
    },
    {
        ...
        category: 'Condensed Matter · Defects & Energy Transport',
    ...
    {
        id: 'ae-custom',
        category: 'Exploration · Custom Scenarios',
        title: 'Custom (Manual)',
...
export function populateAEScenarioSelect(select, selectedId = AE_DEFAULT_SCENARIO) {
    ...
    for (const period of ELEMENT_PERIODS) {
        const group = document.createElement('optgroup');
        group.label = `Atomic Structure · Periodic Table · ${period.label}`;
