...
import { ALPHA, K_B, PI_FTD, HBAR_C_MEV_FM } from './constants.js';

// ── Energy Levels ───────────────────────────────────────────────────
//
// Note: these formulas use K_B, FTD's own electron-mass anchor (0.511 MeV),
// so the spectra are FTD values end-to-end (true-to-FTD). K_B differs from
// the PDG electron mass (0.51099895 MeV) by only ~2 ppm, so wavelengths and
// energies still match CODATA Rydberg values to display precision.
