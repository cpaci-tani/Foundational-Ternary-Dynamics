...
> **STATUS: CLOSED.** Phase 3 of the refactor sweep is complete (commits
> 8b4732d, 1506079, 1499a11, 506805b, plus 848e839 for this map). The
> guide below records the design decisions made during the extraction. The
> current state of the viewport module is documented in
> [META_PROJECT_ATLAS.md](../../../../META_PROJECT_ATLAS.md) §2,
