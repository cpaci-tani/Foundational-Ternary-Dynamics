...
// method through a one-line delegator. See docs/SPEC_REFACTOR_LARGE_FILES.md §4.
import { createLatticeSamplers } from './bridge/mock-lattice-samplers.js';
...
// propagate back, and the four existing MockBridge invalidation sites
// (reset / setScale0Tick / setScale0FluxBuffer / setScale0WaveBuffer)
// continue to govern cache freshness.
...
// Extracted as Wave 2 ticket 5 of the large-file refactor. See
// docs/SPEC_REFACTOR_LARGE_FILES.md §4. Factory takes MockBridge instance
// so state._pe / _peParticleTypes / _peBufs / _peFieldBufs live on the
// bridge and remain accessible to any legacy code that inspects them.
import { createParticleEngine } from './bridge/mock-particle-engine.js';
...
// Extracted as Wave 2 ticket 6 of the large-file refactor. See
// docs/SPEC_REFACTOR_LARGE_FILES.md §4. Factory takes MockBridge instance
// so state._ae / _aeBondSet / _aeIdToIdx / _aeNeighborSets live on the
// bridge and remain visible to any legacy code inspecting them.
import { createAtomEngine } from './bridge/mock-atom-engine.js';
...
// see docs/SPEC_REFACTOR_LARGE_FILES.md §4. Called via .call(this, name)
// so every this.reset(), this.injectParticle(...), etc., binds back to this
// MockBridge instance.
import { runSetupScenario } from './bridge/scenarios/index.js';

// NOTE: _valenceElectrons + computeAtomicProps moved to bridge/mock-atom-engine.js
// alongside the AE block (Wave 2 ticket 6). They were only used by aeAddAtom,
