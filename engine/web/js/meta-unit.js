...
function makeWireframe(vertices, edges, color) {
    const positions = [];
...
function makeMirrorPlane(normal, color) {
...
function findAllEdges(vertices) {
    const edges = [];
...
function edgesAtDistance(vertices, targetD2) {
