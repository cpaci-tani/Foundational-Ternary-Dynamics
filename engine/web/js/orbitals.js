...
const R0_NUCLEAR = 0.3;           // nuclear radius scale: r_nuc = R0 * A^(1/3)
const POINTS_PER_NUCLEON = 4;     // cloud points per nucleon
const PROTON_COLOR  = [1.00, 0.30, 0.20];  // warm red
const NEUTRON_COLOR = [0.30, 0.50, 0.90];  // cool blue
const NUCLEON_SIZE  = 1.3;
...
function generateNuclearCloud(Z) {
    ...
    return { offsets, colors, sizes, count: offsets.length / 3 };
}
