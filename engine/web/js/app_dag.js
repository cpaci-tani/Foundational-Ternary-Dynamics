...
import { createBridge, MockBridge } from './wasm-bridge-dag.js?v=20260415h';
import { tryNativeBridge } from './ws-bridge.js';
import { Viewport } from './viewport.js?v=20260415h';
...
import * as Scale0Controller from './scales/scale0/controller.js?v=20260415h';
...
function wireViewportToggles() {
    ...
    const fieldToggles = [
        ...
        ['toggle-force-volume', 'showForceVolume', (on) => viewport.toggleForceVolume(on)],
        ...
        ['toggle-gravity-field', 'showGravityField', (on) => viewport.toggleGravityField(on)],
