...
3. generic Time, Thermodynamics, Dispersion, and Knots surfaces need explicit
   `empty` applicability states. P1 Observables is resolved: it now exposes one
   static inapplicable boundary and performs no Empty scientific work;
