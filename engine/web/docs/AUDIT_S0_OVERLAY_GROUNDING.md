...
Companion to: [`SPEC_OVERLAY_SEMANTICS.md`](SPEC_OVERLAY_SEMANTICS.md) (visual-encoding audit; older + partial)
...
- **Visual semantics** — *does the shape/motion/color teach what the quantity is?* That is the job of
  `SPEC_OVERLAY_SEMANTICS.md` (v1.0, 2026-04-16). It is now partial: it predates ~10 of the current
