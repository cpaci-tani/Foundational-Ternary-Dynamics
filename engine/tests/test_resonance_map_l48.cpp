/**
 * Phase B.3 (resonance investigation): same fine A-scan at L=48.
 * See test_resonance_map_l32.cpp for context. L=48 is the intermediate
 * lattice size — does the resonance pattern shift smoothly with L?
 *
 * Expected (if hypothesis is correct): resonance windows at L=48 should
 * be at SHIFTED amplitudes compared to L=32, and the cluster sizes inside
 * the windows may be different too.
 */
#include <iostream>
#include <iomanip>
#include <vector>
...
int main() {
    std::cout << "================================================================\n";
    std::cout << "  RESONANCE MAP at L=48, +color+triad, fine A-scan\n";
    std::cout << "================================================================\n\n";
    ...
    std::cout << "Scan: A ∈ [3.0, 8.0] in 0.25 steps\n\n";
    ...
    std::cout << "\n================================================================\n";
    std::cout << "  RESULT: REPORTED (L=48 resonance map)\n";
    std::cout << "================================================================\n";
    return 0;
}
