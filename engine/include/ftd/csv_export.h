 ...
 *
 * Header-only utility for exporting simulation data to CSV files.
 ...
 */
inline bool export_flux_field(const RenderBridge& bridge, const std::string& filename) {
 ...
 * @return          true if export succeeded
 */
inline bool export_density_slice(const RenderBridge& bridge, const std::string& filename,
                                  char axis, int index) {
    std::ofstream out(filename);
    if (!out.is_open()) {
        std::cerr << "CSV export error: cannot open " << filename << "\n";
 ...
 * @return          true if export succeeded
 */
inline bool export_diagnostics_row(const RenderBridge& bridge, const std::string& filename) {
 ...
 */
inline bool export_line_profile(const RenderBridge& bridge, const std::string& filename,
 ...
 */
inline bool export_particle_snapshot(const RenderBridge& bridge, const std::string& filename) {
    bool needs_header = false;
    {
        std::ifstream test(filename);
        if (!test.is_open() || test.peek() == std::ifstream::traits_type::eof()) {
 ...
 */
inline bool export_radial_profile(const RenderBridge& bridge, const std::string& filename,
