/**
 * Implementations of the ftd_sim CLI demo scenarios.
 *
 * Extracted verbatim from engine/src/main.cpp. Function signatures
 * preserved exactly; wrapped in namespace ftd::cli_demos so that
 * main.cpp can dispatch via ftd::cli_demos::scenario_X(...).
 */
...
// Helper: find a manifested particle near a position. File-local to this
// translation unit — only used by scenario_A.
namespace {
