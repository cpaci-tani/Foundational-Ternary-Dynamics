...
// The physics-control panel model, the RmlUi row types + ShellData, and their
// toggle/config/overlay/scenario builders live in app/ui_model.{h,cpp}.

// AppContext + the command / request / nudge helpers live in
// app/app_context.{h,cpp}.
