// engine/native/tests/test_d3d12_render_frame_fencing.cpp
//
...
//
// Same try/catch-SKIP pattern as this suite's other native tests
...
ftd::native::NativeFrame make_frame(int tick, int lattice_size,
...
void check_no_validation_errors(ftd::native::D3D12Presenter& presenter) {
...
int main() {
    ...
    try {
        ...
        for (int i = 0; i < kIterations; ++i) {
            ...
            ftd::native::NativeFrame frame = make_frame(i, 8, n, n / 2);
