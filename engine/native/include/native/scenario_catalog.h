#pragma once
//
// native/scenario_catalog.h — engine/native's OWN Scale-0 scenario catalog.
//
// WHY THIS EXISTS (self-containment):
//   The committed native rebuild must NOT depend on engine/include/ftd/
//   scenario_meta.h — that header is an UNTRACKED file belonging to a
//   concurrent session's held-off bundle, so a native tree that #included it
//   carried a dangling build dependency. This header is the native tree's own,
//   in-repo copy of that descriptor table (ported verbatim), living under
//   ftd::native so it never collides with the engine header if both are present.
//
// MIRROR SOURCE:
//   The table mirrors engine/web/js/scales/scale0/scenario-registry.js
//   (sourceTitle / category / tags / epistemic rows) and MUST stay set-equal
//   with the canonical engine registry ftd::scale0_scenario_ids()
...
inline constexpr ScenarioMeta SCENARIO_META[] = {
    ...
    {"s0-cell-capacitor", "Locked Plate Pair — Gauss-Charged Flux Gap", "1. Validated Native Dynamics", "", "flux,cell,storage,gauss", "[EMERGENT] gap flux built by the native Gauss law from [IMPOSED] locked plates; capacitor identity [OPEN]", "admitted-behavioral", 0, 0},
    {"s0-cell-torus", "Azimuthal Ring Reservoir — Periodic Free-Wave Hold", "1. Validated Native Dynamics", "", "flux,cell,storage,wave", "[EMERGENT] under the isolated periodic wave map from [IMPOSED] ring initial data; storage identity [OPEN]", "admitted-behavioral", 0, 0},
    {"s0-cell-torus-reverse", "Azimuthal Ring Reservoir — Reversed Circulation Control", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,control", "[EMERGENT] mirror of s0-cell-torus under the isolated wave map; control", "admitted-behavioral", 0, 0},
    {"s0-cell-torus-scrambled", "Sign-Scrambled Ring — Zero-Circulation Control", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,control", "[EMERGENT] under the isolated wave map from [IMPOSED] sign-alternated ring data; control", "admitted-behavioral", 0, 0},
    {"s0-cell-torus-open", "Azimuthal Ring Reservoir — Dispersal-Boundary Loss Control", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,boundary,control", "[EMERGENT] under [IMPOSED] dispersal boundary law; no-membrane control", "admitted-behavioral", 0, 0},
    {"s0-cell-torus-walled", "Azimuthal Ring Reservoir — Reflective-Box Hold", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,boundary", "[EMERGENT] under [IMPOSED] reflective boundary law; walled-membrane hold", "admitted-behavioral", 0, 0},
    {"s0-cell-triad", "Three-Axis Standing Arms — Zero-Momentum Flux Cell", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,isotropy", "[EMERGENT] under the isolated periodic wave map from [IMPOSED] standing-arm data; matter-clock identity not claimed", "admitted-behavioral", 0, 0},
    {"s0-cell-torus-membrane", "Walled Ring Reservoir — Clocked Shell Membrane", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,membrane", "[EMERGENT] retention under the [IMPOSED] de Broglie clock mass gap on an imposed locked shell; storage identity [OPEN]", "admitted-behavioral", 0, 0},
    {"s0-cell-torus-membrane-gated", "Walled Ring Reservoir — Scheduled Discharge Port", "1. Validated Native Dynamics", "", "flux,cell,storage,wave,membrane,port", "[EMERGENT] aperture discharge under the [IMPOSED] clock membrane; port ledger measured", "admitted-behavioral", 0, 0},
