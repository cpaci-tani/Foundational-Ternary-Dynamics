...
public:
    ...
    bool applied_reload() const { return ui_.applied_reload; }
    bool applied_host_write() const { return ui_.applied_host_write; }
    std::uint32_t last_total_manifested() const { return last_total_manifested_; }
    ...
    // native main.cpp's startup call), OR the sim thread itself
