...
**1038 code files, 314,600 LOC** (tracked `.cpp/.cc/.h/.hpp/.cu/.cuh/.js/.mjs/.py` under `engine/`).
...
|---|--:|--:|
| `tests` | 390 | 109,696 |
| `web/js-toplevel` | 53 | 73,423 |
| `include` | 103 | 18,428 |
| `web/scale0` | 58 | 14,965 |
| `src/core` | 41 | 12,008 |
| `web/tests` | 71 | 11,797 |
| `web/ui` | 83 | 10,953 |
| `web/bridge` | 31 | 10,531 |
| `web/viewport` | 13 | 8,079 |
| `cuda` | 18 | 7,518 |
| `tools` | 30 | 6,913 |
| `archive` | 12 | 5,597 |
| `src/scenarios` | 7 | 3,002 |
| `wasm` | 5 | 2,802 |
| `web/scale2` | 12 | 2,087 |
| `sim` | 16 | 1,951 |
| `web/scale1` | 10 | 1,899 |
...
### `tests`  (390 files, 109,696 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`test_gpu_physics.cpp`](../../engine/tests/test_gpu_physics.cpp) | 2662 | GPU Physics Test Suite — Testing Ontic Predictions at Scale Leverages the CUDA GpuEngine ( speedup) to run physics campaigns at lattice sizes and tick counts impractical on CPU. |
...
| [`test_gpu_experiments.cpp`](../../engine/tests/test_gpu_experiments.cpp) | 1703 | GPU Particle Physics Experiment Suite Simulations of real scientific experiments on the FTD GPU engine, using ALL available telemetry (EnergyAudit, sync_to_host, phi_coulomb) with quantitative pred... |
...
| [`campaign_hydrogen_spectrum.cpp`](../../engine/tests/campaign_hydrogen_spectrum.cpp) | 1304 | Campaign: Hydrogen Spectrum (consolidated suite) Merges 5 legacy hydrogen test files into a single ftd::test-instrumented suite using the Phase 2a NDJSON telemetry API: test_hydrogen_scale1 -> sect... |
...
| [`benchmark_engine_theory.cpp`](../../engine/tests/benchmark_engine_theory.cpp) | 1158 | ENGINE-THEORY BRIDGE BENCHMARK — COMPREHENSIVE Quantitative comparison of C++ engine output to FTD theory. |
...
| [`test_gpu_parity_complete.cpp`](../../engine/tests/test_gpu_parity_complete.cpp) | 786 | GPU Parity Complete: Every physics domain tested on GPU vs CPU. |
...
| [`campaign_free_dynamics.cpp`](../../engine/tests/campaign_free_dynamics.cpp) | 688 | Campaign: Free Particle Dynamics — Hierarchical Exploration Probes the engine's behavior with FREE (unlocked) particles, building from simplest to most complex: FD1: Single free particle — inertia... |
...
| [`test_gauss_law_fidelity.cpp`](../../engine/tests/test_gauss_law_fidelity.cpp) | 547 | ============================================================================ test_gauss_law_fidelity.cpp (engine-fidelity investigation, 2026-07-16) ------------------------------------------------... |
...
| [`test_triad_confinement.cpp`](../../engine/tests/test_triad_confinement.cpp) | 488 | Test: Triad Binding from Confinement (Checklist #38) Verifies that three same-sign particles with different color orientations form a bound state via the color confinement force, rather than relyin... |
...
| [`test_dyadic_recurrence_probe.cpp`](../../engine/tests/test_dyadic_recurrence_probe.cpp) | 416 | @file test_dyadic_recurrence_probe.cpp @brief [EXPLORATORY] Target-blind C3 geometry -> engine recurrence probe. |
...
| [`test_gpu_continuity_ledger.cpp`](../../engine/tests/test_gpu_continuity_ledger.cpp) | 367 | GPU-native continuity ledger parity. |
...
| [`test_particle_lifetime.cpp`](../../engine/tests/test_particle_lifetime.cpp) | 349 | Diagnostic: Particle Lifetime & Energy Loss Probes three issues: PL1: Slow particle survival (v=0.01, 0.02 — were evaporating) PL2: Energy loss rate vs velocity (quantify radiation) PL3: Orbital en... |
...
| [`test_gpu_delta_upload.cpp`](../../engine/tests/test_gpu_delta_upload.cpp) | 258 | ============================================================================ test_gpu_delta_upload.cpp — C5 (CUDA ticket): host→device delta upload. |
...
| [`test_render_bridge_golden.cpp`](../../engine/tests/test_render_bridge_golden.cpp) | 229 | ============================================================================ test_render_bridge_golden.cpp ---------------------------------------------------------------------------- Phase 4 PRE-F... |
...
| [`test_born_infeld.cpp`](../../engine/tests/test_born_infeld.cpp) | 191 | Test: Born-Infeld Lagrangian Predictions Verifies: 1. |
...
| [`test_portable_field.cpp`](../../engine/tests/test_portable_field.cpp) | 184 | Test: Portable Self-Field Verifies that particles carry their flux when they move. |
...
| [`test_boundary_modes_golden.cpp`](../../engine/tests/test_boundary_modes_golden.cpp) | 178 | ============================================================================ test_boundary_modes_golden.cpp — boundary-mode characterization goldens (revision 0.6; ADR-0012 amendment / multi-profil... |
...
| [`golden_hash.h`](../../engine/tests/support/golden_hash.h) | 173 | ============================================================================ golden_hash.h — shared golden-gate state-hash harness (revision 0.5). |
...
| [`test_atom_toggles_table.cpp`](../../engine/tests/test_atom_toggles_table.cpp) | 136 | Test: AtomToggles characterization (ticket 3.3) Pins the EXACT post-construction toggle state, enable_all()/minimal() profiles, validate() verdicts, and the string get_toggle/set_toggle round-trip... |
...
| [`test_cosmic_toggles_table.cpp`](../../engine/tests/test_cosmic_toggles_table.cpp) | 129 | Test: CosmicToggles characterization (ticket 3.3) Pins the EXACT post-construction toggle state, enable_all()/minimal() profiles, and the string get_toggle/set_toggle round-trip for CosmicEngine —... |
...
| [`test_particle_toggles_table.cpp`](../../engine/tests/test_particle_toggles_table.cpp) | 129 | Test: ParticleToggles characterization (ticket 3.3) Pins the EXACT post-construction toggle state, enable_all()/minimal() profiles, validate() verdicts, and the string get_toggle/set_toggle round-t... |
...
| [`test_gpu_golden.cpp`](../../engine/tests/test_gpu_golden.cpp) | 109 | ============================================================================ test_gpu_golden.cpp — GPU-backend golden characterization (revision 0.7 GPU half / CUDA audit ticket C4; ADR-0012 amendm... |
...
| [`test_ws_protocol.cpp`](../../engine/tests/test_ws_protocol.cpp) | 109 | ============================================================================ test_ws_protocol.cpp — WebSocket remote-control protocol unit tests (revision 1.4). |
...
| [`test_render_bridge_golden_default.cpp`](../../engine/tests/test_render_bridge_golden_default.cpp) | 104 | ============================================================================ test_render_bridge_golden_default.cpp — DEFAULT-PROFILE golden gate (revision 0.5b; ADR-0012 amendment). |
...
| [`test_render_bridge_golden_l9.cpp`](../../engine/tests/test_render_bridge_golden_l9.cpp) | 77 | ============================================================================ test_render_bridge_golden_l9.cpp — secondary lattice-size golden (L=9) (revision 0.7 CPU half; ADR-0012 amendment / mult... |
...
### `web/js-toplevel`  (53 files, 73,423 LOC)
...
| [`app.js`](../../engine/web/js/app.js) | 1755 | @file app.js @brief FTD Web Dashboard — Main Application Controller [EXTENDED] Initializes all subsystems, manages the frame loop, and wires up UI controls to the simulation bridge. |
...
| [`ws-bridge.js`](../../engine/web/js/ws-bridge.js) | 657 | WebSocket Bridge — connects web dashboard to native GPU engine. |
| [`molecules.js`](../../engine/web/js/molecules.js) | 605 | Molecular Library — 25 molecules for Scale 2 (AtomEngine). |
| [`constants.js`](../../engine/web/js/constants.js) | 582 | @file constants.js @brief FTD Constants — single source of truth for the web dashboard. |
| [`physics-harness.js`](../../engine/web/js/physics/physics-harness.js) | 507 | PhysicsHarness — single canonical surface for reading and writing Scale-0 lattice physics state. |
...
| [`atomic-energy.js`](../../engine/web/js/atomic-energy.js) | 202 | Atomic Energy Calculator Computes physical atomic energies for all 118 elements: - Nuclear binding energy (Bethe-Weizsäcker semi-empirical mass formula) - Total rest mass energy (protons + neutrons... |
...
| [`zoo.js`](../../engine/web/js/zoo.js) | 163 | Particle Zoo — interactive table of all SM particles with FTD data. |
...
### `include`  (103 files, 18,428 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`render_bridge.h`](../../engine/include/ftd/render_bridge.h) | 659 | Render-Bridge Tick Engine Implements the Scale-0 lattice tick dynamics with staged read/write loops and toggle-gated extension phases. |
| [`cosmic_engine.h`](../../engine/include/ftd/cosmic_engine.h) | 530 | CosmicEngine: Scale 5 simulation N-body + SPH cosmic simulation with Barnes-Hut octree gravity. |
| [`atom_engine.h`](../../engine/include/ftd/atom_engine.h) | 508 | AtomEngine: Scale 2 simulation Atoms as composite objects with inter-atomic forces: Ionic: F = -ALPHA * Q_i * Q_j / (4*pi * r²_soft) * r_hat Van der Waals: Lennard-Jones 12-6 with eps/sigma from on... |
| [`constants.h`](../../engine/include/ftd/constants.h) | 458 | FTD Render-Bridge Constants Engine-facing interface to the ontic derivation chain. |
...
| [`term_toggles.h`](../../engine/include/ftd/term_toggles.h) | 436 | Runtime toggles for the logic-first engine. |
...
| [`particle_engine.h`](../../engine/include/ftd/particle_engine.h) | 393 | ParticleEngine: Scale 1 simulation Phase 7: Lattice-free engine with continuous positions and analytical forces. |
...
| [`gauge_couplings.h`](../../engine/include/ftd/ontic/gauge_couplings.h) | 276 | ontic/gauge_couplings.h — Layers 5, 5b, 7 and simulation parameters. |
...
| [`render_bridge_diagnostics.h`](../../engine/include/ftd/render_bridge_diagnostics.h) | 263 | @file engine/include/ftd/render_bridge_diagnostics.h @purpose POD diagnostic structs returned by RenderBridge inspection methods. |
| [`master_quadratic.h`](../../engine/include/ftd/ontic/master_quadratic.h) | 255 | ontic/master_quadratic.h — Layers 3, 3b, 3c, 4, 4b of the ontic chain. |
...
| [`gpu_buffers.h`](../../engine/include/ftd/gpu_buffers.h) | 247 | SoA (Structure-of-Arrays) device buffers for GPU-accelerated FTD engine. |
...
| [`hilbert.h`](../../engine/include/ftd/hilbert.h) | 211 | Hilbert Space Construction from Complexified Flux H_FTD = L^2(Lattice, C) where psi(v) = J_x(v) + i*J_y(v) The complexified transverse flux components form a wave function. |
...
| [`gpu_engine.h`](../../engine/include/ftd/gpu_engine.h) | 207 | GPU-Accelerated FTD Engine Drop-in alternative to RenderBridge that executes the tick cycle on NVIDIA GPU via CUDA. |
...
| [`backend.h`](../../engine/include/ftd/backend.h) | 145 | @file backend.h @brief Backend abstraction — collapses #ifdef FTD_ENABLE_CUDA proliferation. |
...
| [`particle_masses.h`](../../engine/include/ftd/ontic/particle_masses.h) | 123 | ontic/particle_masses.h — Layers 6, 6b, 6c of the ontic chain. |
...
| [`scenarios.h`](../../engine/include/ftd/scenarios.h) | 68 | ========================================================================== engine/include/ftd/scenarios.h C++ port of the Scale-0 scenario library that was previously JS-only on the MockBridge (eng... |
...
| [`constants_shared.h`](../../engine/include/ftd/constants_shared.h) | 47 | Shared physics constants — included by both constants.h and CUDA kernels. |
...
### `web/scale0`  (58 files, 14,965 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`scenario-registry.js`](../../engine/web/js/scales/scale0/scenario-registry.js) | 1663 | Hard admission gate for the normal Scale-0 menu. |
...
| [`scenario-loader.js`](../../engine/web/js/scales/scale0/runtime/scenario-loader.js) | 707 | .js` and // `engine/src/scenarios/*.cpp` MUST only mutate toggle keys that // appear in `SCALE0_TOGGLES`. |
...
| [`wave-info.js`](../../engine/web/js/scales/scale0/ui/overlays/wave-lab/wave-info.js) | 547 | @file engine/web/js/scales/scale0/ui/overlays/wave-lab/wave-info.js @purpose Live telemetry and controls for standalone RF/light/sound lattice waves. |
| [`time-panel.js`](../../engine/web/js/scales/scale0/ui/overlays/time-panel.js) | 527 | Time Observatory — Scale-0 time-dilation instrument. |
| [`knots-panel.js`](../../engine/web/js/scales/scale0/ui/overlays/knots-panel.js) | 526 | _symbols:_ mountKnotsPanel(), initKnotsPanel() |
| [`wire.js`](../../engine/web/js/scales/scale0/ui/controls/wire.js) | 505 | Scale 0 Controls Panel Wiring Binds event listeners for every control card mounted by Scale0ControlsComponent: - Physics toggles card (all 18 toggles from SCALE0_TOGGLES) - Substrate controls card... |
...
| [`controller.js`](../../engine/web/js/scales/scale0/controller.js) | 359 | Scale 0 (Lattice) Controller Refactored into a package-style module with explicit runtime phases, a viewport adapter, scenario registry, and UI bindings owned by Scale 0. |
...
| [`viewport-adapter.js`](../../engine/web/js/scales/scale0/viewport-adapter.js) | 260 | _symbols:_ createScale0ViewportAdapter() |
| [`template.js`](../../engine/web/js/scales/scale0/ui/overlays/template.js) | 252 | Scale 0 Viewport Overlay — Field visualization controls A compact accordion: a filter box + an active-overlays strip on top, then the toggles grouped into collapsible semantic categories (the colla... |
...
| [`g2.js`](../../engine/web/js/scales/scale0/ui/overlays/p1-observables/g2.js) | 245 | @file engine/web/js/scales/scale0/ui/overlays/p1-observables/g2.js @purpose Lepton g-2 (Schwinger) and live precession component. |
...
| [`bindings.js`](../../engine/web/js/scales/scale0/ui/bindings.js) | 235 | v=2: Tier 1 quantum overlay bindings added — see SPEC_S0_QUANTUM_OVERLAYS.md |
...
| [`panel-shell.js`](../../engine/web/js/scales/scale0/ui/overlays/panel-shell.js) | 195 | Scale-0 Visualization panel shell — accordion + active strip + filter. |
...
| [`dom.js`](../../engine/web/js/scales/scale0/ui/dom.js) | 120 | _symbols:_ getEl(), setButtonActive(), readButtonActive(), setCheckboxValue() |
...
| [`diagnostics.js`](../../engine/web/js/scales/scale0/runtime/diagnostics.js) | 93 | Live decomposition tooltip for the status-bar energy readout (whole-box audit channels, sim units). |
| [`manifestation-flash.js`](../../engine/web/js/scales/scale0/runtime/manifestation-flash.js) | 93 | Scale-0 manifestation spawn-flash — a REAL "just manifested this tick" visual, distinct from the pre-existing genesis isosurface (which shows the \|J\|~K_GENESIS precondition band, not the discrete e... |
...
| [`frame-sync.js`](../../engine/web/js/scales/scale0/runtime/frame-sync.js) | 55 | _symbols:_ syncRenderableData() |
...
| [`physics-toggles.js`](../../engine/web/js/scales/scale0/ui/controls/physics-toggles.js) | 50 | Scale 0 Physics Toggles Card |
...
### `src/core`  (41 files, 12,008 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`render_bridge.cpp`](../../engine/src/render_bridge.cpp) | 1110 | Logic-First FTD Engine (v2.0) Built from axioms: {3D lattice, ternary states, flux field, local causality} Six rules, nothing else: 1. |
| [`particle_engine.cpp`](../../engine/src/particle_engine.cpp) | 676 | ParticleEngine: Scale 1 simulation Phase 7: Lattice-free engine with continuous positions and analytical forces. |
| [`vtk_export.cpp`](../../engine/src/vtk_export.cpp) | 636 |  |
| [`ws_server.cpp`](../../engine/src/ws_server.cpp) | 608 | FTD WebSocket Server Standalone executable that bridges the FTD engine to the web dashboard via WebSocket on port 9100. |
| [`wilson_dirac.cpp`](../../engine/src/wilson_dirac.cpp) | 544 | Wilson-Dirac CPU implementation -- Phase II.2-A. |
| [`transmutation_phases.cpp`](../../engine/src/transmutation_phases.cpp) | 523 | Transmutation phases — implementation. |
...
| [`poisson_solvers.cpp`](../../engine/src/poisson_solvers.cpp) | 341 | Poisson solvers — implementation. |
| [`atom_engine.cpp`](../../engine/src/atom_engine.cpp) | 339 | AtomEngine: Scale 2 simulation — class lifecycle and tick orchestration. |
| [`injection.cpp`](../../engine/src/injection.cpp) | 331 | Injection — implementation. |
...
| [`dag_engine.cpp`](../../engine/src/dag_engine.cpp) | 319 | ══════════════════════════════════════════════════════════════════════ STATUS BANNER — DAG Engine is a DEPRECATED SKELETON (ticket W6), NOT the production physics path. |
...
| [`backend.cpp`](../../engine/src/backend.cpp) | 238 | @file backend.cpp @brief Backend implementations — CpuBackend + GpuBackend. |
| [`diagnostics_compute.cpp`](../../engine/src/diagnostics_compute.cpp) | 223 | Diagnostics — implementation. |
...
| [`lagrangian.cpp`](../../engine/src/lagrangian.cpp) | 177 |  |
...
| [`main.cpp`](../../engine/src/main.cpp) | 88 | FTD Render-Bridge Simulation Engine — CLI entry point. |
...
| [`energy_ledger_compute.cpp`](../../engine/src/energy_ledger_compute.cpp) | 68 | Energy ledger computation — implementation. |
...
| [`scenario-parity.spec.js`](../../engine/web/tests/scenario-parity.spec.js) | 636 | @ts-check |
...
| [`audit-regression.spec.js`](../../engine/web/tests/audit-regression.spec.js) | 297 | @ts-check |
...
| [`_helpers.js`](../../engine/web/tests/_helpers.js) | 237 | @ts-check |
...
| [`scale2-physics.spec.js`](../../engine/web/tests/scale2-physics.spec.js) | 224 | @ts-check |
...
| [`wasm-scenario-coverage.spec.js`](../../engine/web/tests/wasm-scenario-coverage.spec.js) | 153 | @ts-check |
...
| [`genesis-burst.spec.js`](../../engine/web/tests/genesis-burst.spec.js) | 123 | @ts-check |
...
| [`scale0-conservation-panel.spec.js`](../../engine/web/tests/scale0-conservation-panel.spec.js) | 92 | @ts-check |
...
### `web/ui`  (83 files, 10,953 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`data.js`](../../engine/web/js/ui/components/knowledge-base/data.js) | 1910 | _symbols:_ getKnowledgeBaseSections(), getKnowledgeBaseEntry(), searchKnowledgeBase(), KNOWLEDGE_BASE |
| [`template.js`](../../engine/web/js/ui/components/panel-resources/template.js) | 603 | _symbols:_ getScaleControlsBlocksTemplate(), getZooPanelTemplate(), getInspectorPanelTemplate(), getPhysicsPanelTemplate() |
...
| [`scale0.js`](../../engine/web/js/ui/panels/diagnostics-panel/descriptors/scale0.js) | 138 | Scale 0 diagnostics table descriptor. |
...
| [`diagnostics-template.js`](../../engine/web/js/ui/components/panel-resources/diagnostics-template.js) | 131 | _symbols:_ getDiagnosticsPanelTemplate() |
...
### `web/bridge`  (31 files, 10,531 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`mock-atom-engine.js`](../../engine/web/js/bridge/mock-atom-engine.js) | 1284 | Scale-2 Atom Engine (AE) — MockBridge side only. |
| [`wasm-bridge.js`](../../engine/web/js/bridge/wasm-bridge.js) | 1011 | @file engine/web/js/bridge/wasm-bridge.js @purpose Thin wrapper around the compiled C++/WASM physics engine (engine/wasm/ftd_wasm.cpp). |
| [`s0-seed-scenarios.js`](../../engine/web/js/bridge/scenarios/s0-seed-scenarios.js) | 839 | S0Seed scenarios — s0-seed-* group. |
| [`mock-particle-engine.js`](../../engine/web/js/bridge/mock-particle-engine.js) | 788 | Scale-1 Particle Engine (PE) — MockBridge side only. |
| [`_helpers.js`](../../engine/web/js/bridge/scenarios/_helpers.js) | 593 | Shared scenario primitives — JS mirror of `engine/src/scenarios/_helpers.h`. |
...
| [`flux-scenarios.js`](../../engine/web/js/bridge/scenarios/flux-scenarios.js) | 510 | Flux scenarios — flux-* group. |
...
| [`spectrum-comparator.js`](../../engine/web/js/bridge/scenarios/spectrum-comparator.js) | 434 | _symbols:_ isSingleWaveScenario(), getWaveScenarioDefaults(), sanitizeWaveScenarioSettings(), getWaveScenarioSettings() |
| [`wasm-bridge-proxy.js`](../../engine/web/js/bridge/wasm-bridge-proxy.js) | 419 | Main-thread proxy for the Scale-0 WASM physics Web Worker. |
| [`cosmic-postupdates.js`](../../engine/web/js/bridge/cosmic-postupdates.js) | 351 | Cosmic scale-5 post-integration updates. |
| [`wasm-bridge.worker.js`](../../engine/web/js/bridge/wasm-bridge.worker.js) | 322 | Scale-0 WASM physics Web Worker. |
...
| [`s0-field-scenarios.js`](../../engine/web/js/bridge/scenarios/s0-field-scenarios.js) | 259 | S0Field scenarios — s0-field-* group. |
...
| [`quantum-scenarios.js`](../../engine/web/js/bridge/scenarios/quantum-scenarios.js) | 198 | Quantum scenarios — quantum-* group. |
| [`vacuum-scenarios.js`](../../engine/web/js/bridge/scenarios/vacuum-scenarios.js) | 196 | Vacuum Particle Scenarios — s0-vacuum-* group. |
| [`bridge-contract.js`](../../engine/web/js/bridge/bridge-contract.js) | 190 | Bridge contract — the surface every Scale-0 bridge must implement. |
...
### `web/viewport`  (13 files, 8,079 LOC)
...
| [`viewport.js`](../../engine/web/js/viewport.js) | 1268 | @file viewport.js @brief Three.js 3D Viewport — renders particles and fields from the simulation bridge. |
...
| [`particle-renderer.js`](../../engine/web/js/viewport/particle-renderer.js) | 736 | @file engine/web/js/viewport/particle-renderer.js @purpose Owns particle positions, trails, velocity vectors, per-particle force vectors for the Scale-0 lattice dashboard. |
...
### `cuda`  (18 files, 7,518 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`kernels_forces.cu`](../../engine/cuda/kernels_forces.cu) | 1119 | @file kernels_forces.cu @brief GPU kernels for Phase 4 (Forces) and Phase 5 (Movement). |
| [`gpu_engine.cu`](../../engine/cuda/gpu_engine.cu) | 901 | @file gpu_engine.cu @brief GPU-accelerated FTD tick engine. |
| [`gpu_buffers.cu`](../../engine/cuda/gpu_buffers.cu) | 884 | SoA device buffer management for FTD GPU engine. |
| [`kernels_stencil_single.cu`](../../engine/cuda/kernels_stencil_single.cu) | 678 | @file kernels_stencil_single.cu @brief Single-substrate Phase Read / Phase Write kernels (FTD tick cycle). |
| [`kernels_stencil_dual.cu`](../../engine/cuda/kernels_stencil_dual.cu) | 626 | @file kernels_stencil_dual.cu @brief Dual-substrate Phase Read / Phase Write kernels (FTD tick cycle). |
| [`kernels_poisson.cu`](../../engine/cuda/kernels_poisson.cu) | 486 | FFT-based Poisson solver for FTD GPU engine. |
...
| [`kernels_eft.cu`](../../engine/cuda/kernels_eft.cu) | 384 | @file kernels_eft.cu @brief GPU-native EFT calculations: face-flux conversion, blocking, operator evaluation, and parallel reductions. |
| [`atom_engine_gpu.cu`](../../engine/cuda/atom_engine_gpu.cu) | 354 | GPU AtomEngine backend (Wave 5.3 Phase 1). |
| [`particle_engine_gpu.cu`](../../engine/cuda/particle_engine_gpu.cu) | 315 | GPU ParticleEngine backend (Wave 5.4 Phase 1). |
| [`kernels_aux.cu`](../../engine/cuda/kernels_aux.cu) | 312 | @file kernels_aux.cu @brief Auxiliary physics kernels (weak transmutation, pair production). |
| [`wilson_dirac_gpu.cu`](../../engine/cuda/wilson_dirac_gpu.cu) | 185 | Wilson-Dirac GPU kernel (Phase II.2-E). |
...
| [`cuda_error.cuh`](../../engine/cuda/cuda_error.cuh) | 38 | @file cuda_error.cuh — shared CUDA / cuFFT error-check macros (revision C1). |

### `tools`  (30 files, 6,913 LOC)
...
| [`build_file_manifest.py`](../../engine/tools/build_file_manifest.py) | 330 | Build a machine-readable manifest of every tracked code file in engine/. |
...
### `src/scenarios`  (7 files, 3,002 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`s0_seed.cpp`](../../engine/src/scenarios/s0_seed.cpp) | 961 | ========================================================================== engine/src/scenarios/s0_seed.cpp Group: s0-seed-* (50 scenarios) JS source: engine/web/js/bridge/scenarios/s0-seed-scenari... |
| [`_helpers.h`](../../engine/src/scenarios/_helpers.h) | 585 | ========================================================================== engine/src/scenarios/_helpers.h Private (non-installed) helper header shared by the split scenario group files (flux.cpp,... |
| [`flux.cpp`](../../engine/src/scenarios/flux.cpp) | 492 | ========================================================================== engine/src/scenarios/flux.cpp Group: flux-* (22 scenarios) JS source: engine/web/js/bridge/scenarios/flux-scenarios.js Spl... |
| [`s0_field.cpp`](../../engine/src/scenarios/s0_field.cpp) | 375 | ========================================================================== engine/src/scenarios/s0_field.cpp Group: s0-field-* (9 scenarios) JS source: engine/web/js/bridge/scenarios/s0-field-scena... |
| [`vacuum.cpp`](../../engine/src/scenarios/vacuum.cpp) | 266 | ========================================================================== engine/src/scenarios/vacuum.cpp Group: s0-vacuum-* (15 scenarios) JS source: engine/web/js/bridge/scenarios/vacuum-scenari... |
| [`quantum.cpp`](../../engine/src/scenarios/quantum.cpp) | 210 | ========================================================================== engine/src/scenarios/quantum.cpp Group: quantum-* (8 scenarios) JS source: engine/web/js/bridge/scenarios/quantum-scenario... |
| [`light.cpp`](../../engine/src/scenarios/light.cpp) | 113 | ========================================================================== engine/src/scenarios/light.cpp Group: light-* (4 scenarios) JS source: engine/web/js/bridge/scenarios/light-scenarios.js S... |

### `wasm`  (5 files, 2,802 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`ftd_wasm.cpp`](../../engine/wasm/ftd_wasm.cpp) | 1560 | @file ftd_wasm.cpp @brief Emscripten Embind bindings for the FTD engine — shared helpers. |
| [`bindings_particle.cpp`](../../engine/wasm/bindings_particle.cpp) | 440 | @file bindings_particle.cpp @brief Embind bindings for ParticleEngine (Scale 1). |
...
| [`bindings_atom.cpp`](../../engine/wasm/bindings_atom.cpp) | 344 | @file bindings_atom.cpp @brief Embind bindings for AtomEngine (Scale 2). |
...
### `web/scale2`  (12 files, 2,087 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`controller.js`](../../engine/web/js/scales/scale2/controller.js) | 785 | Scale 2 (Atoms) Controller ──────────────────────────────────────────────────────────────────── Owns the Atom Engine (AE) frame loop, force decomposition rendering, element legend building, orbital... |
...
### `web/scale1`  (10 files, 1,899 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`controller.js`](../../engine/web/js/scales/scale1/controller.js) | 596 | Scale 1 (Particles) Controller Extracted from app.js to isolate the Particle Engine (PE) frame loop, scenario loader, cloud rendering, trail history, and field overlay logic. |
...
| [`pe-cloud-expander.js`](../../engine/web/js/scales/scale1/pe-cloud-expander.js) | 400 | Scale 1 — PE Cloud Expander ──────────────────────────────────────────────────────────────────── Fixed-boundary point cloud per particle. |
...
| [`pe-controls.js`](../../engine/web/js/scales/scale1/ui/controls/pe-controls.js) | 107 | Scale 1 — Particle Engine Controls Card Factory function that returns the "Particle Engine Controls" card DOM element. |
...
### `src/phases`  (4 files, 1,565 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`phase_write.cpp`](../../engine/src/render_bridge_phases/phase_write.cpp) | 551 | @file engine/src/render_bridge_phases/phase_write.cpp @purpose Implementation of phase_write decomposition (Phase 4a, 2026-04-27). |
| [`phase_movement.cpp`](../../engine/src/render_bridge_phases/phase_movement.cpp) | 435 | @file engine/src/render_bridge_phases/phase_movement.cpp @purpose Implementation of phase_movement decomposition (Phase 4c, 2026-04-27). |
| [`phase_forces.cpp`](../../engine/src/render_bridge_phases/phase_forces.cpp) | 349 | @file engine/src/render_bridge_phases/phase_forces.cpp @purpose Implementation of phase_forces decomposition (Phase 4b, 2026-04-27). |
...
### `web/config`  (4 files, 1,442 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`toggles.js`](../../engine/web/js/config/toggles.js) | 752 | Toggle Configuration — Single source of truth for all scale toggles. |
| [`scenarios.js`](../../engine/web/js/config/scenarios.js) | 369 | Scenario Descriptions — Metadata for scenario dropdowns and info panels. |
...
### `src/cli_demos`  (1 files, 984 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`cli_demo_scenarios.cpp`](../../engine/src/cli_demos/cli_demo_scenarios.cpp) | 984 | Implementations of the ftd_sim CLI demo scenarios. |

### `src/atom`  (3 files, 838 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`atom_forces.cpp`](../../engine/src/atom/atom_forces.cpp) | 623 | AtomEngine force computation. |
...
### `web/scale5`  (5 files, 405 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`controller.js`](../../engine/web/js/scales/scale5/controller.js) | 307 | Scale 5 — Cosmic Controller Manages the cosmic scale: N-body gravitational simulation with Hubble expansion, dark matter, and cosmological diagnostics. |
...
### `web/scale6`  (1 files, 213 LOC)

| File | LOC | Purpose |
|---|--:|---|
| [`controller.js`](../../engine/web/js/scales/scale6/controller.js) | 213 | Scale 6 (Meta / Existential Unit) Controller ──────────────────────────────────────────────────────────────────── Reconnects the previously-orphaned MetaUnit module (the 27-site Moore neighborhood... |
