...
- [x] **6.15** Test dashboard (legacy): static JSON mode retired; no standalone test-dashboard product remains.
- [x] **6.16** Test dashboard (legacy): live SSE and the later Qt6 runner retired; CTest/NDJSON remain the maintained test interfaces.
