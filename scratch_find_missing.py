...
index_file = r'c:\Users\cpaci\Desktop\ftd\docs\theory\META_INDEX.md'
...
for root, dirs, files in os.walk(r'c:\Users\cpaci\Desktop\ftd\docs\theory'):
    ...
    for file in files:
        if file.endswith('.md'):
            ...
            if rel_path not in index_content and file not in index_content:
                missing.append(rel_path)

print("Missing from META_INDEX.md:")
for m in missing:
    print(m)
